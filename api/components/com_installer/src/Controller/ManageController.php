...
class ManageController extends ApiController
{
	...
	public function displayList()
	{
		...
		$this->modelState->set('filter.status', $this->input->get('status', $this->input->get->get('status')));
		$this->modelState->set('filter.type', $this->input->get('type', $this->input->get->get('type')));
