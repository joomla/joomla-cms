...
JLoader::register('SearchLanguage', JPATH_ADMINISTRATOR . '/components/com_search/helpers/language.php');
 ...
 * @since  4.0
 */
class En_GBSearch extends SearchIndexerLanguage
{
	protected $stopwords = array(
		'I','a','about','an','and','are','as','at','be','by','com','for','from',
		'he','hi','how','in','is','it','of','on','or','that','the','this','to',
		'was','what','when','where','who','will','with','you', 'the','www'
	);
	...
	/**
	 * Stem a word depending on the language
	 * This specific stemmer for english is the Porter Stemmer by Martin Porter
	 * implemented by Copyright (c) 2005 Richard Heyes (http://www.phpguru.org/)
	 * The implementation is free software. 
