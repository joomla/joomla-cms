		...
		<div class="control-group">
			<div class="controls">
				<div class="input-prepend input-append">
					...
					<input name="secretkey" autocomplete="off" tabindex="3" id="mod-login-secretkey" type="text" class="input-submedium" placeholder="<?php echo JText::_('JGLOBAL_SECRETKEY'); ?>" size="15"/>
					<span class="btn hasTooltip" title="<?php echo JText::_('MOD_LOGIN_TRUST_THIS_DEVICE'); ?>">
						<input id="mod-login-trust" type="checkbox" name="trust" class="inputbox" value="yes" tabindex="4" />
					</span>
					<?php else: ?>
