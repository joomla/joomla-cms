...
<div class="ml-auto">
	<ul class="nav text-center">
		...
		<li class="nav-item">
			<a class="nav-link link-title" href="<?php echo Uri::root(); ?>" title="<?php echo Text::sprintf('MOD_STATUS_PREVIEW', $sitename); ?>" target="_blank">
		...
		<li class="nav-item">
			<a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" title="<?php echo Text::_('MOD_STATUS_QUICKSTART'); ?>">
