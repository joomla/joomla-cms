		...
		<li class="nav-item dropdown">
			...
			<div class="dropdown-menu dropdown-menu-right dropdown-notifications">
				<div class="list-group">
					...
					<a href="<?php echo Route::_('index.php?option=com_postinstall&amp;eid=' . ExtensionHelper::getExtensionRecord('files_joomla')->extension_id); ?>" class="list-group-item list-group-item-action">
