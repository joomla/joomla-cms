 ...
 * @subpackage  mod_status_template
 *
...
<div class="ml-auto d-flex">
	...
	<ul class="nav text-center">
		...
		<li class="nav-item footer-mobil-icon d-flex">
			<a class="nav-link link-title d-flex flex-column align-items-stretch px-2" href="<?php echo Uri::root(); ?>"
		...
		<li class="nav-item d-flex">
			<a class="nav-link d-flex flex-column align-items-stretch px-2 <?php echo ($hideLinks ? 'disabled' : 'dropdown-toggle'); ?>" <?php echo ($hideLinks ? '' : 'href="' . Route::_('index.php?option=com_messages') . '"'); ?> title="<?php echo Text::_('MOD_STATUS_PRIVATE_MESSAGES'); ?>">
                <div class="d-flex align-items-end mx-auto">
		...
		<?php if ($user->authorise('core.manage', 'com_postinstall')) : ?>
			<li class="nav-item dropdown d-flex">
				<button class="nav-link dropdown-toggle d-flex flex-column align-items-stretch px-2 <?php echo ($hideLinks ? 'disabled' : ''); ?>" data-toggle="dropdown" type="button"
		...
		<li class="nav-item dropdown header-profile footer-mobil-icon d-flex">
			<button class="nav-link dropdown-toggle d-flex flex-column align-items-stretch px-2 <?php echo ($hideLinks ? 'disabled' : ''); ?>" data-toggle="dropdown" type="button"
