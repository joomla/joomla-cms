...
<div class="header-item-content dropdown header-profile d-flex">
	...
	<div class="dropdown-menu dropdown-menu-right">
		...
		<?php if (PluginHelper::isEnabled('user', 'atum')) : ?>
			<?php $route = 'index.php?option=com_admin&task=profile.edit&id=' . $user->id . '&return=' . base64_encode($uri) . '#atum'; ?>
			<a class="dropdown-item" href="<?php echo Route::_($route); ?>">
				<span class="fas fa-fw fa-universal-access" aria-hidden="true"></span>
				<?php echo Text::_('TPL_ATUM_ACCESSIBILITY_SETTINGS'); ?>
			</a>
		<?php endif; ?>
