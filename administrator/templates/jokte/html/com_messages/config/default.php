...
<form action="<?php echo JRoute::_('index.php?option=com_messages'); ?>" method="post" name="adminForm" id="message-form" class="form-validate">
	<fieldset>
		<div id="toolbar" class="fltrt toolbar-list">
			<ul class="clean">
				<li id="toolbar-save">
					<a onclick="Joomla.submitform('config.save', this.form);window.top.setTimeout('window.parent.SqueezeBox.close()', 1400);">
		...
		<div class="pagetitle icon-48-messages" >
			<h2><?php echo JText::_('COM_MESSAGES_MY_SETTINGS') ?></h2>
		</div>
	</fieldset>
