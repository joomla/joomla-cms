...
class JHtmlUsers
{
	...
	{
		$title = JText::_('COM_CJFORUM_ADD_NOTE');
	...
	public static function filterNotes($count, $userId)
	{
		...
		$title = JText::_('COM_CJFORUM_FILTER_NOTES');

		return '<a href="' . JRoute::_('index.php?option=com_users&view=notes&filter_search=uid:' . (int) $userId) . '">'
			. JHtml::_('image', 'admin/filter_16.png', 'COM_CJFORUM_NOTES', array('title' => $title), true) . '</a>';
	}
	...
	public static function notes($count, $userId)
	{
		...
		$title = JText::plural('COM_CJFORUM_N_USER_NOTES', $count);
		...
		if ($self)
		{
			$states = array(
				1 => array(
					'task'				=> 'unblock',
					'text'				=> '',
					'active_title'		=> 'COM_CJFORUM_USER_FIELD_BLOCK_DESC',
					'inactive_title'	=> '',
					'tip'				=> true,
				...
				0 => array(
					...
					'text'				=> '',
					'active_title'		=> '',
					'inactive_title'	=> 'COM_CJFORUM_USERS_ERROR_CANNOT_BLOCK_SELF',
					'tip'				=> true,
		...
		else
		{
			$states = array(
				1 => array(
					'task'				=> 'unblock',
					'text'				=> '',
					'active_title'		=> 'COM_CJFORUM_TOOLBAR_UNBLOCK',
					'inactive_title'	=> '',
					'tip'				=> true,
					'active_class'		=> 'unpublish',
					'inactive_class'	=> 'unpublish'
	...
	public static function activateStates()
	{
		$states = array(
			1	=> array(
				'task'				=> 'activate',
				'text'				=> '',
				'active_title'		=> 'COM_CJFORUM_TOOLBAR_ACTIVATE',
				'inactive_title'	=> '',
				'tip'				=> true,
				'active_class'		=> 'unpublish',
				'inactive_class'	=> 'unpublish'
			...
			0	=> array(
				...
				'text'				=> '',
				'active_title'		=> '',
				'inactive_title'	=> 'COM_CJFORUM_ACTIVATED',
				'tip'				=> true,
				'active_class'		=> 'publish',
				'inactive_class'	=> 'publish'
			)
    ...
    public static function ranks()
	{
		...
		{
		    $ranks[] = JHtml::_('select.option', $options[$i]->value, $options[$i]->text);
		}
