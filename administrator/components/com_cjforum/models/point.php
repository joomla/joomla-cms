...
class CjForumModelPoint extends JModelAdmin
{
	protected $text_prefix = 'COM_CJFORUM';

	public $typeAlias = 'com_cjforum.point';
	...
	public function getTable ($type = 'Points', $prefix = 'CjForumTable', $config = array())
	{
	...
	{
		// Get the form.
		$form = $this->loadForm('com_cjforum.point', 'point', array('control' => 'jform', 'load_data' => $loadData));
		if (empty($form))
		{
			return false;
		}
	...
	protected function loadFormData ()
	{
		...
		$app = JFactory::getApplication();
		$data = $app->getUserState('com_cjforum.edit.point.data', array());
		...
		$this->preprocessData('com_cjforum.point', $data);
