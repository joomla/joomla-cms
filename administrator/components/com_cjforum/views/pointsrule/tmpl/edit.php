...
<script type="text/javascript">
	...
	{
		if (task == 'pointsrule.cancel' || document.formvalidator.isValid(document.id('item-form')))
		{
...
<form action="<?php echo JRoute::_('index.php?option=com_cjforum&layout=edit&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="item-form" class="form-validate">
	...
	<div class="form-horizontal">
		...
		<?php if ($this->canDo->get('core.admin')) : ?>
			<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'editor', JText::_('COM_CJFORUM_SLIDER_EDITOR_CONFIG', true)); ?>
