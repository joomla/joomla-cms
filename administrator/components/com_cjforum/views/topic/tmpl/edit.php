...
<form
	...
	<div class="form-horizontal">
		...
		<?php if (isset($params->show_urls_images_backend) && $params->show_urls_images_backend == 1) : ?>
			<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'images', JText::_('COM_CJFORUM_FIELDSET_URLS_AND_IMAGES', true)); ?>
			<div class="row-fluid form-horizontal-desktop">
				<div class="span6">
