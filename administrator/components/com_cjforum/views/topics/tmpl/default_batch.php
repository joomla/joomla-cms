...
<div class="modal hide fade" id="collapseModal">
	...
	<div class="modal-body modal-batch">
		<p><?php echo JText::_('COM_CJFORUM_BATCH_TIP'); ?></p>
		<div class="row-fluid">
		...
		<div class="row-fluid">
			...
			<?php if ($published >= 0) : ?>
				<div class="control-group span6">
					<div class="controls">
						<?php echo JHtml::_('batch.item', 'com_cjforum'); ?>
					</div>
				</div>
			<?php endif; ?>
		</div>
	...
	<div class="modal-footer">
		...
		<button class="btn btn-primary" type="submit" onclick="Joomla.submitbutton('topic.batch');">
