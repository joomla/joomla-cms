...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_cjforum&task=topics.saveOrderAjax&tmpl=component';
	JHtml::_('sortablelist.sortable', 'topicList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
...
<form
	action="<?php echo JRoute::_('index.php?option=com_cjforum&view=topics'); ?>"
			...
			<table class="table table-striped" id="topicList">
				<thead>
					...
					<?php endif;?>
						...
						<th width="10%">
							<?php echo JHtml::_('searchtools.sort', 'COM_CJFORUM_REPLIES', 'a.replies', $listDirn, $listOrder); ?>
						</th>
						<th width="10%">
			...
			:
				...
				?>
					<tr class="row<?php echo $i % 2; ?>"
						...
						<td class="center">
							<div class="btn-group">
								<?php echo JHtml::_('jgrid.published', $item->state, $i, 'topics.', $canChange, 'cb', $item->publish_up, $item->publish_down); ?>
								<?php echo JHtml::_('cjforumadministrator.featured', $item->featured, $i, $canChange); ?>
								<?php
									// Create dropdown items
									$action = $archived ? 'unarchive' : 'archive';
									JHtml::_('actionsdropdown.' . $action, 'cb' . $i, 'topics');
						...
						<td class="center">
							<span class="badge badge-default"><?php echo (int) $item->hits; ?></span>
						</td>
						<td class="center hidden-phone">
