...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_cjforum&task=points.saveOrderAjax&tmpl=component';
...
<form
	action="<?php echo JRoute::_('index.php?option=com_cjforum&view=points'); ?>"
						...
						<td class="has-context">
							<div class="pull-left">
								...
								<?php if ($canEdit || $canEditOwn) : ?>
									<a href="<?php echo JRoute::_('index.php?option=com_cjforum&task=point.edit&id=' . $item->id); ?>" title="<?php echo JText::_('JACTION_EDIT'); ?>">
										<i class="icon icon-pencil"></i>
									</a>
								<?php endif; ?>
								<span><?php echo $item->title; ?></span>
								<div class="small">
									<?php echo JText::_('COM_CJFORUM_RULE_NAME') . ": " . $this->escape($item->rule_title); ?>
								</div>
							</div>
						</td>
