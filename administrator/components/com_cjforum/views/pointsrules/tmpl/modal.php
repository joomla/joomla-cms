...
?>
<form action="<?php echo JRoute::_('index.php?option=com_cjforum&view=pointsrules&layout=modal&tmpl=component&function='.$function.'&'.JSession::getFormToken().'=1');?>" method="post" name="adminForm" id="adminForm">
		...
		<div id="filter-bar" class="btn-toolbar">
			<div class="filter-search btn-group pull-left">
				...
				<input type="text" name="filter_search" id="filter_search" placeholder="<?php echo JText::_('JSEARCH_FILTER'); ?>" value="<?php echo $this->escape($this->state->get('filter.search')); ?>" 
					class="hasTooltip" title="<?php echo JHtml::tooltipText('COM_CJFORUM_SEARCH_IN_NAME'); ?>" data-placement="bottom"/>
			</div>
			<div class="btn-group pull-left">
				...
				<button type="button" class="btn" onclick="if (window.parent) window.parent.<?php echo $this->escape($function); ?>('', '<?php echo JText::_('COM_CJFORUM_SELECT_A_RULE'); ?>');">
					<?php echo JText::_('COM_CJFORUM_OPTION_NO_RULE'); ?>
				</button>
			</div>
		</div>
	</fieldset>
		...
		<thead>
			<tr>
				...
				<th class="nowrap" width="25%">
					<?php echo JHtml::_('grid.sort', 'COM_CJFORUM_APP_NAME', 'a.app_name', $listDirn, $listOrder); ?>
				</th>
				<th class="nowrap" width="25%">
					<?php echo JHtml::_('grid.sort', 'COM_CJFORUM_RULE_NAME', 'a.rule_name', $listDirn, $listOrder); ?>
				</th>
				<th width="5%">
