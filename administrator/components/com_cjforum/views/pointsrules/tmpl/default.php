...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_cjforum&task=pointsrules.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_cjforum&view=pointsrules'); ?>" method="post" name="adminForm" id="adminForm">
...
<?php endif;?>
		...
		<?php else : ?>
			<table class="table table-striped" id="pointsrulesList">
				<thead>
					<tr>
						...
						<th width="5%">
							<?php echo JHtml::_('searchtools.sort', 'COM_CJFORUM_POINTS', 'a.points', $listDirn, $listOrder); ?>
						</th>
						<th width="10%" class="nowrap hidden-phone">
							<?php echo JHtml::_('searchtools.sort',  'COM_CJFORUM_APP_NAME', 'a.app_name', $listDirn, $listOrder); ?>
						</th>
						<th width="15%" class="nowrap hidden-phone">
							<?php echo JHtml::_('searchtools.sort',  'COM_CJFORUM_RULE_NAME', 'a.rule_name', $listDirn, $listOrder); ?>
						</th>
						<th width="10%" class="nowrap hidden-phone">
			...
			:
				...
				$canCreate = $user->authorise('core.create', 'com_cjforum');
						...
						<td class="has-context">
							<div class="pull-left">
								...
								<?php if ($canEdit || $canEditOwn) : ?>
									<a href="<?php echo JRoute::_('index.php?option=com_cjforum&task=pointsrule.edit&id=' . $item->id); ?>" title="<?php echo JText::_('JACTION_EDIT'); ?>">
