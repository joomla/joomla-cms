...
if ($saveOrder) {
    $saveOrderingUrl = 'index.php?option=com_jed&task=extensionimages.saveOrderAjax&tmpl=component&' . Session::getFormToken() . '=1';
    HTMLHelper::_('draggablelist.draggable');
}

?>

<form action="<?php echo Route::_('index.php?option=com_jed&view=extensionimages'); ?>" method="post"
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <?php echo LayoutHelper::render('joomla.searchtools.default', array('view' => $this)); ?>
                ...
                <table class="table table-striped" id="extensionimageList">
                    <thead>
                    <tr>
                        <th width="1%" >
                    ...
                    <?php foreach ($this->items as $i => $item) :
                        ...
                        <tr class="row<?php echo $i % 2; ?>" data-draggable-group='1' data-transition>
                            ...
                            <td>
                                <?php echo HTMLHelper::_('jgrid.published', $item->state, $i, 'extensionimages.', $canChange, 'cb'); ?>
                            </td>
