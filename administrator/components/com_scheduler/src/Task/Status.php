...
abstract class Status
{
     ...
     * @since  4.1.0
     */
    final public const INVALID_EXIT = -2;
     ...
     * @since 4.1.0
     */
    final public const NO_RELEASE = 4;
     ...
     * @since 4.1.0
     */
    final public const WILL_RESUME = 123;
     ...
     * @since 4.1.0
     */
    final public const TIMEOUT = 124;
     ...
     * @since 4.1.0
     */
    final public const NO_TASK = 125;
     ...
     * @since 4.1.0
     */
    final public const NO_ROUTINE = 127;
