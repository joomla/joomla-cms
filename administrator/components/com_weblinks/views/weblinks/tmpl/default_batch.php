...
<div class="modal hide fade" id="collapseModal">
	...
	<div class="modal-footer">
		<button class="btn" type="button" onclick="document.getElementById('batch-category-id').value='';getElementById('batch-access').value='';getElementById('batch-language-id').value='';getElementById('batch-tag-id)').value=''" data-dismiss="modal">
