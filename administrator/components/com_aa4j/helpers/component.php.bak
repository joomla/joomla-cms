...
class UsersHelper
{
	...
	/**
	 * Get a list of filter options for the spam state of a user.
	 *
	 * @return  array  An array of JHtmlOption elements.
	 *
	 * @since   1.6
	 */
	static function getHscoreOptions()
	{
		// Build the filter options.
		$options = array();
		$options[] = JHtml::_('select.option', '0', JText::_('COM_AA4J_SPAM'));
		$options[] = JHtml::_('select.option', '1', JText::_('COM_AA4J_HAM'));
