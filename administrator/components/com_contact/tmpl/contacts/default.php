                ...
                <?php else : ?>
                                ...
                                <th scope="row" class="has-context">
                                    <div>
                                        ...
                                        <?php if ($canEdit || $canEditOwn) : ?>
                                            <a href="<?php echo Route::_('index.php?option=com_contact&task=contact.edit&id=' . (int) $item->id); ?>" title="<?php echo $this->text('JACTION_EDIT'); ?> <?php echo $this->escape($item->name); ?>">
                    ...
                    if (
                        ...
                        <?php echo HTMLHelper::_(
                            ...
                            'collapseModal',
                            [
                                'title'  => $this->text('COM_CONTACT_BATCH_OPTIONS'),
