...
class ContactModel extends AdminModel
{
	...
	protected function canDelete($record)
	{
		...
		return Factory::getApplication()->getIdentity()->authorise('core.delete', 'com_contact.category.' . (int) $record->catid);
	}
	...
	protected function canEditState($record)
	{
		...
		{
			return Factory::getApplication()->getIdentity()->authorise('core.edit.state', 'com_contact.category.' . (int) $record->catid);
		}
	...
	{
		return Factory::getApplication()->getIdentity()->authorise('core.create', 'com_contact');
	}
}
