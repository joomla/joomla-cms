...
class AssociationField extends FormField
{
    ...
    protected function getInput()
    {
        ...
        $html[] = HTMLHelper::_(
            ...
            ['title'       => Text::_('COM_ASSOCIATIONS_SELECT_TARGET'), 'backdrop'    => 'static', 'url'         => $urlSelect, 'height'      => '400px', 'width'       => '800px', 'bodyHeight'  => 70, 'modalWidth'  => 80, 'footer'      => '<button type="button" class="btn btn-secondary" data-bs-dismiss="modal">'
