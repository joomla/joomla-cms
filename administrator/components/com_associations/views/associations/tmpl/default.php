...
$associationMode = array(
	"grau" => 0, // nicht verknüpft
	"gruen" => 1, // verknüpft und aktuell
	"gelb" => 2, // verknüpft und nicht aktuell
);
                            ...
                            <tr class="row<?php echo $i % 2; ?>">
                                ...
                                <?php echo
									AssociationsHelper::getAssociationHtmlList($this->extensionName,
										$this->typeName, (int) $item->id, $item->language, !$isCheckout, false);
									?>
                                <?php echo
									AssociationsHelper::getAssociationHtmlList($this->extensionName,
										$this->typeName, (int) $item->id, $item->language, !$isCheckout, true);
									?>-->
									<?php echo
									AssociationsHelper::getAssociationHtmlList1($this->extensionName,
										$this->typeName, (int) $item->id, $item->language, !$isCheckout, 1);
									?>
									<?php echo
									AssociationsHelper::getAssociationHtmlList1($this->extensionName,
										$this->typeName, (int) $item->id, $item->language, !$isCheckout, 2);
									?>

									<?php echo
									AssociationsHelper::getAssociationHtmlList1($this->extensionName,
										$this->typeName, (int) $item->id, $item->language, !$isCheckout, 0);
									?>
                                </td>
								<?php if (!empty($this->typeFields['menutype'])) : ?>
                                    <td class="small">
