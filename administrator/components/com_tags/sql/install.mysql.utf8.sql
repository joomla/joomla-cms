...
CREATE TABLE IF NOT EXISTS `#__core_content` (
  ...
  `core_content_type` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'FK to the content types table',
  `core_title` varchar(255) NOT NULL,
  `core_alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
  `core_body` mediumtext NOT NULL,
  `core_state` tinyint(1) NOT NULL DEFAULT '0',
  `core_checked_out_session`  varchar(255) NOT NULL DEFAULT '',
  `core_checked_out_user_id` int(11) DEFAULT '0',
  `core_access` int(10) unsigned NOT NULL DEFAULT '0',
  `core_params` text NOT NULL,
  `core_featured` tinyint(4) unsigned NOT NULL DEFAULT '0',
  `core_metadata` varchar(2048) NOT NULL COMMENT 'JSON encoded metadata properties.',
  `core_created_user_id` int(11)  DEFAULT '0',
  `core_created_time` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `core_modified_user_id` int(11)  DEFAULT '0' COMMENT 'Most recent user that modified',
  ...
  KEY `idx_content_type` (`core_content_type`),
  KEY `idx_core_modified_user_id` (`core_modified_user_id`),
  KEY `idx_core_checked_out_user_id` (`core_checked_out_user_id`),
  KEY `idx_core_created_user_id` (`core_created_user_id`),
  CONSTRAINT `#__core_content_ibfk_1` FOREIGN KEY (`core_content_type`) REFERENCES `#__content_types` (`type_id`),
  CONSTRAINT `#__core_content_ibfk_2` FOREIGN KEY (`core_modified_user_id`) REFERENCES `#__users` (`id`) ON UPDATE CASCADE ON DELETE SET NULL,
  CONSTRAINT `#__core_content_ibfk_3` FOREIGN KEY (`core_checked_out_user_id`) REFERENCES `#__users` (`id`) ON UPDATE CASCADE ON DELETE SET NULL,
  CONSTRAINT `#__core_content_ibfk_4` FOREIGN KEY (`core_created_user_id`) REFERENCES `#__users` (`id`) ON UPDATE CASCADE ON DELETE SET NULL
