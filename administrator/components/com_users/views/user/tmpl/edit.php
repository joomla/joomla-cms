...
<form
	...
	id="user-form"
	name="adminForm"
	action="<?php echo JRoute::_('index.php?option=com_users&layout=' . $layout . $tmpl . '&id=' . (int) $this->item->id); ?>"
	method="post"
					...
					<div class="control-group">
						<div class="control-label">
							<label
								...
								title="<?php echo '<strong>' . JText::_('COM_USERS_USER_FIELD_TWOFACTOR_LABEL') . '</strong><br />'
						...
						<div class="controls">
							<?php echo JHtml::_(
								...
								array(
									'onchange' => 'Joomla.twoFactorMethodChange()'
								),
								'value',
								'text',
