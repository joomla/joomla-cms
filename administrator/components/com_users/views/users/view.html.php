...
class UsersViewUsers extends JViewLegacy
{
	...
	protected function addToolbar()
	{
		...
		JHtml::_('sidebar.setaction', 'index.php?option=com_users&view=users');

		JHtml::_('sidebar.addfilter', JText::_('COM_USERS_FILTER_STATE'), 'filter_state',
			JHtml::_('select.options', UsersHelper::getStateOptions(), 'value', 'text', $this->state->get('filter.state')));
		JHtml::_('sidebar.addfilter', JText::_('COM_USERS_FILTER_ACTIVE'), 'filter_active',
			JHtml::_('select.options', UsersHelper::getActiveOptions(), 'value', 'text', $this->state->get('filter.active')));
		JHtml::_('sidebar.addfilter', JText::_('COM_USERS_FILTER_USERGROUP'), 'filter_group_id',
			JHtml::_('select.options', UsersHelper::getGroups(), 'value', 'text', $this->state->get('filter.group_id')));
		JHtml::_('sidebar.addfilter', JText::_('COM_USERS_OPTION_FILTER_DATE'), 'filter_range',
