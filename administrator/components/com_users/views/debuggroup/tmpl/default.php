					...
					<tr>
						<td colspan="<?php echo $colSpan; ?>">
							...
							<div class="legend">
								...
								<span class="text-success icon-ok"></span><?php echo JText::_('COM_USERS_DEBUG_EXPLICIT_ALLOW'); ?>&nbsp;
								<span class="icon-remove"></span><?php echo JText::_('COM_USERS_DEBUG_EXPLICIT_DENY'); ?>
								<br><br>
							</div>
						</td>
					</tr>
