...
?>
<h2>
    <?php echo $this->text('COM_USERS_USER_BACKUPCODES') ?>
</h2>

<p class="text-muted">
    <?php echo $this->text('COM_USERS_USER_BACKUPCODES_DESC') ?>
</p>
...
<div class="alert alert-info">
    ...
    <?php echo $this->text('COM_USERS_MFA_BACKUPCODES_RESET_INFO'); ?>
</div>
...
<div class="d-sm-none">
    <a class="btn btn-danger" href="<?php echo Route::_(sprintf("index.php?option=com_users&task=method.regenerateBackupCodes&user_id=%s&%s=1%s", $this->user->id, Factory::getApplication()->getFormToken(), empty($this->returnURL) ? '' : '&returnurl=' . $this->returnURL)) ?>">
        ...
        <?php echo $this->text('COM_USERS_MFA_BACKUPCODES_RESET'); ?>
    </a>
