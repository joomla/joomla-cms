...
/**
 * Static class to handle mambot view logic
 * 
...
class JInstallerExtensionTasks {
	...
	function showInstalled() {
		 ...
		 */
		$baseDir = JPath :: clean(JPATH_SITE.DS.'mambots', false);
		...
		JInstallerScreens_mambot :: showInstalled($rows);

	}
}

/**
 * Static class to handle mambot view display
 * 
 * @author Louis Landry <louis@webimagery.net>
 * @static
 * @package Joomla
 ...
 * @since 1.1
 */
class JInstallerScreens_mambot {
...
?>
			...
			<input type="hidden" name="type" value="mambot" />
			</form>
			<?php
