                    ...
                    <?php else : ?>
                        <table class="table">
                            <caption class="visually-hidden">
                                <?php echo $this->text('COM_INSTALLER_DATABASE_TABLE_CAPTION'); ?>,
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" class="w-10">
                                        <?php echo $this->text('COM_INSTALLER_HEADING_PROBLEMS'); ?>
                                    </th>
                                    <th scope="col" class="w-10 d-none d-lg-table-cell text-end">
                                        <?php echo $this->text('COM_INSTALLER_HEADING_DATABASE_SCHEMA'); ?>
                                    </th>
                                    <th scope="col" class="w-10 d-none d-lg-table-cell">
                                        <?php echo $this->text('COM_INSTALLER_HEADING_UPDATE_VERSION'); ?>
                                    </th>
                                    <th scope="col" class="w-10 d-none d-lg-table-cell">
                                ...
                                <?php foreach ($this->changeSet as $i => $item) : ?>
                                    ...
                                    <tr class="row<?php echo $i % 2; ?>">
                                        ...
                                        <th scope="row">
                                            ...
                                            <div class="small">
                                                <?php echo $this->text($manifest->description); ?>
                                            </div>
                                        </th>
