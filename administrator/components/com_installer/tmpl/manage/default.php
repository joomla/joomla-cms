                ...
                <div id="j-main-container" class="j-main-container">
                    ...
                    <table class="table" id="manageList">
                        <caption class="visually-hidden">
                            <?php echo $this->text('COM_INSTALLER_MANAGE_TABLE_CAPTION'); ?>,
                        ...
                        <thead>
                            <tr>
                                ...
                                <th scope="col" class="w-1 d-none d-md-table-cell">
                                    <?php echo $this->text('COM_INSTALLER_HEADING_LOCKED'); ?>
                                </th>
                        ...
                        <tbody>
                        <?php $createdDateFormat = $this->text('DATE_FORMAT_LC4'); ?>
                        <?php foreach ($this->items as $i => $item) : ?>
                            ...
                            if ($item->status == 2) {
                                ...
                                <td class="d-none d-md-table-cell">
                                    <?php echo $item->locked ? $this->text('JYES') : $this->text('JNO'); ?>
                                </td>
                                <td class="d-none d-md-table-cell">
