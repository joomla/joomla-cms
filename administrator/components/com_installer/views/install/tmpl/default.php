...
<form enctype="multipart/form-data" action="<?php echo JRoute::_('index.php?option=com_installer&view=install');?>" method="post" name="adminForm" id="adminForm" class="form-horizontal">
	...
	<?php echo JHtml::_('bootstrap.startPane', 'myTab', array('active' => 'upload')); ?>
		...
		<?php echo JHtml::_('bootstrap.addPanel', 'myTab', 'upload', JText::_('COM_INSTALLER_UPLOAD_PACKAGE_FILE')); ?>
		...
		<?php echo JHtml::_('bootstrap.addPanel', 'myTab', 'directory', JText::_('COM_INSTALLER_INSTALL_FROM_DIRECTORY')); ?>
			<fieldset class="uploadform">
		...
		<?php echo JHtml::_('bootstrap.addPanel', 'myTab', 'url', JText::_('COM_INSTALLER_INSTALL_FROM_URL')); ?>
			<fieldset class="uploadform">
		...
		<?php if ($this->ftp) : ?>
			<?php echo JHtml::_('bootstrap.addPanel', 'myTab', 'ftp', JText::_('COM_INSTALLER_MSG_DESCFTPTITLE')); ?>
