					...
					<tr class="row<?php echo $i % 2; ?>">
						...
						<td class="center">
								...
								<?php if (strpos($language->version, $minorVersion) !== 0 || strpos($language->version, $currentShortVersion) !== 0) : ?>
									<span class="label label-warning hasTooltip" title="<?php echo JText::_('JGLOBAL_LANGUAGE_VERSION_NOT_PLATFORM'); ?>"><?php echo JHtml::inlineBidirectional($language->version, 'ltr'); ?></span>
								<?php else : ?>
									<span class="label label-success"><?php echo JHtml::inlineBidirectional($language->version, 'ltr'); ?></span>
								<?php endif; ?>
						</td>
