					...
					<tr class="row<?php echo $i % 2; ?>">
						...
						<td class="center">
								...
								<?php if (strpos($language->version, $minorVersion) !== 0 || strpos($language->version, $currentShortVersion) !== 0) : ?>
									<span class="label label-warning hasTooltip" dir="ltr" title="<?php echo JText::_('JGLOBAL_LANGUAGE_VERSION_NOT_PLATFORM'); ?>"><?php echo $language->version; ?></span>
								<?php else : ?>
									<span class="label label-success" dir="ltr"><?php echo $language->version; ?></span>
								<?php endif; ?>
						</td>
