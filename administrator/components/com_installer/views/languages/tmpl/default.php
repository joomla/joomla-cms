...
// Vars Init!
$ver 		= new JVjokte;
$ver_actual	= substr($ver->LIBERACION,0,3);
$ver_param 	= $this->thisversion;
?>
<form
			...
			<table class="adminlist">
				...
				<tbody>
					<?php foreach ($this->items as $i => $language) :
						...
						// Version compare - Only view is version is the same about params						
						if (($ver_param == '1') && (substr($language->version,0,3) == $ver_actual)):
							continue;
						endif; 
						...
						<tr class="row<?php echo $i%2; ?>">
							<td>
								<?php echo JHtml::_('grid.id', $i, $language->update_id, false, 'cid'); ?></td>
							<td>
