...
<div id="installer-database">
  ...
  <?php endif; ?>
  	...
  	<?php
  		...
  		<ul class="nav nav-tabs">
  		  <li class="active"><a href="#problems" data-toggle="tab"><?php echo JText::plural('COM_INSTALLER_MSG_N_DATABASE_ERROR_PANEL',
		$this->errorCount); ?> <span class="badge badge-info"><?php echo $this->errorCount; ?></span></a></li>
  		  <li><a href="#other" data-toggle="tab"><?php echo JText::_('COM_INSTALLER_MSG_DATABASE_INFO'); ?></a></li>
  		</ul>
