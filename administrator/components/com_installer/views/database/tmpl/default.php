				...
				<fieldset class="panelform">
					<ul>
						...
						<?php if ($this->schemaVersion != $this->changeSet->getSchema()) : ?>
							<li><?php echo JText::sprintf('COM_INSTALLER_MSG_DATABASE_SCHEMA_ERROR', $this->schemaVersionHtml, JHtml::_('language.inlineBidirectional', $this->changeSet->getSchema(), 'ltr')); ?></li>
						<?php endif; ?>

						<?php if (version_compare($this->updateVersion, JVERSION) != 0) : ?>
							<li><?php echo JText::sprintf('COM_INSTALLER_MSG_DATABASE_UPDATEVERSION_ERROR', $this->updateVersionHtml, JHtml::_('language.inlineBidirectional', JVERSION, 'ltr')); ?></li>
						<?php endif; ?>
		...
		<?php endif; ?>
			<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'other', JText::_('COM_INSTALLER_MSG_DATABASE_INFO')); ?>
				<div class="control-group" >
					<fieldset class="panelform">
						<ul>
							<li><?php echo JText::sprintf('COM_INSTALLER_MSG_DATABASE_SCHEMA_VERSION_IN_TABLE', JHtml::_('language.inlineBidirectional', '#__schemas', 'ltr'), $this->schemaVersionHtml); ?></li>
							<li><?php echo JText::sprintf('COM_INSTALLER_MSG_DATABASE_UPDATE_VERSION_IN_TABLE', JHtml::_('language.inlineBidirectional', '#__extensions', 'ltr'), $this->updateVersionHtml); ?></li>
