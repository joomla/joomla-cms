...
$options = [
    HTMLHelper::_('select.option', 'c', $this->text('JLIB_HTML_BATCH_COPY')),
    HTMLHelper::_('select.option', 'm', $this->text('JLIB_HTML_BATCH_MOVE'))
];
...
<div class="p-3">
    ...
    <div class="row">
            ...
            <div class="form-group col-md-6">
                <div class="control-group">
                    <label id="batch-choose-action-lbl" for="batch-menu-id">
                        <?php echo $this->text('COM_MENUS_BATCH_MENU_LABEL'); ?>
                    </label>
                    <select class="form-select" name="batch[menu_id]" id="batch-menu-id">
                        <option value=""><?php echo $this->text('JLIB_HTML_BATCH_NO_CATEGORY'); ?></option>
                        <?php
                        $opts = [
                ...
                <div id="batch-copy-move">
                    <?php echo $this->text('JLIB_HTML_BATCH_MOVE_QUESTION'); ?>
        ...
        <?php if ($published < 0 && $clientId == 1) : ?>
            <p><?php echo $this->text('COM_MENUS_SELECT_MENU_FILTER_NOT_TRASHED'); ?></p>
        <?php endif; ?>
    </div>
    <?php else : ?>
    <div class="row">
        <p><?php echo $this->text('COM_MENUS_SELECT_MENU_FIRST'); ?></p>
    </div>
    <?php endif; ?>
</div>
