...
<form action="<?php echo JRoute::_('index.php?option=com_menus&layout=edit&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="item-form" class="form-validate form-horizontal">
	<fieldset>
		<?php echo JHtml::_('bootstrap.startPane', 'myTab', array('active' => 'details')); ?>
			...
			<?php echo JHtml::_('bootstrap.addPanel', 'myTab', 'details', JText::_('COM_MENUS_ITEM_DETAILS')); ?>
				<div class="row-fluid">
					<div class="span6">
			...
			<?php echo JHtml::_('bootstrap.addPanel', 'myTab', 'options', JText::_('COM_MENUS_ADVANCED_FIELDSET_LABEL')); ?>
			...
			<?php if (!empty($this->modules)) : ?>
				<?php echo JHtml::_('bootstrap.addPanel', 'myTab', 'modules', JText::_('COM_MENUS_ITEM_MODULE_ASSIGNMENT')); ?>
