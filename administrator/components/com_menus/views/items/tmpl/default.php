		...
		<div id="sidebar" class="span2">
			<div class="sidebar-nav">
				...
				<div class="filter-select">
					...
					<label class="hide-text" for="menutype">
						<?php echo JText::_('COM_MENUS_OPTION_SELECT_MENU'); ?>
					</label>
						...
						<td class="order">
							<?php if ($canChange) : ?>
								<div class="input-prepend">
									...
									<?php if(!$disabled = $saveOrder) : echo "<span class=\"add-on tip\" title=\"".JText::_('JDISABLED')."\"><i class=\"icon-ban-circle\"></i></span>"; endif;?><input type="text" name="order[]" class="width-20" size="5" value="<?php echo $orderkey + 1;?>" <?php echo $disabled ?> title="<?php echo $item->title; ?> order" class="text-area-order" />
