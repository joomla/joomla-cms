...
class JFormFieldModal_Menu extends JFormField
{
	...
	protected function getInput()
	{
		...
		$linkItems  = 'index.php?option=com_menus&amp;view=items&amp;layout=modal&amp;client_id=' . $clientId . '&amp;tmpl=component&amp;' . JSession::getFormToken() . '=1';
		$linkItem   = 'index.php?option=com_menus&amp;view=item&amp;layout=modal&amp;client_id=' . $clientId . '&amp;tmpl=component&amp;' . JSession::getFormToken() . '=1';
