...
<?php endif;?>
		<div id="filter-bar" class="btn-toolbar">
			...
			<div class="btn-group pull-left">
				...
				<button type="button" class="btn hasTooltip" title="<?php JHtml::tooltipText('JSEARCH_FILTER_CLEAR'); ?>" onclick="document.getElementById('filter_search').value='';this.form.submit();"><i class="icon-remove"></i></button>
			</div>
