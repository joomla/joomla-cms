...
<form action="<?php echo Route::_('index.php?option=com_banners&layout=edit&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="banner-form" aria-label="<?php echo $this->text('COM_BANNERS_BANNER_' . ((int) $this->item->id === 0 ? 'NEW' : 'EDIT'), true); ?>" class="form-validate">
    ...
    <div class="main-card">
        ...
        <?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'details', $this->text('COM_BANNERS_BANNER_DETAILS')); ?>
        <div class="row">
            <div class="col-lg-9">
        ...
        <?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'otherparams', $this->text('COM_BANNERS_GROUP_LABEL_BANNER_DETAILS')); ?>
            <fieldset id="fieldset-otherparams" class="options-form">
                <legend><?php echo $this->text('COM_BANNERS_GROUP_LABEL_BANNER_DETAILS'); ?></legend>
                <div>
