...
class Tracks extends BaseController
{
	...
	public function display($cachable = false, $urlparams = array())
	{
		...
		if ($view = $this->getView($vName, 'raw'))
		{
			...
			setcookie(ApplicationHelper::getHash($this->context . '.basename'), $form['basename'], time() + 365 * 86400, $cookie_path, $cookie_domain);
			setcookie(ApplicationHelper::getHash($this->context . '.compressed'), $form['compressed'], time() + 365 * 86400, $cookie_path, $cookie_domain);
