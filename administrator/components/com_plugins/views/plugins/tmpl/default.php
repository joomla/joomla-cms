...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_plugins&task=j.saveOrderAjax&tmpl=component';
	JHtml::_('sortablelist.sortable', 'articleList', 'cmsitem', strtolower($listDirn), $saveOrderingUrl);
}
