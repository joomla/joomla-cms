        ...
        <?php else : ?>
            <table class="table" id="pluginList">
                <caption class="visually-hidden">
                    <?php echo $this->text('COM_PLUGINS_TABLE_CAPTION'); ?>,
                ...
                <?php foreach ($this->items as $i => $item) :
                    ...
                    <tr class="row<?php echo $i % 2; ?>" data-draggable-group="<?php echo $item->folder; ?>">
                        ...
                        <th scope="row">
                            ...
                            <?php endif; ?>
                            <?php if ($canEdit) : ?>
                                <a href="<?php echo Route::_('index.php?option=com_plugins&task=plugin.edit&extension_id=' . (int) $item->extension_id); ?>" title="<?php echo $this->text('JACTION_EDIT'); ?> <?php echo $this->escape($item->name); ?>">
