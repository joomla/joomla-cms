...
class Templates
{
	...
	public function thumb($template, $clientId = 0)
	{
		...
		if (file_exists($thumb))
		{
			...
			{
				$html = '<button type="button" data-target="#' . $template . '-Modal" class="thumbnail float-left hasTooltip" data-toggle="modal" title="'. Text::_('COM_TEMPLATES_CLICK_TO_ENLARGE') . '">' . $html . '</button>';
			}
		}
