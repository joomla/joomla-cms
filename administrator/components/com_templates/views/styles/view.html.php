...
class TemplatesViewStyles extends JViewLegacy
{
	...
	protected function addToolbar()
	{
		...
		JHtml::_('sidebar.setaction', 'index.php?option=com_templates&view=styles');

		JHtml::_('sidebar.addfilter', JText::_('COM_TEMPLATES_FILTER_TEMPLATE'), 'filter_template',
		...
		JHtml::_('sidebar.addfilter', JText::_('JGLOBAL_FILTER_CLIENT'), 'filter_client_id',
