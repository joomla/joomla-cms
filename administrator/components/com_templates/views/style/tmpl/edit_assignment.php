...
<div class="btn-toolbar">
	<button class="btn" type="button" class="jform-rightbtn" onclick="jQuery('.chk-menulink').each(function() {this.checked = !this.checked; });">
...
<div id="menu-assignment">
	<ul class="menu-links thumbnails">
		...
		<?php foreach ($menuTypes as &$type) : ?>
			<li class="span3">
				<div class="thumbnail">
				<button class="btn" type="button" class="jform-rightbtn" onclick="jQuery('.<?php echo $type->menutype; ?>').each(function() { this.checked = !this.checked; });">
					<i class="icon-checkbox-partial"></i> <?php echo JText::_('JGLOBAL_SELECTION_INVERT'); ?>
				</button>
