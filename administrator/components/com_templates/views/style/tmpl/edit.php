...
<form action="<?php echo JRoute::_('index.php?option=com_templates&layout=edit&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="style-form" class="form-validate form-horizontal">
	<fieldset>
		<ul class="nav nav-tabs">
			<li class="active"><a href="#basic" data-toggle="tab"><?php echo JText::_('COM_TEMPLATES_BASIC_FIELDSET_LABEL');?></a></li>
			<li><a href="#options" data-toggle="tab"><?php echo JText::_('COM_TEMPLATES_ADVANCED_FIELDSET_LABEL');?></a></li>
