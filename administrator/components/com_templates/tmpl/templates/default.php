                ...
                <?php if ($this->total > 0) : ?>
                    <table class="table" id="templateList">
                        <caption class="visually-hidden">
                            <?php echo $this->text('COM_TEMPLATES_TEMPLATES_TABLE_CAPTION'); ?>,
                        ...
                        <thead>
                            <tr>
                                <th scope="col" class="w-20 col1template d-none d-md-table-cell">
                                    <?php echo $this->text('COM_TEMPLATES_HEADING_IMAGE'); ?>
                                </th>
                                ...
                                <?php if ($this->pluginState) : ?>
                                    <th scope="col" class="w-10 d-none d-md-table-cell text-center">
                                        <?php echo $this->text('COM_TEMPLATES_OVERRIDES'); ?>
                                    </th>
                                <?php endif; ?>
                            </tr>
                        </thead>
                            ...
                            <tr class="row<?php echo $i % 2; ?>">
                                ...
                                <th scope="row" class="template-name">
                                    ...
                                    <div>
                                        ...
                                        <?php else : ?>
                                            <?php echo $this->text('COM_TEMPLATES_TEMPLATE_NO_PREVIEW'); ?>
                                        <?php endif; ?>
                                    </div>
                                    <?php if (isset($item->xmldata->inheritable) && $item->xmldata->inheritable) : ?>
                                        <div class="badge bg-primary">
                                            ...
                                            <?php echo $this->text('COM_TEMPLATES_TEMPLATE_IS_PARENT'); ?>
                                        </div>
                                    <?php endif; ?>
                                ...
                                <?php if ($this->pluginState) : ?>
                                    <td class="d-none d-md-table-cell text-center">
                                        ...
                                        <?php else : ?>
                                            <span class="badge bg-success"><?php echo $this->text('COM_TEMPLATES_UPTODATE'); ?></span>
                                        <?php endif; ?>
                                    </td>
                                <?php endif; ?>
                            </tr>
