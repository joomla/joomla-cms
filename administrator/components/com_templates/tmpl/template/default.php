...
if (!$this->getCurrentUser()->authorise('core.admin')) {
    Factory::getApplication()->enqueueMessage($this->text('JERROR_ALERTNOAUTHOR'), 'danger');
}
...
<div class="main-card">
    ...
    <?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'editor', $this->text('COM_TEMPLATES_TAB_EDITOR')); ?>
    <div class="row mt-2">
        ...
        <div class="col-md-9">
            <fieldset class="options-form">
                <?php if ($this->type == 'home') : ?>
                    <legend><?php echo $this->text('COM_TEMPLATES_HOME_HEADING'); ?></legend>
                    <form action="<?php echo Route::_('index.php?option=com_templates&view=template&id=' . $input->getInt('id') . '&file=' . $this->file . '&isMedia=' . $input->get('isMedia', 0)); ?>" method="post" name="adminForm" id="adminForm">
                        ...
                        <p><?php echo $this->text('COM_TEMPLATES_HOME_TEXT'); ?></p>
                        <p>
                            <a href="https://docs.joomla.org/Special:MyLanguage/J4.x:Template_Overrides" target="_blank" rel="noopener" class="btn btn-primary btn-lg">
                                <?php echo $this->text('COM_TEMPLATES_HOME_BUTTON'); ?>
                            </a>
                        </p>
                    </form>
                    ...
                    <div class="row">
                        <div class="col-md-12" id="override-pane">
                            ...
                            <?php if (!empty($this->source->coreFile)) : ?>
                                <h2><?php echo $this->text('COM_TEMPLATES_FILE_OVERRIDE_PANE'); ?></h2>
                            <?php endif; ?>
                            <form action="<?php echo Route::_('index.php?option=com_templates&view=template&id=' . $input->getInt('id') . '&file=' . $this->file . '&isMedia=' . $input->get('isMedia', 0)); ?>" method="post" name="adminForm" id="adminForm">
                        ...
                        <?php if (!empty($this->source->coreFile)) : ?>
                            <div class="col-md-12" id="core-pane">
                                <h2><?php echo $this->text('COM_TEMPLATES_FILE_CORE_PANE'); ?></h2>
                                <div class="editor-border">
                            ...
                            <?php
                                $difference = DiffHelper::calculateFiles(
                                    ...
                                    [
                                        'language' => [
                                            'old_version' => $this->text('COM_TEMPLATES_DIFF_CORE'),
                                            'new_version' => $this->text('COM_TEMPLATES_DIFF_OVERRIDE'),
                                            'differences' => $this->text('COM_TEMPLATES_DIFF_DIFFERENCES'),
                                        ],
                                        'resultForIdenticals' => $this->text('COM_TEMPLATES_DIFF_IDENTICAL'),
                                        'detailLevel' => 'word',
                                        'spaceToHtmlTag' => true,
                            ...
                            <div class="col-md-12" id="diff-main">
                                <h2><?php echo $this->text('COM_TEMPLATES_FILE_COMPARE_PANE'); ?></h2>
                                <div class="diff-pane">
                ...
                <?php elseif ($this->type == 'archive') : ?>
                    <legend><?php echo $this->text('COM_TEMPLATES_FILE_CONTENT_PREVIEW'); ?></legend>
                    <form action="<?php echo Route::_('index.php?option=com_templates&view=template&id=' . $input->getInt('id') . '&file=' . $this->file . '&isMedia=' . $input->get('isMedia', 0)); ?>" method="post" name="adminForm" id="adminForm">
    ...
    <?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'overrides', $this->text('COM_TEMPLATES_TAB_OVERRIDES')); ?>
    <div class="row mt-2">
        <div class="col-md-3">
            <fieldset class="options-form">
                <legend><?php echo $this->text('COM_TEMPLATES_OVERRIDES_MODULES'); ?></legend>
        ...
        <div class="col-md-3">
            <fieldset class="options-form">
                <legend><?php echo $this->text('COM_TEMPLATES_OVERRIDES_COMPONENTS'); ?></legend>
                <ul class="list-unstyled">
                    <?php $token = Session::getFormToken() . '=' . 1; ?>
        ...
        <div class="col-md-3">
            <fieldset class="options-form">
                <legend><?php echo $this->text('COM_TEMPLATES_OVERRIDES_PLUGINS'); ?></legend>
                <ul class="list-unstyled">
                    <?php $token = Session::getFormToken() . '=' . 1; ?>
        ...
        <div class="col-md-3">
            <fieldset class="options-form">
                <legend><?php echo $this->text('COM_TEMPLATES_OVERRIDES_LAYOUTS'); ?></legend>
                <ul class="list-unstyled">
                    <?php $token = Session::getFormToken() . '=' . 1; ?>
    ...
    <?php if ($this->pluginState) : ?>
        <?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'files', $this->text('COM_TEMPLATES_TAB_UPDATED_FILES')); ?>
    ...
    $copyModalData = [
        ...
        'params'   => [
            'title'  => $this->text('COM_TEMPLATES_TEMPLATE_' . strtoupper($taskName)),
    ...
    <?php if ($this->type != 'home') : ?>
        ...
        $deleteModalData = [
            ...
            'params'   => [
                'title'  => $this->text('COM_TEMPLATES_ARE_YOU_SURE'),
    ...
    $fileModalData = [
        'selector' => 'fileModal',
        'params'   => [
            'title'      => $this->text('COM_TEMPLATES_NEW_FILE_HEADER'),
    ...
    $folderModalData = [
        ...
        'params'   => [
            'title'      => $this->text('COM_TEMPLATES_MANAGE_FOLDERS'),
    ...
    <?php if ($this->type == 'image') : ?>
        ...
        $resizeModalData = [
            ...
            'params'   => [
                'title'  => $this->text('COM_TEMPLATES_RESIZE_IMAGE'),
