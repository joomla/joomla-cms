                    ...
                    <tbody>
                        <?php foreach ($this->updatedList as $i => $value) : ?>
                            <tr class="row<?php echo $i % 2; ?>">
                                ...
                                <td>
                                    <a href="<?php echo Route::_('index.php?option=com_templates&view=template&id=' . (int) $value->extension_id . '&file=' . $value->hash_id . '&return=updated_files'); ?>" title="<?php echo Text::_('JACTION_EDIT'); ?>"><?php echo base64_decode($value->hash_id); ?></a>
                                </td>
                                <td>
