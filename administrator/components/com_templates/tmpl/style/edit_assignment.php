...
<div class="btn-toolbar">
	<button class="btn btn-sm btn-secondary jform-rightbtn" type="button" onclick="toggleAll()">
		...
		<?php foreach ($menuTypes as &$type) : ?>
			<li>
				<div class="menu-links-block">
					<button class="btn btn-sm btn-secondary jform-rightbtn mb-2" type="button" onclick='toggleMenutype("<?php echo $type->menutype; ?>")'>
