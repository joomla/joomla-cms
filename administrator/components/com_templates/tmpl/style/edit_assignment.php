...
?>
<label id="jform_menuselect-lbl" for="jform_menuselect"><?php echo $this->text('JGLOBAL_MENU_SELECTION'); ?></label>
<div class="btn-toolbar">
    <button class="btn btn-sm btn-secondary jform-rightbtn" type="button" onclick="Joomla.toggleAll()">
        <span class="icon-square" aria-hidden="true"></span> <?php echo $this->text('JGLOBAL_SELECTION_INVERT_ALL'); ?>
    </button>
</div>
            ...
            <li>
                <div class="menu-links-block">
                    <button class="btn btn-sm btn-secondary jform-rightbtn mb-2" type="button" onclick='Joomla.toggleMenutype("<?php echo $type->menutype; ?>")'>
                        <span class="icon-square" aria-hidden="true"></span> <?php echo $this->text('JGLOBAL_SELECTION_INVERT'); ?>
                    </button>
