		...
		<?php foreach ($menuTypes as &$type) : ?>
			<li>
				<div class="menu-links-block">
					<button class="btn btn-sm btn-secondary jform-rightbtn mb-2" type="button" onclick="document.querySelector('.<?php echo str_replace(' ', '-', $type->menutype); ?>').setAttribute('checked', !document.querySelector('.<?php echo str_replace(' ', '-', $type->menutype); ?>').getAttribute('checked'));">
