		...
		<?php foreach ($menuTypes as &$type) : ?>
			<li>
				<div class="menu-links-block">
					<button class="btn btn-sm btn-secondary jform-rightbtn mb-2" type="button" onclick="jQuery('.<?php echo str_replace(' ', '-', $type->menutype) ; ?>').attr('checked', !jQuery('.<?php echo str_replace(' ', '-', $type->menutype); ?>').attr('checked'));">
