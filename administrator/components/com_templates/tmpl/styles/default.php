                ...
                <?php if ($this->total > 0) : ?>
                    <table class="table" id="styleList">
                        <caption class="visually-hidden">
                            <?php echo $this->text('COM_TEMPLATES_STYLES_TABLE_CAPTION'); ?>,
                        ...
                        <thead>
                            <tr>
                                ...
                                <th scope="col" class="w-5 text-center">
                                    <?php echo $this->text('COM_TEMPLATES_TEMPLATE_PREVIEW'); ?>
                                </th>
                                ...
                                <?php if ($clientId === 0) : ?>
                                    <th scope="col" class="w-12 d-none d-md-table-cell">
                                        <?php echo $this->text('COM_TEMPLATES_HEADING_PAGES'); ?>
                                    </th>
                                <?php endif; ?>
                                <th scope="col" class="w-12 d-none d-md-table-cell">
                        ...
                        <tbody>
                            ...
                            <tr class="row<?php echo $i % 2; ?>">
                                ...
                                <th scope="row">
                                    <?php if ($canEdit) : ?>
                                        <a href="<?php echo Route::_('index.php?option=com_templates&task=style.edit&id=' . (int) $item->id); ?>" title="<?php echo $this->text('JACTION_EDIT'); ?> <?php echo $this->escape($item->title); ?>">
                                ...
                                <td class="text-center">
                                    ...
                                    <?php else : ?>
                                        ...
                                        <div role="tooltip" id="nopreview-<?php echo (int) $item->id; ?>"><?php echo $this->text('COM_TEMPLATES_TEMPLATE_NO_PREVIEW'); ?></div>
                                    <?php endif; ?>
                                </td>
                                <td class="text-center">
                                ...
                                <td class="small d-none d-md-table-cell">
                                    <?php if ($item->home == '1') : ?>
                                        <?php echo $this->text('COM_TEMPLATES_STYLES_PAGES_ALL'); ?>
                                    ...
                                    <?php else : ?>
                                        <?php echo $this->text('COM_TEMPLATES_STYLES_PAGES_NONE'); ?>
                                    <?php endif; ?>
                                </td>
                                <?php endif; ?>
                                <td class="small d-none d-md-table-cell">
