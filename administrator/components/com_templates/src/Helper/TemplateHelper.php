...
abstract class TemplateHelper
{
    ...
    public static function canUpload($file, $err = '')
    {
        ...
        $executable = ['exe', 'phtml', 'java', 'perl', 'py', 'asp', 'dll', 'go', 'jar', 'ade', 'adp', 'bat', 'chm', 'cmd', 'com', 'cpl', 'hta', 'ins', 'isp', 'jse', 'lib', 'mde', 'msc', 'msp', 'mst', 'pif', 'scr', 'sct', 'shb', 'sys', 'vb', 'vbe', 'vbs', 'vxd', 'wsc', 'wsf', 'wsh'];
        ...
        $allowable = [...$imageTypes, ...$sourceTypes, ...$fontTypes, ...$archiveTypes];
        ...
        foreach ($html_tags as $tag) {
            ...
            if (stristr($xss_check, (string) ('<' . $tag . ' ')) || stristr($xss_check, (string) ('<' . $tag . '>'))) {
                $app = Factory::getApplication();
