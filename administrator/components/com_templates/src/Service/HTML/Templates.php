...
class Templates
{
	...
	public function thumb($template, $clientId = 0)
	{
		...
		if (file_exists($thumb))
		{
			...
			{
				$html = '<button type="button" data-bs-target="#' . $template . '-Modal" class="thumbnail float-left" data-bs-toggle="modal" title="'. Text::_('COM_TEMPLATES_CLICK_TO_ENLARGE') . '">' . $html . '</button>';
			}
		}
