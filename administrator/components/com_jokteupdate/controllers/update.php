 ...
 * @since       2.5.4
 */
class JokteupdateControllerUpdate extends JControllerLegacy
{
	/**
	...
	public function download()
	{
		...
		if ($file)
		{
			JFactory::getApplication()->setUserState('com_jokteupdate.file', $file);
			$url = 'index.php?option=com_jokteupdate&task=update.install';
		}
		else
		{
			JFactory::getApplication()->setUserState('com_jokteupdate.file', null);
			$url = 'index.php?option=com_jokteupdate';
	...
	public function finalise()
	{
		...
		$url = 'index.php?option=com_jokteupdate&task=update.cleanup';
	...
	public function cleanup()
	{
		...
		$url = 'index.php?option=com_jokteupdate&layout=complete';
		$this->setRedirect($url);
	}
	...
	protected function _applyCredentials()
	{
		...
		{
			$user = JFactory::getApplication()->getUserStateFromRequest('com_jokteupdate.ftp_user', 'ftp_user', null, 'raw');
			$pass = JFactory::getApplication()->getUserStateFromRequest('com_jokteupdate.ftp_pass', 'ftp_pass', null, 'raw');
