...
<form action="<?php echo Route::_('index.php?option=com_mails&layout=edit&template_id=' . $this->item->template_id . '&language=' . $this->item->language); ?>" method="post" name="adminForm" id="item-form" aria-label="<?php echo $this->text('COM_MAILS_FORM_EDIT'); ?>" class="form-validate">
    <div class="main-card">
        <?php echo HTMLHelper::_('uitab.startTabSet', 'myTab', ['active' => 'general', 'recall' => true, 'breakpoint' => 768]); ?>

        <?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'general', $this->text('COM_MAILS_MAIL_CONTENT')); ?>
        <div class="row">
            <div class="col-md-12">
                <h1><?php echo $this->text($component . '_MAIL_' . $sub_id . '_TITLE'); ?> - <?php echo $this->escape($this->item->language); ?>
                </h1>
                <div class="small mb-1">
                    <span class="badge bg-secondary"><?php echo $this->escape($this->master->template_id); ?></span>
                </div>
                <p><?php echo $this->text($component . '_MAIL_' . $sub_id . '_DESC'); ?></p>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <button type="button" id="btnResetSubject" class="btn btn-secondary">
                    <?php echo $this->text('COM_MAILS_RESET_TO_DEFAULT_SUBJECT'); ?>
                </button>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <button type="button" id="btnResetBody" class="btn btn-secondary">
                    <?php echo $this->text('COM_MAILS_RESET_TO_DEFAULT_BODY'); ?>
                </button>
                <div class="tags-container-body mt-3 <?php echo $fieldBody->disabled ? 'hidden' : ''; ?>">
                    <h2><?php echo $this->text('COM_MAILS_FIELDSET_TAGS_LABEL'); ?></h2>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <button type="button" id="btnResetHtmlBody" class="btn btn-secondary">
                    <?php echo $this->text('COM_MAILS_RESET_TO_DEFAULT_HTML_BODY'); ?>
                </button>
