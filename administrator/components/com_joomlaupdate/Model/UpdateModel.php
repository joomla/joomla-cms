...
ENDDATA;
	...
	public function finaliseUpgrade()
	{
		...
		$installer->extension = new \Joomla\CMS\Table\Extension(\JFactory::getDbo());
		...
		$id = $db->loadResult();
		$row = new \Joomla\CMS\Table\Extension(\JFactory::getDbo());
		...
		$update = new \Joomla\CMS\Table\Update(\JFactory::getDbo());
		$uid = $update->find(
