...
<form enctype="multipart/form-data" action="index.php" method="post" id="uploadForm">
	...
	<div class="form-check mb-3">
		<input class="form-check-input me-2" type="checkbox" onchange="document.getElementById('uploadButton').disabled = !this.checked;" value="" id="joomlaupdate-confirm-backup">
