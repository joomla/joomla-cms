...
Text::script('COM_JOOMLAUPDATE_VIEW_UPLOAD_ERROR_NOTZIP');
Text::script('COM_JOOMLAUPDATE_VIEW_UPLOAD_ERROR_FULLINSTALLATION_PREUPLOAD');
Text::script('COM_JOOMLAUPDATE_VIEW_UPLOAD_ERROR_NOTUPGRADE');
