...
Text::script('COM_JOOMLAUPDATE_VIEW_UPLOAD_ERROR_NOTZIP', true);
Text::script('COM_JOOMLAUPDATE_VIEW_UPLOAD_ERROR_NOTUPGRADE', true);
Text::script('COM_JOOMLAUPDATE_VIEW_UPLOAD_ERROR_FULLINSTALLATION_PREUPLOAD', true);
