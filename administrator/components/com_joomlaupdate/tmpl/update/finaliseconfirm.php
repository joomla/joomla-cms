...
<div class="alert alert-warning">
	<h4 class="alert-heading"><?php echo Text::_('COM_JOOMLAUPDATE_VIEW_UPDATE_FINALISE_HEAD'); ?></h4>
	<p><?php echo Text::sprintf('COM_JOOMLAUPDATE_VIEW_UPDATE_FINALISE_HEAD_DESC', JFactory::getConfig()->get('sitename')); ?></p>
</div>

<hr>

<form action="<?php echo Route::_('index.php', true); ?>" method="post" id="form-login" class="form-inline text-center">
	<fieldset class="loginform">
		<div class="control-group">
			<div class="controls">
				<div class="input-prepend input-append">
					<span class="input-group-addon">
						<span class="icon-user hasTooltip" title="<?php echo Text::_('JGLOBAL_USERNAME'); ?>" aria-hidden="true"></span>
		...
		<div class="control-group">
			<div class="controls">
				<div class="input-prepend input-append">
					<span class="input-group-addon">
						<span class="icon-lock hasTooltip" title="<?php echo Text::_('JGLOBAL_PASSWORD'); ?>" aria-hidden="true"></span>
		...
		<?php if (count($twofactormethods) > 1) : ?>
			<div class="control-group">
				<div class="controls">
					<div class="input-prepend input-append">
						<span class="input-group-addon">
							<span class="icon-star hasTooltip" title="<?php echo Text::_('JGLOBAL_SECRETKEY'); ?>" aria-hidden="true"></span>
