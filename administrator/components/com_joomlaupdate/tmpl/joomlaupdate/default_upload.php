...
$errSelectPackage = Text::script('COM_INSTALLER_MSG_INSTALL_PLEASE_SELECT_A_PACKAGE', true);

$ajaxLoaderImage = HTMLHelper::_('image', 'jui/ajax-loader.gif', '', null, true, true);
$css             = <<< CSS
	#loading {
...
<fieldset>
	<legend><?php echo Text::_('COM_INSTALLER_SUBMENU_WARNINGS'); ?></legend>
...
<form enctype="multipart/form-data" action="index.php" method="post" id="uploadForm">
	<fieldset class="uploadform">
		...
		<table class="table table-striped">
			<tbody>
			<tr>
				<td><?php echo Text::_('COM_JOOMLAUPDATE_VIEW_UPLOAD_PACKAGE_FILE'); ?></td>
				<td>
					<input class="form-control-file" id="install_package" name="install_package" type="file" size="57">
					<?php $maxSize = HTMLHelper::_('number.bytes', JUtility::getMaxUploadSize()); ?>
			...
			<tr>
				...
				<td><?php echo $this->methodSelectUpload; ?></td>
			</tr>
			<tr id="upload_ftp_hostname" <?php echo $this->ftpFieldsDisplay; ?>>
				<td><?php echo Text::_('COM_JOOMLAUPDATE_VIEW_DEFAULT_FTP_HOSTNAME'); ?></td>
				<td><input class="form-control" type="text" name="ftp_host" value="<?php echo $this->ftp['host']; ?>"></td>
			</tr>
