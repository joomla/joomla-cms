            ...
            <div id="j-main-container" class="j-main-container">
                ...
                <?php if (empty($this->items)) : ?>
                    <div class="alert alert-info">
                        ...
                        <?php echo $this->text('COM_FINDER_MAPS_NO_CONTENT'); ?>
                    </div>
                <?php else : ?>
                <table class="table">
                    <caption class="visually-hidden">
                        <?php echo $this->text('COM_FINDER_MAPS_TABLE_CAPTION'); ?>,
                        ...
                        <tr>
                            ...
                            <?php if (!$branchFilter) : ?>
                                <th scope="col" class="w-1 text-center">
                                    <?php echo $this->text('COM_FINDER_HEADING_CHILDREN'); ?>
                                </th>
                            <?php endif; ?>
                            <th scope="col" class="w-1 text-center">
                                <span class="icon-check" aria-hidden="true"></span>
                                <span class="d-none d-md-inline"><?php echo $this->text('COM_FINDER_MAPS_COUNT_PUBLISHED_ITEMS'); ?></span>
                            </th>
                            <th scope="col" class="w-1 text-center">
                                <span class="icon-times" aria-hidden="true"></span>
                                <span class="d-none d-md-inline"><?php echo $this->text('COM_FINDER_MAPS_COUNT_UNPUBLISHED_ITEMS'); ?></span>
                            </th>
                        ...
                        <tr class="row<?php echo $i % 2; ?>">
                            ...
                            <th scope="row">
                                ...
                                if (trim($item->branch_title, '*') === 'Language') {
                                    ...
                                    $title = $lang->hasKey($key) ? $this->text($key) : $item->title;
                                }
                                ?>
                                ...
                                <div class="small">
                                    <strong><?php echo $this->text('COM_FINDER_MAPS_MULTILANG'); ?></strong>
                                </div>
                                <?php endif; ?>
                            </th>
                            <?php if (!$branchFilter) : ?>
                            ...
                            <?php if ($item->level > 1) : ?>
                                ...
                                <div role="tooltip" id="tip-publish<?php echo $i; ?>">
                                    <?php echo $this->text('COM_FINDER_MAPS_COUNT_PUBLISHED_ITEMS'); ?>
                                </div>
                            <?php else : ?>
                                -
                            <?php endif; ?>
                            ...
                            <?php if ($item->level > 1) : ?>
                                ...
                                <div role="tooltip" id="tip-unpublish<?php echo $i; ?>">
                                    <?php echo $this->text('COM_FINDER_MAPS_COUNT_UNPUBLISHED_ITEMS'); ?>
                                </div>
                            <?php else : ?>
                                -
                            <?php endif; ?>
