...
<form action="<?php echo JRoute::_('index.php?option=com_finder&view=filter&layout=edit&filter_id=' . (int) $this->item->filter_id); ?>" method="post" name="adminForm" id="adminForm" class="form-validate form-horizontal">
	...
	<fieldset>
		<?php echo JHtml::_('bootstrap.startPane', 'myTab', array('active' => 'basic')); ?>
			...
			<?php echo JHtml::_('bootstrap.addPanel', 'myTab', 'basic', JText::_('COM_FINDER_EDIT_FILTER')); ?>
			...
			<?php echo JHtml::_('bootstrap.addPanel', 'myTab', 'params', JText::_('COM_FINDER_FILTER_FIELDSET_PARAMS')); ?>
			...
			<?php echo JHtml::_('bootstrap.addPanel', 'myTab', 'details', JText::_('COM_FINDER_FILTER_FIELDSET_DETAILS')); ?>
				<div class="control-group">
