    ...
    <?php if (!$this->language_filter && $this->switchers == 0) : ?>
        <?php if ($this->homes == 1) : ?>
            <div class="alert alert-info">
                ...
                <?php echo $this->text('COM_LANGUAGES_MULTILANGSTATUS_NONE'); ?>
            </div>
        <?php else : ?>
            <div class="alert alert-info">
                <span class="icon-info-circle" aria-hidden="true"></span>
                <span class="visually-hidden"><?php echo $this->text('INFO'); ?></span>
                <?php echo $this->text('COM_LANGUAGES_MULTILANGSTATUS_USELESS_HOMES'); ?>
            </div>
        <?php endif; ?>
    <?php else : ?>
        <?php if (!in_array($this->default_lang, $content_languages)) : ?>
            <div class="alert alert-error">
                ...
                <span class="visually-hidden"><?php echo $this->text('ERROR'); ?></span>
        ...
        <?php if ($this->defaultHome == true) : ?>
            <div class="alert alert-warning">
                ...
                <?php echo $this->text('COM_LANGUAGES_MULTILANGSTATUS_DEFAULT_HOME_MODULE_PUBLISHED'); ?>
            </div>
        <?php endif; ?>
        ...
        <?php if ($notice_disabled) : ?>
            <div class="alert alert-warning">
                <span class="icon-exclamation-triangle" aria-hidden="true"></span>
                <span class="visually-hidden"><?php echo $this->text('WARNING'); ?></span>
                <?php echo $this->text('COM_LANGUAGES_MULTILANGSTATUS_LANGUAGEFILTER_DISABLED'); ?>
            </div>
        <?php endif; ?>
        <?php if ($notice_switchers) : ?>
            <div class="alert alert-warning">
                <span class="icon-exclamation-triangle" aria-hidden="true"></span>
                <span class="visually-hidden"><?php echo $this->text('WARNING'); ?></span>
                <?php echo $this->text('COM_LANGUAGES_MULTILANGSTATUS_LANGSWITCHER_UNPUBLISHED'); ?>
            </div>
        <?php endif; ?>
        <?php foreach ($this->contentlangs as $contentlang) : ?>
        ...
        <?php if ($this->listUsersError) : ?>
            <div class="alert alert-warning">
                <span class="icon-exclamation-triangle" aria-hidden="true"></span>
                <span class="visually-hidden"><?php echo $this->text('WARNING'); ?></span>
                <?php echo $this->text('COM_LANGUAGES_MULTILANGSTATUS_CONTACTS_ERROR_TIP'); ?>
                <ul>
        ...
        <table class="table table-sm">
            <caption class="visually-hidden"><?php echo $this->text('COM_LANGUAGES_MULTILANGSTATUS_TABLE_CAPTION'); ?></caption>
            <thead>
                <tr>
                    <th scope="col">
                        <?php echo $this->text('JDETAILS'); ?>
                    </th>
                    <th class="text-center" scope="col">
                        <?php echo $this->text('JSTATUS'); ?>
                    </th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    <th scope="row">
                        <?php echo $this->text('COM_LANGUAGES_MULTILANGSTATUS_LANGUAGEFILTER'); ?>
                    </th>
                    <td class="text-center">
                        <?php if ($this->language_filter) : ?>
                            <?php echo $this->text('JENABLED'); ?>
                        <?php else : ?>
                            <?php echo $this->text('JDISABLED'); ?>
                        <?php endif; ?>
                    </td>
                </tr>
                ...
                <tr>
                    <th scope="row">
                        <?php echo $this->text('COM_LANGUAGES_MULTILANGSTATUS_LANGSWITCHER_PUBLISHED'); ?>
                    </th>
                    <td class="text-center">
                ...
                <tr>
                    <th scope="row">
                        <?php if ($this->homes > 1) : ?>
                            <?php echo $this->text('COM_LANGUAGES_MULTILANGSTATUS_HOMES_PUBLISHED_INCLUDING_ALL'); ?>
                        <?php else : ?>
                            <?php echo $this->text('COM_LANGUAGES_MULTILANGSTATUS_HOMES_PUBLISHED'); ?>
                        <?php endif; ?>
                    </th>
                    <td class="text-center">
                        <?php if ($this->homes > 1) : ?>
                            <?php echo $this->homes; ?>
                        <?php else : ?>
                            <?php echo $this->text('COM_LANGUAGES_MULTILANGSTATUS_HOMES_PUBLISHED_ALL'); ?>
                        <?php endif; ?>
                    </td>
                </tr>
            </tbody>
        ...
        <table class="table table-sm">
            <caption class="visually-hidden"><?php echo $this->text('COM_LANGUAGES_MULTILANGSTATUS_CONTENT_TABLE_CAPTION'); ?></caption>
            <thead>
                <tr>
                    <th scope="col">
                    ...
                    <th class="text-center" scope="col">
                        <?php echo $this->text('COM_LANGUAGES_MULTILANGSTATUS_SITE_LANG_PUBLISHED'); ?>
                    </th>
                    <th class="text-center" scope="col">
                        <?php echo $this->text('COM_LANGUAGES_MULTILANGSTATUS_CONTENT_LANGUAGE_PUBLISHED'); ?>
                    </th>
                    <th class="text-center" scope="col">
                        <?php echo $this->text('COM_LANGUAGES_MULTILANGSTATUS_HOMES_PUBLISHED'); ?>
                    </th>
                ...
                <?php foreach ($this->statuses as $status) : ?>
                    ...
                    <?php if ($status->element) : ?>
                            <td class="text-center">
                                ...
                                <span class="visually-hidden"><?php echo $this->text('JYES'); ?></span>
                            </td>
                    <?php else : ?>
                            <td class="text-center">
                    ...
                    <?php // Published Home pages ?>
                        <td class="text-center">
                            ...
                            <?php elseif ($status->home_published == 0) : ?>
                                <span class="text-danger icon-times" aria-hidden="true"></span>
                                <span class="visually-hidden"><?php echo $this->text('JNO'); ?></span>
