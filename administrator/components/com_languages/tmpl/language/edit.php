...
<h2><?php echo $this->escape($this->form->getValue('title', null, $this->text('COM_LANGUAGES_LANGUAGE_NEW_LANGUAGE_TITLE'))); ?></h2>

<form action="<?php echo Route::_('index.php?option=com_languages&view=language&layout=edit&lang_id=' . (int) $this->item->lang_id); ?>" method="post" name="adminForm" id="language-form" aria-label="<?php echo $this->text('COM_LANGUAGES_LANGUAGE_FORM_' . ((int) $this->item->lang_id === 0 ? 'NEW' : 'EDIT'), true); ?>" class="main-card form-validate">
    ...
    <?php echo HTMLHelper::_('uitab.startTabSet', 'myTab', ['active' => 'details', 'recall' => true, 'breakpoint' => 768]); ?>
        ...
        <?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'metadata', $this->text('JGLOBAL_FIELDSET_OPTIONS')); ?>
            <div class="row">
                <div class="col-md-6 mb-3">
                    <fieldset id="fieldset-sitename" class="options-form">
                        <legend><?php echo $this->text('COM_LANGUAGES_FIELDSET_SITE_NAME_LABEL'); ?></legend>
                        <div>
