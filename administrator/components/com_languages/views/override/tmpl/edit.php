...
JHtml::_('stylesheet', 'com_overrider/overrider.css', array('version' => 'auto', 'relative' => true));

JHtml::_('behavior.core');
JHtml::_('jquery.framework');
JHtml::_('script', 'com_overrider/overrider.min.js', array('version' => 'auto', 'relative' => true));
