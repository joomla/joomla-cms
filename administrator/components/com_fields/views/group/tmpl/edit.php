...
<form action="<?php echo JRoute::_('index.php?option=com_fields&extension=' . $input->getCmd('extension', 'com_fields') . '&layout=edit&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="item-form" class="form-validate">
