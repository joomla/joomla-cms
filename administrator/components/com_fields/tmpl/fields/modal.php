                ...
                <tbody>
                    ...
                    <tr class="row<?php echo $i % 2; ?>">
                        ...
                        <td class="small d-none d-md-table-cell">
                            <a class="btn btn-sm btn-warning w-100" href="#" onclick="Joomla.fieldgroupIns('<?php echo $this->escape($item->group_id); ?>', '<?php echo $this->escape($editor); ?>');"><?php echo $item->group_id ? $this->escape($item->group_title) : $this->text('JNONE'); ?></a>
                        </td>
                        <td class="small d-none d-md-table-cell">
                            <?php echo $item->type; ?>
                        </td>
