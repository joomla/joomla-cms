...
<div role="main">
    ...
    <table class="table">
        <caption class="visually-hidden">
            <?php echo $this->text('COM_CONTENTHISTORY_PREVIEW_CAPTION'); ?>
        </caption>
        <thead>
            <tr>
                <th class="w-25" scope="col"><?php echo $this->text('COM_CONTENTHISTORY_PREVIEW_FIELD'); ?></th>
                <th scope="col"><?php echo $this->text('COM_CONTENTHISTORY_PREVIEW_VALUE'); ?></th>
            </tr>
        </thead>
        <tbody>
