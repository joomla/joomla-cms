...
?>
<div role="main">
    <h1 class="mb-3"><?php echo $this->text('COM_CONTENTHISTORY_COMPARE_TITLE'); ?></h1>

    <table id="diff" class="table">
        <caption class="visually-hidden">
            <?php echo $this->text('COM_CONTENTHISTORY_COMPARE_CAPTION'); ?>
        </caption>
        <thead>
            <tr>
                <th scope="col" class="w-25"><?php echo $this->text('COM_CONTENTHISTORY_PREVIEW_FIELD'); ?></th>
                <th scope="col"><?php echo $this->text('COM_CONTENTHISTORY_COMPARE_OLD'); ?></th>
                <th scope="col"><?php echo $this->text('COM_CONTENTHISTORY_COMPARE_NEW'); ?></th>
                <th scope="col"><?php echo $this->text('COM_CONTENTHISTORY_COMPARE_DIFF'); ?></th>
            </tr>
        </thead>
        <tbody>
