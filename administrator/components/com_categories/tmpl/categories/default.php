                ...
                <?php else : ?>
                    <table class="table" id="categoryList">
                        <caption class="visually-hidden">
                            <?php echo $this->text('COM_CATEGORIES_TABLE_CAPTION'); ?>,
                            ...
                            <tr>
                                ...
                                <?php if (isset($this->items[0]) && property_exists($this->items[0], 'count_published')) : ?>
                                    <th scope="col" class="w-3 text-center d-none d-md-table-cell">
                                        <span class="icon-check" aria-hidden="true" title="<?php echo $this->text('COM_CATEGORY_COUNT_PUBLISHED_ITEMS'); ?>"></span>
                                        <span class="visually-hidden"><?php echo $this->text('COM_CATEGORY_COUNT_PUBLISHED_ITEMS'); ?></span>
                                    </th>
                                <?php endif; ?>
                                <?php if (isset($this->items[0]) && property_exists($this->items[0], 'count_unpublished')) : ?>
                                    <th scope="col" class="w-3 text-center d-none d-md-table-cell">
                                        <span class="icon-times" aria-hidden="true" title="<?php echo $this->text('COM_CATEGORY_COUNT_UNPUBLISHED_ITEMS'); ?>"></span>
                                        <span class="visually-hidden"><?php echo $this->text('COM_CATEGORY_COUNT_UNPUBLISHED_ITEMS'); ?></span>
                                    </th>
                                <?php endif; ?>
                                <?php if (isset($this->items[0]) && property_exists($this->items[0], 'count_archived')) : ?>
                                    <th scope="col" class="w-3 text-center d-none d-md-table-cell">
                                        <span class="icon-folder icon-fw" aria-hidden="true" title="<?php echo $this->text('COM_CATEGORY_COUNT_ARCHIVED_ITEMS'); ?>"></span>
                                        <span class="visually-hidden"><?php echo $this->text('COM_CATEGORY_COUNT_ARCHIVED_ITEMS'); ?></span>
                                    </th>
                                <?php endif; ?>
                                <?php if (isset($this->items[0]) && property_exists($this->items[0], 'count_trashed')) : ?>
                                    <th scope="col" class="w-3 text-center d-none d-md-table-cell">
                                        <span class="icon-trash" aria-hidden="true" title="<?php echo $this->text('COM_CATEGORY_COUNT_TRASHED_ITEMS'); ?>"></span>
                                        <span class="visually-hidden"><?php echo $this->text('COM_CATEGORY_COUNT_TRASHED_ITEMS'); ?></span>
                                    </th>
                                <?php endif; ?>
                                ...
                                <tr class="row<?php echo $i % 2; ?>" data-draggable-group="<?php echo $item->parent_id; ?>"
                                    ...
                                    <th scope="row">
                                        ...
                                        <?php if ($canEdit || $canEditOwn) : ?>
                                            <a href="<?php echo Route::_('index.php?option=com_categories&task=category.edit&id=' . $item->id . '&extension=' . $extension); ?>" title="<?php echo $this->text('JACTION_EDIT'); ?> <?php echo $this->escape($item->title); ?>">
                                    ...
                                    <?php if (isset($this->items[0]) && property_exists($this->items[0], 'count_published')) : ?>
                                        <td class="text-center btns d-none d-md-table-cell itemnumber">
                                            ...
                                            <div role="tooltip" id="tip-publish<?php echo $i; ?>">
                                                <?php echo $this->text('COM_CATEGORY_COUNT_PUBLISHED_ITEMS'); ?>
                                            </div>
                                        </td>
                                    <?php endif; ?>
                                    <?php if (isset($this->items[0]) && property_exists($this->items[0], 'count_unpublished')) : ?>
                                        <td class="text-center btns d-none d-md-table-cell itemnumber">
                                            ...
                                            <div role="tooltip" id="tip-unpublish<?php echo $i; ?>">
                                                <?php echo $this->text('COM_CATEGORY_COUNT_UNPUBLISHED_ITEMS'); ?>
                                            </div>
                                        </td>
                                    <?php endif; ?>
                                    <?php if (isset($this->items[0]) && property_exists($this->items[0], 'count_archived')) : ?>
                                        <td class="text-center btns d-none d-md-table-cell itemnumber">
                                            ...
                                            <div role="tooltip" id="tip-archive<?php echo $i; ?>">
                                                <?php echo $this->text('COM_CATEGORY_COUNT_ARCHIVED_ITEMS'); ?>
                                            </div>
                                        </td>
                                    <?php endif; ?>
                                    <?php if (isset($this->items[0]) && property_exists($this->items[0], 'count_trashed')) : ?>
                                        <td class="text-center btns d-none d-md-table-cell itemnumber">
                                            ...
                                            <div role="tooltip" id="tip-trash<?php echo $i; ?>">
                                                <?php echo $this->text('COM_CATEGORY_COUNT_TRASHED_ITEMS'); ?>
                                            </div>
                                        </td>
                                    <?php endif; ?>
                    ...
                    if (
                        ...
                        <?php echo HTMLHelper::_(
                            ...
                            'collapseModal',
                            [
                                'title'  => $this->text('COM_CATEGORIES_BATCH_OPTIONS'),
