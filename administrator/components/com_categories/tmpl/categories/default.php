    ...
    <div class="row">
        <div class="col-md-12">
            <div id="j-main-container" class="j-main-container">
                ...
                <?php else : ?>
                    <table class="table table--collapsible" id="categoryList">
                        ...
                        <tbody <?php if ($saveOrder) :
                            ...
                            <?php foreach ($this->items as $i => $item) : ?>
                                ...
                                ?>
                                <tr class="row<?php echo $i % 2; ?>" data-draggable-group="<?php echo $item->parent_id; ?>" data-item-id="<?php echo $item->id ?>" data-parents="<?php echo $parentsStr ?>" data-level="<?php echo $item->level; ?>" data-lft="<?php echo $item->lft; ?>" data-rgt="<?php echo $item->rgt; ?>">
