...
<form action="<?php echo JRoute::_('index.php?option=com_categories&extension=' . $input->getCmd('extension', 'com_content') . '&layout=' . $layout . $tmpl . '&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="item-form" class="form-validate">
	...
	<div>
		<?php echo JHtml::_('tab.startTabSet', 'myTab', array('active' => 'general')); ?>

		<?php echo JHtml::_('tab.addTab', 'myTab', 'general', JText::_('JCATEGORY')); ?>
		<div class="row">
			<div class="col-md-9">
		...
		<?php echo JHtml::_('tab.addTab', 'myTab', 'publishing', JText::_('COM_CATEGORIES_FIELDSET_PUBLISHING')); ?>
		<div class="row">
			<div class="col-md-6">
		...
		<?php if ( ! $isModal && $assoc && $extensionassoc) : ?>
			<?php echo JHtml::_('tab.addTab', 'myTab', 'associations', JText::_('JGLOBAL_FIELDSET_ASSOCIATIONS')); ?>
		...
		<?php if ($this->canDo->get('core.admin')) : ?>
			<?php echo JHtml::_('tab.addTab', 'myTab', 'rules', JText::_('COM_CATEGORIES_FIELDSET_RULES')); ?>
