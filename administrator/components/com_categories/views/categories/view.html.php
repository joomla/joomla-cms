...
class CategoriesViewCategories extends JViewLegacy
{
	...
	protected function addToolbar()
	{
		...
		JHtml::_('sidebar.setaction', 'index.php?option=com_categories&view=categories');

		JHtml::_('sidebar.addfilter', JText::_('JOPTION_SELECT_MAX_LEVELS'), 'filter_level',
	...
	{
		return array('a.lft' => JText::_('JGRID_HEADING_ORDERING'), 'a.state' => JText::_('JSTATUS'), 'a.title' => JText::_('JGLOBAL_TITLE'),
			'a.access' => JText::_('JGRID_HEADING_ACCESS'), 'language' => JText::_('JGRID_HEADING_LANGUAGE'), 'a.id' => JText::_('JGRID_HEADING_ID'));
	}
}
