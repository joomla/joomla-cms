...
class JFormFieldModal_Category extends JFormField
{
	...
	protected function getInput()
	{
		...
		if ($allowEdit)
		{
			$html[] = '<a class="btn'.($value ? '' : ' hidden').'" href="index.php?option=com_categories&layout=modal&tmpl=component&task=category.edit&id=' . $value. '" target="_blank" title="'.JText::_('COM_CATEGORIES_EDIT_CATEGORY').'" ><span class="icon-edit"></span> ' . JText::_('JACTION_EDIT') . '</a>';
		}
