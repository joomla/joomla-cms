			...
			$html .= JHtml::_(
				...
				array(
					...
					'footer'      => '<a role="button" class="btn btn-cancel" aria-hidden="true"'
							. ' onclick="window.processModalEdit(this, \'' . $this->id . '\', \'add\', \'category\', \'cancel\'); return false;">'
							. JText::_("JLIB_HTML_BEHAVIOR_CLOSE") . '</a>'
							. '<a role="button" class="btn btn-save btn-primary hidden" aria-hidden="true"'
							. ' onclick="window.processModalEdit(this, \'' . $this->id . '\', \'add\', \'category\', \'save\'); return false;">'
							. JText::_("JSAVE") . '</a>'
							. '<a role="button" class="btn btn-apply btn-success" aria-hidden="true"'
							. ' onclick="window.processModalEdit(this, \'' . $this->id . '\', \'add\', \'category\', \'apply\'); return false;">'
							. JText::_("JAPPLY") . '</a>',
				)
			);
		}
		...
		if ($allowEdit)
		{
			$html .= JHtml::_(
				...
				array(
					...
					'modalWidth'  => '80',
					'footer'      => '<a role="button" class="btn btn-cancel" aria-hidden="true"'
							. ' onclick="window.processModalEdit(this, \'' . $this->id . '\', \'edit\', \'category\', \'cancel\'); return false;">'
							. JText::_("JLIB_HTML_BEHAVIOR_CLOSE") . '</a>'
							. '<a role="button" class="btn btn-save btn-primary" aria-hidden="true"'
							. ' onclick="window.processModalEdit(this, \'' . $this->id . '\', \'edit\', \'category\', \'save\'); return false;">'
							. JText::_("JSAVE") . '</a>'
							. '<a role="button" class="btn btn-apply btn-success" aria-hidden="true"'
							. ' onclick="window.processModalEdit(this, \'' . $this->id . '\', \'edit\', \'category\', \'apply\'); return false;">'
							. JText::_("JAPPLY") . '</a>',
				)
			);
		}
