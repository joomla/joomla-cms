...
?>
		<tr>
			<td>
				<a>
					<?php echo JHtml::image($this->_tmp_doc->icon_16, $this->_tmp_doc->name, array('width' => 16, 'height' => 16, 'border' => 0), true);?> </a>
			</td>
			...
			<td>
				<a class="delete-item" href="index.php?option=com_media&amp;task=file.delete&amp;tmpl=component&amp;<?php echo JUtility::getToken(); ?>=1&amp;folder=<?php echo $this->state->folder; ?>&amp;rm[]=<?php echo $this->_tmp_doc->name; ?>" rel="<?php echo $this->_tmp_doc->name; ?>"><?php echo JHtml::image('media/remove.png', JText::_('Delete'), array('width' => 16, 'height' => 16, 'border' => 0), true);?></a>
