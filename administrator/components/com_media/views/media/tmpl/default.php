		...
		<td>
			...
			<form action="index.php?option=com_media&amp;task=folder.create" name="folderForm" id="folderForm" method="post">
				<fieldset id="folderview">
					...
					<div class="view">
						<iframe onload="MediaManager.onloadframe();" src="index.php?option=com_media&amp;view=mediaList&amp;tmpl=component&amp;folder=<?php echo $this->state->folder;?>" id="folderframe" name="folderframe" width="100%" marginwidth="0" marginheight="0" scrolling="auto" frameborder="0"></iframe>
					</div>
				</fieldset>
			</form>
