	...
	<div class="well">
		<div class="row">
			...
			<div class="pull-right">
				<button class="btn btn-primary" type="button" onclick="<?php if ($this->state->get('field.id')):?>window.parent.jInsertFieldValue(document.getElementById('f_url').value,'<?php echo $this->state->get('field.id');?>');<?php else:?>ImageManager.onok();<?php endif;?>window.parent.jQuery('#imageModal').modal('hide');"><?php echo JText::_('COM_MEDIA_INSERT') ?></button>
				<button class="btn" type="button" onclick="window.parent.jQuery('#imageModal').modal('hide');"><?php echo JText::_('JCANCEL') ?></button>
			</div>
		</div>
	</div>
