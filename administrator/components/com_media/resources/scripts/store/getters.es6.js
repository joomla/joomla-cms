 ...
 */
export const getSelectedDirectoryDirectories = (state, getters) => state.directories.filter(
 ...
 */
export const getSelectedDirectoryFiles = (state, getters) => state.files.filter(
