			...
			<article class="thumbnail center" >
				...
				<div class="small height-20">
					<label class="checkbox">
						...
						<a target="_top" href="index.php?option=com_media&amp;controller=media.display.editor&amp;tmpl=index&amp;<?php echo JSession::getFormToken(); ?>=1&amp;folder=<?php echo $this->state->get('folder'); ?>&amp;file=<?php echo $this->_tmp_img->name; ?>" title="<?php echo $this->_tmp_img->name; ?>" class="preview"><?php echo JHtml::_('string.truncate', $this->_tmp_img->name, 8, false); ?></a>
