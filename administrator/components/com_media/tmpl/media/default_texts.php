...
Text::script('COM_MEDIA_CREATE_NEW_FOLDER_EXISTING_FOLDER_ERROR', true);
Text::script('COM_MEDIA_CREATE_NEW_FOLDER_RELATIVE_PATH_ERROR', true);
Text::script('COM_MEDIA_CREATE_NEW_FOLDER_UNEXPECTED_CHARACTER', true);
