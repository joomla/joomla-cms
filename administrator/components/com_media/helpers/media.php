...
abstract class MediaHelper
{
	 ...
	 *
	 * @since 1.5
	 * @deprectated 4.0 Use JHelperMedia instead
	 */
	 ...
	 *
	 * @since  3.2
	 * @deprecated 4.0 use JImage::resize instead
	 */
	...
	{
		JLog::add('MediaHelper::countFiles() is deprecated. Use JHelperMedia::canUpload() instead.', JLog::WARNING, 'deprecated');
		$mediaHelper = new JHelperMedia();
