 ...
 */
final class FetchMediaFilesEvent extends AbstractImmutableEvent
{
	/**
	 * Constructor.
	 *
	 ...
	 * @since   __DEPLOY_VERSION__
	 */
	protected function setFiles(array $values): array
	{
		$result = [];
	...
	protected function getFiles(array $values) {
		$result = [];
		 ...
		 * @throws BadMethodCallException
		 */
		private function validateFile(\stdClass $value): \stdClass
		{
