        ...
        <?php if (!empty($this->items)) :
            ...
            <table class="table" id="toursList">
                ...
                <caption class="visually-hidden">
                    <?php echo $this->text('COM_GUIDEDTOURS_GUIDEDTOURS_TABLE_CAPTION'); ?>,
                ...
                <tr>
                    ...
                    <th scope="col">
                        <?php echo $this->text('COM_GUIDEDTOURS_TITLE'); ?>
                    </th>
                    <th scope="col" class="d-none d-md-table-cell">
                        <?php echo $this->text('COM_GUIDEDTOURS_DESCRIPTION'); ?>
                    </th>
                    <th scope="col" class="w-10 text-center d-none d-md-table-cell">
                        <?php echo $this->text('COM_GUIDEDTOURS_STEPS'); ?>
                    </th>
                        ...
                        <th scope="row" class="has-context">
                            <div>
                                ...
                                <?php if ($canEdit || $canEditOwn) : ?>
                                    <a href="<?php echo Route::_('index.php?option=com_guidedtours&task=tour.edit&id=' . $item->id); ?>" title="<?php echo $this->text('JACTION_EDIT'); ?> <?php echo $this->escape($item->title); ?>">
