...
class JoomlaInstallerScript
{
	...
	public function deleteUnexistingFiles($dryRun = false, $suppressOutput = false)
	{
		...
		$files = array(
			...
			'/media/editors/tinymce/js/plugins/image/plugin.js',
			'/media/editors/tinymce/js/plugins/image/plugin.min.js',
			...
			'/media/plg_editors_tinymce/js/plugins/image/plugin.es6.js',
			'/media/plg_editors_tinymce/js/plugins/image/plugin.es6.min.js',
			'/media/plg_editors_tinymce/js/plugins/image/plugin.es6.min.js.gz',
		...
		$folders = array(
			...
			'/media/editors/tinymce/js/plugins/image',
