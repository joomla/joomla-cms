...
class JoomlaInstallerScript
{
     ...
     * updating from a version older than 7.0.0.
     *
     * @return  void
     *
     * @since   5.0.0
    ...
    {
        // Don't uninstall extensions when not updating from a version older than 7.0.0
        if (empty($this->fromVersion) || version_compare($this->fromVersion, '7.0.0', 'ge')) {
            return true;
        }
    ...
    public function deleteUnexistingFiles($dryRun = false, $suppressOutput = false)
    {
        ...
        $files = [
            ...
            '/administrator/components/com_admin/sql/updates/mysql/6.0.0-2025-03-25.sql',
            '/administrator/components/com_admin/sql/updates/mysql/6.0.0-2025-05-20.sql',
            '/administrator/components/com_admin/sql/updates/mysql/6.0.0-2025-08-02.sql',
            ...
            '/administrator/components/com_admin/sql/updates/mysql/6.0.0-2025-09-05.sql',
            '/administrator/components/com_admin/sql/updates/mysql/6.0.0-2025-09-16.sql',
            '/administrator/components/com_admin/sql/updates/mysql/6.0.0-2025-09-17.sql',
            '/administrator/components/com_admin/sql/updates/mysql/6.0.0-2025-09-23.sql',
            '/administrator/components/com_admin/sql/updates/mysql/6.0.0-2025-09-26.sql',
            '/administrator/components/com_admin/sql/updates/mysql/6.0.0-2025-10-11.sql',
            '/administrator/components/com_admin/sql/updates/mysql/6.0.1-2025-10-29.sql',
            '/administrator/components/com_admin/sql/updates/mysql/6.1.0-2025-10-30.sql',
            ...
            '/administrator/components/com_admin/sql/updates/mysql/6.1.0-2026-02-06.sql',
            '/administrator/components/com_admin/sql/updates/mysql/6.1.0-2026-03-07.sql',
            '/administrator/components/com_admin/sql/updates/mysql/6.1.0-2026-03-10.sql',
            '/administrator/components/com_admin/sql/updates/mysql/6.1.0-2026-03-13.sql',
            '/administrator/components/com_admin/sql/updates/postgresql/6.0.0-2024-08-11.sql',
            '/administrator/components/com_admin/sql/updates/postgresql/6.0.0-2025-03-25.sql',
            '/administrator/components/com_admin/sql/updates/postgresql/6.0.0-2025-05-20.sql',
            '/administrator/components/com_admin/sql/updates/postgresql/6.0.0-2025-08-02.sql',
            ...
            '/administrator/components/com_admin/sql/updates/postgresql/6.0.0-2025-09-05.sql',
            '/administrator/components/com_admin/sql/updates/postgresql/6.0.0-2025-09-16.sql',
            '/administrator/components/com_admin/sql/updates/postgresql/6.0.0-2025-09-17.sql',
            '/administrator/components/com_admin/sql/updates/postgresql/6.0.0-2025-09-23.sql',
            '/administrator/components/com_admin/sql/updates/postgresql/6.0.0-2025-09-26.sql',
            '/administrator/components/com_admin/sql/updates/postgresql/6.0.0-2025-10-10.sql',
            '/administrator/components/com_admin/sql/updates/postgresql/6.0.0-2025-10-11.sql',
            '/administrator/components/com_admin/sql/updates/postgresql/6.0.1-2025-10-29.sql',
            '/administrator/components/com_admin/sql/updates/postgresql/6.1.0-2025-10-30.sql',
            '/administrator/components/com_admin/sql/updates/postgresql/6.1.0-2025-11-29.sql',
            '/administrator/components/com_admin/sql/updates/postgresql/6.1.0-2026-01-29.sql',
            '/administrator/components/com_admin/sql/updates/postgresql/6.1.0-2026-02-06.sql',
    ...
    {
        // List all components added since 7.0
        $newComponents = [
    ...
    public function postflight($action, $installer)
    {
        ...
        // Add here code which shall be executed only when updating from an older version than 7.0.0
