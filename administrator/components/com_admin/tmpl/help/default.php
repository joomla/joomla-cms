		...
		<div id="sidebar" class="col-md-3">
			<div class="sidebar-nav">
				<ul class="nav flex-column">
					<li><?php echo JHtml::_('link', JHelp::createUrl('JHELP_START_HERE'), Text::_('COM_ADMIN_START_HERE'), array('target' => 'helpFrame')); ?></li>
					...
					<li><?php echo JHtml::_('link', JHelp::createUrl('JHELP_GLOSSARY'), Text::_('COM_ADMIN_GLOSSARY'), array('target' => 'helpFrame')); ?></li>
					<li class="divider"></li>
