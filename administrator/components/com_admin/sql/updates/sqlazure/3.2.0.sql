...
INSERT INTO #__update_sites (name, type, location, enabled, last_check_timestamp) VALUES('FOF Updates (official releases)','extension','http://cdn.akeebabackup.com/updates/fof.xml',1,0);

INSERT INTO #__update_sites_extensions (update_site_id, extension_id) VALUES (SCOPE_IDENTITY(), 105);