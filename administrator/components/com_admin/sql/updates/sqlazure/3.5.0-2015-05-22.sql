...
SELECT 803, 'banners', 'package', 'pkg_banners', '', 0, 1, 1, 0, '', '', '', '', 0, '1900-01-01 00:00:00', 0, 0;
...
SELECT 'Banners Update Site', 'extension', 'https://raw.githubusercontent.com/joomla-extensions/banners/master/manifest.xml', 1;

INSERT INTO [#__update_sites_extensions] ([update_site_id], [extension_id])
SELECT (SELECT [update_site_id] FROM [#__update_sites] WHERE [name] = 'Banners Update Site'), 803;