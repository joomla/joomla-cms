...
UPDATE `#__fields` SET `modified_time` = `created_time` WHERE `modified_time` = '0000-00-00 00:00:00';
UPDATE `#__fields` SET `checked_out_time` = NULL WHERE `checked_out_time` = '0000-00-00 00:00:00';

UPDATE `#__fields_groups` SET `modified` = `created` WHERE `modified` = '0000-00-00 00:00:00';
