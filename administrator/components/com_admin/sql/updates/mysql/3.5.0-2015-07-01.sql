...
-- 1. Limit indexes on utf8_bin collated columns for UTF-8 Multibyte (utf8mb4)
...
-- 2. Set eroneous columns with value NULL having a not null constraint and no default
UPDATE `#__menu` SET `alias`='' WHERE `alias` IS NULL;

-- 3. Column modifications for later conversion to utf8mb4
...
-- 4. Convert all tables to utf8mb4
