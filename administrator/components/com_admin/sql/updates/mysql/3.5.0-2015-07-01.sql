...
-- Step 1: Limit indexes to first 100 so their max allowed lengths not get exceeded with utf8mb4
...
-- Step 2: Enlarge columns to avoid data loss on conversion to utf8mb4
...
-- Step 3: Convert all tables to UTF-8 Multibyte (utf8mb4)
