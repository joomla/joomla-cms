...
UPDATE `#__modules` SET
	...
	`publish_down` = CASE WHEN `publish_down` IN (0, '1000-01-01 00:00:00') THEN NULL ELSE `publish_down` END,
	`checked_out_time` = CASE WHEN `checked_out_time` IN (0, '1000-01-01 00:00:00') THEN NULL ELSE `checked_out_time` END;
