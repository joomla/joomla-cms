...
ALTER TABLE `#__finder_links_terms0` MODIFY `weight` float unsigned NOT NULL DEFAULT 0;
ALTER TABLE `#__finder_links_terms1` MODIFY `weight` float unsigned NOT NULL DEFAULT 0;
ALTER TABLE `#__finder_links_terms2` MODIFY `weight` float unsigned NOT NULL DEFAULT 0;
ALTER TABLE `#__finder_links_terms3` MODIFY `weight` float unsigned NOT NULL DEFAULT 0;
ALTER TABLE `#__finder_links_terms4` MODIFY `weight` float unsigned NOT NULL DEFAULT 0;
ALTER TABLE `#__finder_links_terms5` MODIFY `weight` float unsigned NOT NULL DEFAULT 0;
ALTER TABLE `#__finder_links_terms6` MODIFY `weight` float unsigned NOT NULL DEFAULT 0;
ALTER TABLE `#__finder_links_terms7` MODIFY `weight` float unsigned NOT NULL DEFAULT 0;
ALTER TABLE `#__finder_links_terms8` MODIFY `weight` float unsigned NOT NULL DEFAULT 0;
ALTER TABLE `#__finder_links_terms9` MODIFY `weight` float unsigned NOT NULL DEFAULT 0;
ALTER TABLE `#__finder_links_termsa` MODIFY `weight` float unsigned NOT NULL DEFAULT 0;
ALTER TABLE `#__finder_links_termsb` MODIFY `weight` float unsigned NOT NULL DEFAULT 0;
ALTER TABLE `#__finder_links_termsc` MODIFY `weight` float unsigned NOT NULL DEFAULT 0;
ALTER TABLE `#__finder_links_termsd` MODIFY `weight` float unsigned NOT NULL DEFAULT 0;
ALTER TABLE `#__finder_links_termse` MODIFY `weight` float unsigned NOT NULL DEFAULT 0;
ALTER TABLE `#__finder_links_termsf` MODIFY `weight` float unsigned NOT NULL DEFAULT 0;
