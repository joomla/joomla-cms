...
ALTER TABLE `#__contact_details` MODIFY `modified` datetime NULL DEFAULT NULL;
...
UPDATE `#__contact_details` SET
	...
	`modified` = CASE WHEN `modified` IN ('0000-00-00 00:00:00', '1000-01-01 00:00:00') THEN NULL ELSE `modified` END;
