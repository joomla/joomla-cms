ALTER TABLE `#__ucm_content` MODIFY `core_created_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `#__ucm_content` MODIFY `core_modified_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP;
