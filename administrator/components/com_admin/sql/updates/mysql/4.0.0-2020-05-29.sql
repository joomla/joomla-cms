...
UPDATE `#__tags` SET `checked_out` = null;
UPDATE `#__update_sites` SET `checked_out` = null;
UPDATE `#__user_notes` SET `checked_out` = null;
UPDATE `#__workflows` SET `checked_out` = null;
UPDATE `#__workflow_stages` SET `checked_out` = null;
UPDATE `#__workflow_transitions` SET `checked_out` = null;
...
UPDATE `#__fields` SET `checked_out` = null;
UPDATE `#__fields_groups` SET `checked_out` = null;
UPDATE `#__ucm_content` SET `core_checked_out_user_id` = null;
