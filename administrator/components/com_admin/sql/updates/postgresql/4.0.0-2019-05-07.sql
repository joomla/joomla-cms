...
('Frontend Link', '', '', 2, 'status', 0, NULL, NULL, NULL, 1, 'mod_status_frontend', 3, 1, '', 1, '*');
...
UPDATE `#__modules` SET `title` = 'Update Checks',`note` = '',`content` = '',`ordering` = 3,`position` = 'icon',`checked_out` = 0,`checked_out_time` = NULL,`publish_up` = NULL,`publish_down` = NULL,`published` = 1,`module` = 'mod_quickicon',`access` = 3,`showtitle` = 1,`params` = '{"icon_type":"update","context":"mod_quickicon","show_global":"1","show_checkin":"1","show_cache":"1","show_users":"1","show_articles":"1","show_categories":"1","show_media":"1","show_menuItems":"1","show_modules":"1","show_plugins":"1","show_templates":"1","layout":"_:default","moduleclass_sfx":"","cache":1,"cache_time":900,"style":"0","module_tag":"div","bootstrap_size":"12","header_tag":"h3","header_class":"fa-check"}',`client_id` = 1,`language` = '*' WHERE `q6vjr_modules`.`id` = 9;ATE `#__modules` SET `id` = 9,`asset_id` = 0,`title` = 'Update Checks',`note` = '',`content` = '',`ordering` = 3,`position` = 'icon',`checked_out` = 0,`checked_out_time` = NULL,`publish_up` = NULL,`publish_down` = NULL,`published` = 1,`module` = 'mod_quickicon',`access` = 3,`showtitle` = 1,`params` = '{"icon_type":"update","context":"mod_quickicon","show_global":"1","show_checkin":"1","show_cache":"1","show_users":"1","show_articles":"1","show_categories":"1","show_media":"1","show_menuItems":"1","show_modules":"1","show_plugins":"1","show_templates":"1","layout":"_:default","moduleclass_sfx":"","cache":1,"cache_time":900,"style":"0","module_tag":"div","bootstrap_size":"12","header_tag":"h3","header_class":"fa-check"}' WHERE `#__modules`.`id` = 9;
