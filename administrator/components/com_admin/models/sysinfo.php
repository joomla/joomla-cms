...
class AdminModelSysInfo extends JModelLegacy
{
	 ...
	 *
	 * @return  string  Output of phpinfo() formatted for display
	 *
	 * @since   1.6
	 */
	 ...
	 * @param   string  $message  An optional message for display
	 *
	 * @return  void
	 *
	 * @note    Renamed from _addDirectory() and changed from private to protected at 3.1.2
	 * @since   1.6
	 */
	protected function addDirectory($name, $path, $message = '')
	{
	 ...
	 *
	 * @since   1.6
	 * @deprecated  4.0  Retrieve the editor from the global config
	 */
