...
<div class="width-50 fltrt helplinks">
	<ul class="helpmenu">
		<?php if ($this->help_url):?>
			<li><?php echo JHtml::link(JHelp::createUrl('joomla.glossary'), JText::_('Admin_Glossary'), array('target' => 'helpFrame')) ?></li>
			<li><?php echo JHtml::link(JHelp::createUrl('joomla.credits'), JText::_('Admin_Credits'), array('target' => 'helpFrame')) ?></li>
			<li><?php echo JHtml::link(JHelp::createUrl('joomla.support'), JText::_('Admin_Support'), array('target' => 'helpFrame')) ?></li>
		<?php else:?>
			<li><?php echo JHtml::link(JURI::base() .'help/'.$this->lang_tag.'/joomla.glossary.html', JText::_('Admin_Glossary'), array('target' => 'helpFrame')) ?></li>
			<li><?php echo JHtml::link(JURI::base() .'help/'.$this->lang_tag.'/joomla.credits.html', JText::_('Admin_Credits'), array('target' => 'helpFrame')) ?></li>
			<li><?php echo JHtml::link(JURI::base() .'help/'.$this->lang_tag.'/joomla.support.html', JText::_('Admin_Support'), array('target' => 'helpFrame')) ?></li>
		<?php endif;?>
		<li><?php echo JHtml::link('http://www.gnu.org/licenses/gpl-2.0.html', JText::_('Admin_License'), array('target' => 'helpFrame')) ?></li>
		<li><?php echo JHtml::link($this->latest_version_check, JText::_('Admin_Latest_Version_Check'), array('target' => 'helpFrame')) ?></li>
	</ul>
</div>
<div class="clr"> </div>
			...
			<div class="helpIndex">
				<ul class="subext">
					<?php foreach ($this->toc as $k=>$v):?>
						<li>
							<?php if ($this->help_url):?>
								<?php echo JHtml::link(JHelp::createUrl($k), $v, array('target' => 'helpFrame'));?>
							<?php else:?>
								<?php echo JHtml::link(JURI::base() .'help/'.$this->lang_tag.'/'.$k, $v, array('target' => 'helpFrame'));?>
							<?php endif;?>
						</li>
					<?php endforeach;?>
				</ul>
