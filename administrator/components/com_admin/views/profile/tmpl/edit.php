...
<form action="<?php echo JRoute::_('index.php?option=com_admin&view=profile&layout=edit&id=' . $this->item->id); ?>" method="post" name="adminForm" id="profile-form" class="js-submit-button form-validate form-horizontal" enctype="multipart/form-data">
