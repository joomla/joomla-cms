			...
			<div id="j-main-container" class="j-main-container">
				...
				<?php else : ?>
					<table class="table" id="articleList">
						...
						<thead>
							<tr>
								<th scope="col" role="columnheader" style="width:1%" class="nowrap text-center d-none d-md-table-cell">
									<?php echo HTMLHelper::_('searchtools.sort', '', 'a.ordering', $listDirn, $listOrder, null, 'asc', 'JGRID_HEADING_ORDERING', 'icon-menu-2'); ?>
								</th>
								<td style="width:1%" class="text-center">
									<?php echo HTMLHelper::_('grid.checkall'); ?>
								</td>
								<th scope="col" role="columnheader" style="width:1%" class="nowrap text-center">
									<?php echo HTMLHelper::_('searchtools.sort', 'JSTATUS', 'a.state', $listDirn, $listOrder); ?>
								</th>
								<th scope="col" role="columnheader" style="min-width:100px" class="nowrap">
									<?php echo HTMLHelper::_('searchtools.sort', 'JGLOBAL_TITLE', 'a.title', $listDirn, $listOrder); ?>
								</th>
								<th scope="col" role="columnheader" style="width:10%" class="nowrap d-none d-md-table-cell">
									<?php echo HTMLHelper::_('searchtools.sort',  'JGRID_HEADING_ACCESS', 'a.access', $listDirn, $listOrder); ?>
								</th>
								<?php if ($assoc) : ?>
									<th scope="col" role="columnheader" style="width:5%" class="nowrap d-none d-md-table-cell">
								...
								<th scope="col" role="columnheader" style="width:3%" class="nowrap d-none d-md-table-cell text-center">
								...
								<?php endif; ?>
								<th scope="col" role="columnheader" style="width:3%" class="nowrap d-none d-md-table-cell">
