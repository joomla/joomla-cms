...
class ContentViewFeatured extends JViewLegacy
{
	...
	protected function addToolbar()
	{
		...
		JHtml::_('sidebar.setaction', 'index.php?option=com_content&view=featured');
	...
	{
		return array('fp.ordering' => JText::_('JGRID_HEADING_ORDERING'), 'a.state' => JText::_('JSTATUS'), 'a.title' => JText::_('JGLOBAL_TITLE'),
