		...
		<div id="sidebar" class="span2">
			<div class="sidebar-nav">
				...
				<div class="filter-select">
					...
					<hr class="hr-condensed" />
					<label class="hide-text" for="filter_author_id">
						...
						<td class="order nowrap">             
							<?php if ($canChange) : ?>
								<div class="input-prepend">
									...
									<?php if(!$disabled = $saveOrder) : echo "<span class=\"add-on tip\" rel=\"tooltip\" title=\"".JText::_('JDISABLED')."\"><i class=\"icon-ban-circle\"></i></span>"; endif;?><input type="text" name="order[]" size="5" value="<?php echo $item->ordering;?>" <?php echo $disabled ?> title="<?php echo $item->title; ?> order" class="width-20 text-area-order" />
								</div>
							<?php else : ?>
