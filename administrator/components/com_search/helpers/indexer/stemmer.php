...
/**
 * Stemmer base class for the Search indexer package.
 *
 * @since  2.5
 */
abstract class SearchIndexerStemmer
{
	/**
	 ...
	 *
	 * @return  SearchIndexerStemmer  A SearchIndexerStemmer instance.
	 *
	 * @since   2.5
	...
	public static function getInstance($adapter)
	{
		...
		$class = 'SearchIndexerStemmer' . ucfirst($adapter);
