...
class SearchIndexerHelper
{
	 ...
	 * @since	2.5
	 */
	protected static $languageHelper = array();
	...
	public static function tokenize($input, $lang, $phrase = false)
	{
		...
		$tokens = array();
		$tokenizer = SearchIndexerLanguage::getInstance($lang);
		...
		{
			$tokens[] = new SearchIndexerToken($term, $lang);
		}
	...
	public static function stem($token, $lang)
	{
		...
		if (!isset(self::$languageHelper[$lang]))
		{
			self::$languageHelper[$lang] = SearchIndexerLanguage::getInstance($lang);
		}

		return self::$languageHelper[$lang]->stem($token);
	}
