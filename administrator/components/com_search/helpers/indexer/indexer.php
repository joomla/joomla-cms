...
/**
 * Main indexer class for the Search indexer package.
 *
 * The indexer class provides the core functionality of the Search
...
abstract class SearchIndexer
{
	...
	/**
	 * Returns a reference to the SearchIndexer object.
	 *
	 * @return  SearchIndexer instance based on the database driver
	 *
	 * @since   3.0
	...
	public static function getInstance()
	{
		...
		$class = 'SearchIndexerDriver' . ucfirst($format);
	...
	public static function getState()
	{
		...
		{
			static::$profiler = JProfiler::getInstance('SearchIndexer');
		}
	...
	protected function tokenizeToDb($input, $context, $lang, $format)
	{
		...
		if (!empty($input))
		{
			...
			else
			{
				...
				// Tokenize the input.
				$tokens = SearchIndexerHelper::tokenize($input, $lang);
