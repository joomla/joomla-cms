...
JLoader::register('SearchIndexer', __DIR__ . '/indexer.php');
JLoader::register('SearchIndexerHelper', __DIR__ . '/helper.php');
JLoader::register('SearchIndexerResult', __DIR__ . '/result.php');
JLoader::register('SearchIndexerTaxonomy', __DIR__ . '/taxonomy.php');

/**
 * Prototype adapter class for the Search indexer package.
 *
 * @since  2.5
 */
abstract class SearchIndexerAdapter extends JPlugin
{
	/**
	 ...
	 * named 'plgSearchContent', the context could be 'Content'.
	 *
	 * @var    string
	 * @since  2.5
	 */
	...
	public function __construct(&$subject, $config)
	{
		...
		{
			$this->type_id = SearchIndexerHelper::addContentType($this->type_title, $this->mime);
		}
		...
		$this->indexer = SearchIndexer::getInstance();
	}
	 ...
	 *
	 * @param   SearchIndexerResult  $item  The item to index as a SearchIndexerResult object.
	 *
	 * @return  boolean  True on success.
	 *
	 * @since   2.5
	 * @throws  Exception on database error.
	 */
	abstract protected function index(SearchIndexerResult $item);
	 ...
	 *
	 * @return  SearchIndexerResult  A SearchIndexerResult object.
	 *
	 * @since   2.5
	 * @throws  Exception on database error.
	 */
	protected function getItem($id)
	{
		...
		$item = ArrayHelper::toObject((array) $row, 'SearchIndexerResult');
