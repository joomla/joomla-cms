...
JLoader::register('SearchIndexerStemmer', dirname(__DIR__) . '/stemmer.php');

/**
 * Snowball stemmer class for the Search indexer package.
 *
 * @since  2.5
 */
class SearchIndexerStemmerSnowball extends SearchIndexerStemmer
{
	/**
