...
/**
 * Result class for the Search indexer package.
 *
...
class SearchIndexerResult
{
	...
	protected $instructions = array(
		SearchIndexer::TITLE_CONTEXT => array('title', 'subtitle', 'id'),
		SearchIndexer::TEXT_CONTEXT => array('summary', 'body'),
		SearchIndexer::META_CONTEXT => array('meta', 'list_price', 'sale_price'),
		SearchIndexer::PATH_CONTEXT => array('path', 'alias'),
		SearchIndexer::MISC_CONTEXT => array('comments')
	);
