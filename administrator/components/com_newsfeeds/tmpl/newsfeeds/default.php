                ...
                <?php else : ?>
                    <table class="table" id="newsfeedList">
                        <caption class="visually-hidden">
                            <?php echo $this->text('COM_NEWSFEEDS_TABLE_CAPTION'); ?>,
                                ...
                                <th scope="row" class="has-context">
                                    <div>
                                        ...
                                        <?php if ($canEdit || $canEditOwn) : ?>
                                            <a href="<?php echo Route::_('index.php?option=com_newsfeeds&task=newsfeed.edit&id=' . (int) $item->id); ?>" title="<?php echo $this->text('JACTION_EDIT'); ?> <?php echo $this->escape($item->name); ?>">
                    ...
                    if (
                        ...
                        <?php echo HTMLHelper::_(
                            ...
                            'collapseModal',
                            [
                                'title'  => $this->text('COM_NEWSFEEDS_BATCH_OPTIONS'),
