...
<form action="<?php echo JRoute::_('index.php?option=com_newsfeeds&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="newsfeed-form" class="form-validate form-horizontal">
	...
	<?php echo JHtml::_('bootstrap.startPane', 'myTab', array('active' => 'details')); ?>
		...
		<?php echo JHtml::_('bootstrap.addPanel', 'myTab', 'details', empty($this->item->id) ? JText::_('COM_NEWSFEEDS_NEW_NEWSFEED') : JText::sprintf('COM_NEWSFEEDS_EDIT_NEWSFEED', $this->item->id)); ?>
		...
		<?php echo JHtml::_('bootstrap.addPanel', 'myTab', 'publishing', JText::_('JGLOBAL_FIELDSET_PUBLISHING')); ?>
			<div class="control-group">
		...
		<?php foreach ($fieldSets as $name => $fieldSet) : ?>
			...
			<?php echo JHtml::_('bootstrap.addPanel', 'myTab', $paramstabs, JText::_($fieldSet->label)); ?>
		...
		<?php foreach ($fieldSets as $name => $fieldSet) : ?>
			...
			<?php echo JHtml::_('bootstrap.addPanel', 'myTab', $metadatatabs, JText::_($fieldSet->label)); ?>
