...
<form action="<?php echo Route::_('index.php?option=com_workflow&view=workflow&extension=' . $input->getCmd('extension') . '&layout=' . $layout . $tmpl . '&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="workflow-form" aria-label="<?php echo $this->text('COM_WORKFLOW_FORM_' . ((int) $this->item->id === 0 ? 'NEW' : 'EDIT'), true); ?>" class="form-validate">
        ...
        <div class="row title-alias form-vertical mb-3">
            <div class="col-md-6">
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input id="workflow_title_translation" class="form-control" value="<?php echo $this->text($this->item->title); ?>" readonly="readonly" type="text">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="main-card">
        ...
        <?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'description', $this->text('COM_WORKFLOW_DESCRIPTION'));?>
        <div class="row">
            <div class="col-lg-9">
