                ...
                <?php else : ?>
                    <table class="table">
                        <caption class="visually-hidden">
                            <?php echo $this->text('COM_WORKFLOW_WORKFLOWS_TABLE_CAPTION'); ?>,
                        ...
                        <thead>
                            <tr>
                                ...
                                <th scope="col" class="w-10 text-center d-none d-md-table-cell">
                                    <?php echo $this->text('COM_WORKFLOW_COUNT_STAGES'); ?>
                                </th>
                                <th scope="col" class="w-10 text-center d-none d-md-table-cell">
                                    <?php echo $this->text('COM_WORKFLOW_COUNT_TRANSITIONS'); ?>
                                </th>
                            ...
                            <tr class="row<?php echo $i % 2; ?>" data-draggable-group="0">
                                ...
                                <th scope="row">
                                    ...
                                    <?php if ($canEdit || $canEditOwn) : ?>
                                        <a href="<?php echo $edit; ?>" title="<?php echo $this->text('JACTION_EDIT', true); ?> <?php echo $this->text($item->title, true); ?>">
