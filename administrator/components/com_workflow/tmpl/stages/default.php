...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_workflow&task=stages.saveOrderAjax&workflow_id=' . (int) $this->workflowID . '&extension=' . $this->extension . '&' . Session::getFormToken() . '=1';
