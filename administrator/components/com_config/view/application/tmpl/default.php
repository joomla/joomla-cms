...
<form action="<?php echo JRoute::_('index.php?option=com_config'); ?>" id="application-form" method="post" name="adminForm" class="js-form form-validate" data-cancel-task="config.cancel.application"  data-skip-permissions="true">
	<div class="row-fluid">
		<!-- Begin Sidebar -->
