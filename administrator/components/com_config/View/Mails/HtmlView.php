...
namespace Joomla\Component\Config\Administrator\View\Mails;
...
class HtmlView extends BaseHtmlView
{
	...
	public function display($tpl = null)
	{
		...
		{
			list($component, $mail_id) = explode('.', $item->mail_id, 2);
	...
	protected function addToolbar()
	{
		...
		ToolbarHelper::title(Text::_('COM_CONFIG_MAILS_TITLE'), 'envelope');
