...
<div class="control-group">
    <label id="jform_menus-lbl" class="control-label" for="jform_assignment"><?php echo $this->text('COM_MODULES_MODULE_ASSIGN'); ?></label>
...
<div id="menuselect-group" class="control-group">
    <label id="jform_menuselect-lbl" class="control-label" for="jform_menuselect"><?php echo $this->text('JGLOBAL_MENU_SELECTION'); ?></label>
    <div id="jform_menuselect" class="controls">
        <?php if (!empty($menuTypes)) : ?>
        <div class="card-header">
            <section class="d-flex align-items-center flex-wrap w-100" aria-label="<?php echo $this->text('COM_MODULES_GLOBAL'); ?>">
                <div class="d-flex align-items-center flex-fill mb-1" role="group" aria-label="<?php echo $this->text('COM_MODULES_GLOBAL_ASSIGN'); ?>"><?php echo $this->text('COM_MODULES_GLOBAL_ASSIGN'); ?>
                ...
                <div class="d-flex align-items-center mb-1 flex-fill" role="group" aria-label="<?php echo $this->text('COM_MODULES_GLOBAL_TREE_EXPAND'); ?>"><?php echo $this->text('COM_MODULES_GLOBAL_TREE_EXPAND'); ?>
                ...
                <div role="search" class="flex-grow-1">
                    <label for="treeselectfilter" class="visually-hidden"><?php echo $this->text('COM_MODULES_SEARCH_MENUITEM'); ?></label>
                    <input type="text" id="treeselectfilter" name="treeselectfilter" class="form-control search-query" autocomplete="off" placeholder="<?php echo $this->text('JSEARCH_FILTER'); ?>">
                </div>
            </section>
        </div>
        <div class="card-body">
                                ...
                                <div class="treeselect-item">
                                    ...
                                    <label for="<?php echo $id . $link->value; ?>" class="">
                                        ...
                                        <?php if ($link->published == 0) : ?>
                                            <?php echo ' <span class="badge bg-secondary">' . $this->text('JUNPUBLISHED') . '</span>'; ?>
                                        <?php endif; ?>
                                        <?php if ($uselessMenuItem) : ?>
                                            <?php echo ' <span class="badge bg-secondary">' . $this->text('COM_MODULES_MENU_ITEM_' . strtoupper($link->type)) . '</span>'; ?>
                                        <?php endif; ?>
                                    </label>
                                </div>
                            <?php
                ...
                <div class="nav-hover treeselect-menu">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu">
                            <h1 class="dropdown-header"><?php echo $this->text('COM_MODULES_SUBITEMS'); ?></h1>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item checkall" href="javascript://"><span class="icon-check-square" aria-hidden="true"></span> <?php echo $this->text('JSELECT'); ?></a>
                            <a class="dropdown-item uncheckall" href="javascript://"><span class="icon-square" aria-hidden="true"></span> <?php echo $this->text('COM_MODULES_DESELECT'); ?></a>
                            <div class="treeselect-menu-expand">
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item expandall" href="javascript://"><span class="icon-plus" aria-hidden="true"></span> <?php echo $this->text('COM_MODULES_EXPAND'); ?></a>
                                <a class="dropdown-item collapseall" href="javascript://"><span class="icon-minus" aria-hidden="true"></span> <?php echo $this->text('COM_MODULES_COLLAPSE'); ?></a>
                            </div>
                        </div>
                    </div>
                </div>
