		...
		<div class="card card-secondary">
			<div class="card-header">
				<span class="small"><?php echo Text::_('JSELECT'); ?>:
					<button id="treeCheckAll" class="btn btn-link small" type="button"><span class="sr-only"><?php echo Text::_('JSELECT'); ?></span><?php echo Text::_('JALL'); ?></button>
					<button id="treeUncheckAll" class="btn btn-link small" type="button"><span class="sr-only"><?php echo Text::_('JSELECT'); ?></span><?php echo Text::_('JNONE'); ?></button>
				</span>
				<span class="width-20">|</span>
				<span class="small"><?php echo Text::_('COM_MODULES_EXPAND'); ?>:
					<button id="treeExpandAll" class="btn btn-link small" type="button"><span class="sr-only"><?php echo Text::_('COM_MODULES_EXPAND'); ?></span><?php echo Text::_('JALL'); ?></button>
					<button id="treeCollapseAll" class="btn btn-link small" type="button"><span class="sr-only"><?php echo Text::_('COM_MODULES_EXPAND'); ?></span><?php echo Text::_('JNONE'); ?></button>
				</span>
