...
class ModuleModel extends AdminModel
{
    ...
    {
        $config = array_merge(
            ['event_after_delete'  => 'onExtensionAfterDelete', 'event_after_save'    => 'onExtensionAfterSave', 'event_before_delete' => 'onExtensionBeforeDelete', 'event_before_save'   => 'onExtensionBeforeSave', 'events_map'          => ['save'   => 'extension', 'delete' => 'extension']],
            $config
        );
