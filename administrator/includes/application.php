<?php
/**
 * @version		$Id: application.php 22565 2011-12-20 07:55:23Z github_bot $
...
class JAdministrator extends JApplication
{
	...
	public function getTemplate($params = false)
	{
		...
		if (!isset($template))
		{
			...
			$query->leftJoin('#__extensions as e ON e.type='.$db->quote('template').' AND e.element='.$db->quote('s.template').' AND e.client_id='.$db->quote('s.client_id'));
			if ($admin_style)
			{
