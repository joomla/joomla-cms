...
abstract class JDatabaseQuery
{
	 ...
	 * If you have direct access to the database object, it is recommeneded you use its escape method directly.
	 *
	 ...
	 *
	 * This method is provided for use where the query object is passed to a function for modification.
	 * If you have direct access to the database object, it is recommeneded you use its nullDate method directly.
	 *
	 * Usage:
	 ...
	 *
	 * This method is provided for use where the query object is passed to a function for modification.
	 * If you have direct access to the database object, it is recommeneded you use its quote method directly.
	 *
	 ...
	 *
	 * This method is provided for use where the query object is passed to a function for modification.
	 * If you have direct access to the database object, it is recommeneded you use its quoteName method directly.
	 *
