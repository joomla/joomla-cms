...
class JFacebookStatus extends JFacebookObject
{
	...
	/**
	 * Method to delete a comment. Note: you can only delete the post if it was created by the same app.
	 * 
	...
	/**
	 * Method to unlike a status message. Note: you can only delete the like if it was created by the same app.
	 * 
	 * @param   string  $status        The status message id.
	 * @param   string  $access_token  The Facebook access token. 
	 * 
