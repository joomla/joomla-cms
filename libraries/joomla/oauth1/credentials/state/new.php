...
class JOAuth1CredentialsStateNew extends JOAuth1CredentialsState
{
	...
	public function initialise($clientKey, $callbackUrl, $lifetime = 3600)
	{
		...
		$this->properties['type'] = JOAuth1Credentials::TEMPORARY;
		$this->properties['temporary_expiration_date'] = time() + $lifetime;

		// Persist the object in the database.
		$this->create();

		return new JOAuth1CredentialsStateTemporary($this->db, $this->properties);
	}
