...
class JFormFieldRepeatable extends JFormField
{
	...
	protected function getInput()
	{
		...
		// Append buttons
		$head_row_str[] = '<th><div class="btn-group"><a href="#" class="add btn button btn-success" aria-label="' .  JText::_('JGLOBAL_FIELD_ADD') . '"><span class="icon-plus" aria-hidden="true"></span> </a></div></th>';
		$body_row_str[] = '<td><div class="btn-group">';
		$body_row_str[] = '<a class="add btn button btn-success" aria-label="' .  JText::_('JGLOBAL_FIELD_ADD') . '><span class="icon-plus" aria-hidden="true"></span> </a>';
		$body_row_str[] = '<a class="remove btn button btn-danger" aria-label="' .  JText::_('JGLOBAL_FIELD_REMOVE') . '><span class="icon-minus" aria-hidden="true"></span> </a>';
		$body_row_str[] = '</div></td>';
