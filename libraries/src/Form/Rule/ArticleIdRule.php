 ...
 */
class ArticleIdRule extends FormRule implements DatabaseAwareInterface
{
    use DatabaseAwareTrait;

    /**
     * Method to test the validity of a Joomla Article.
     *
    ...
    public function test(\SimpleXMLElement $element, $value, $group = null, ?Registry $input = null, ?Form $form = null)
    {
        ...
        $query->select('COUNT(*)')
            ...
            ->bind(':articleId', $value, ParameterType::INTEGER);
