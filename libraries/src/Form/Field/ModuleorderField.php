...
class ModuleorderField extends FormField
{
    ...
    protected function getLayoutData()
    {
        ...
        $extraData = ['ordering' => $this->form->getValue('ordering'), 'clientId' => $this->form->getValue('client_id'), 'moduleId' => $this->form->getValue('id'), 'name'     => $this->name, 'token'    => Session::getFormToken() . '=1', 'element'  => $this->form->getName() . '_' . $this->linked];
