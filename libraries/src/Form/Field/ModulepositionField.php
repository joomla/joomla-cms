...
class ModulepositionField extends TextField
{
    ...
    protected function getInput()
    {
        ...
        $html[] = HTMLHelper::_(
            ...
            'modulePositionModal',
            ['url'    => $link, 'title'  => Text::_('COM_MODULES_CHANGE_POSITION_BUTTON'), 'height' => '100%', 'width'  => '100%', 'modalWidth'  => '800', 'bodyHeight'  => '450', 'footer' => '<button type="button" class="btn btn-secondary" data-bs-dismiss="modal" aria-hidden="true">'
