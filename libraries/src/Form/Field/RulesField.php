...
class RulesField extends FormField
{
	...
	protected function getInput()
	{
		...
		// Begin tabs
		$html[] = '<joomla-tab orientation="vertical" data-ajaxuri="' . $ajaxUri . '" id="permissions-sliders">';
		...
		foreach ($groups as $group)
		{
			...
			$html[] = '<section class="tab-pane' . $active . '" name="' .
				htmlentities(LayoutHelper::render('joomla.html.treeprefix', array('level' => $group->level + 1)), ENT_COMPAT, 'utf-8') . $group->text .
