	...
	protected function getInput()
	{
		...
		switch (strtoupper($this->filter))
		{
			case 'SERVER_UTC':
				...
				if ($this->value !== null && $this->value !== false && $this->value != Factory::getDbo()->getNullDate())
				{
		...
		if ($this->value !== null && $this->value !== false && $this->value != Factory::getDbo()->getNullDate() && strtotime($this->value) !== false)
		{
