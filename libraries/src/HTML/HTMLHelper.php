...
abstract class HTMLHelper
{
	 ...
	 *                                     -1: Returns a `<img>` tag without
	 *                                     looking for relative files 0: Returns a
	 *                                     `<img>` tag while searching for relative
	 *                                     files 1: Returns the file path to the
	 ...
	 *                            The array can have the
	 *                            following keys: readonly
	 *                            Sets the readonly
	 *                            parameter for the input
	 *                            tag disabled      Sets the
	 *                            disabled parameter for the
	 *                            input tag autofocus
	 *                            Sets the autofocus
	 *                            parameter for the input
	 *                            tag autocomplete  Sets the
	 *                            autocomplete parameter for
	 *                            the input tag filter
