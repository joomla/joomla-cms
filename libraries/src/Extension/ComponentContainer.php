...
class ComponentContainer extends Container implements ComponentContainerInterface
{
	...
	/**
	 * Returns the dispatcher. If the dispatcher is not available
	 * null is returned.
	 *
	 ...
	 * @since  __DEPLOY_VERSION__
	 */
	public function getDispatcher(CMSApplicationInterface $app)
	{
		$serviceName = $app->isClient('site') ? 'site.dispatcher' : 'administrator.dispatcher';
