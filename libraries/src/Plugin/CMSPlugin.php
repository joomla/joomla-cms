...
abstract class CMSPlugin implements DispatcherAwareInterface, PluginInterface, LanguageAwareInterface
{
     ...
     * parameter, for best performance. Also bear in mind that Joomla! 7.x onwards will only allow proper listeners,
     ...
     * preferred way to implement plugins in Joomla! 4.x and will be the only possible method with Joomla! 7.x onwards.
     *
     * @param   string  $methodName  The method name to register
     *
     * @return  void
