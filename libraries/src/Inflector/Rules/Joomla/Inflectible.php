...
class Inflectible
{
    ...
    public static function getSingular(): iterable
    {
        ...
        // Joomla adds "es" at the end if the word would end with a "s", English reference implementation would not add anything which means same word as plural
        yield new Transformation(new Pattern('ses$'), 's');
    ...
    public static function getPlural(): iterable
    {
        ...
        // Joomla adds "es" at the end if the word would end with a "s", English reference implementation would not add anything which means same word as singular
        yield new Transformation(new Pattern('s$'), 'ses');
        // An empty string returns an empty string
        yield new Transformation(new Pattern('^$'), '');
        // All other words get an "s" attached to the end
        yield new Transformation(new Pattern('$'), 's');
    }
