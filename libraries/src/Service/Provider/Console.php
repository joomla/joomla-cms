...
class Console implements ServiceProviderInterface
{
    ...
    public function register(Container $container)
    {
        ...
        $container->share(
            ExportCommand::class,
            fn(Container $container) => new ExportCommand($container->get('db')),
            true
        );

        $container->share(
            ImportCommand::class,
            fn(Container $container) => new ImportCommand($container->get('db')),
            true
        );
        ...
        $container->share(
            ...
            fn(Container $container) => new ExtensionsListCommand($container->get('db')),
            true
        );
        ...
        $container->share(
            ...
            fn(Container $container) => new ExtensionDiscoverInstallCommand($container->get('db')),
            true
        );

        $container->share(
            ExtensionDiscoverListCommand::class,
            fn(Container $container) => new ExtensionDiscoverListCommand($container->get('db')),
            true
        );

        $container->share(
            UpdateCoreCommand::class,
            fn(Container $container) => new UpdateCoreCommand($container->get('db')),
            true
        );

        $container->share(
            FinderIndexCommand::class,
            fn(Container $container) => new FinderIndexCommand($container->get('db')),
            true
        );
