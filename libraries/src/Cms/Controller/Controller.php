...
<<<<<<< HEAD:libraries/src/Cms/Controller/BaseController.php
	 *                                        Recognized key values include 'name', 'default_task', 'model_path', and
	 *                                        'view_path' (this list is not meant to be comprehensive).
=======
	 *                                     Recognized key values include 'name', 'default_task', 'model_path', and
	 *                                     'view_path' (this list is not meant to be comprehensive).
>>>>>>> parent of b3b2690464... Change Controller to BaseController:libraries/src/Cms/Controller/Controller.php
