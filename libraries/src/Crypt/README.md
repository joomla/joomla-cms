...
If you're going to use JCrypt in any of your extensions, make *sure* you use **CryptoCipher** (requires mcrypt to be installed) or **SodiumCipher**; These are the only two which are cryptographically secure.
