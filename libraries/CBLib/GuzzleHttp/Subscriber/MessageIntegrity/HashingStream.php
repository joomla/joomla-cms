...
class HashingStream implements StreamInterface
{
	...
	*/
     ...
     * @param HashInterface   $hash       Hash used to calculate the checksum.
     * @param callable        $onComplete Optional function to invoke when the
     *     hash calculation has been completed.
     */
