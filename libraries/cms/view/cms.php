...
abstract class JViewCms implements JView
{
	...
	protected function loadPaths()
	{
		...
		$paths->insert(JPATH_BASE . '/templates/' . $app->getTemplate() . '/html/' . $componentFolder . '/' . $viewName, 100);
		$paths->insert(JPATH_BASE . '/components/' . $componentFolder . '/view/' . $viewName . '/tmpl', 10);
