...
class JFormFieldEditor extends JFormFieldTextarea
{
	...
	public function setup(SimpleXMLElement $element, $value, $group = null)
	{
		...
		if ($result == true)
		{
			$this->height      = $element['height'] ? (string) $element['height'] : '250';
			...
			$this->__set('buttons', $element['buttons']);
			$this->__set('hide', $element['hide']);
			$this->__set('editorType', $element['editor']);
		}
