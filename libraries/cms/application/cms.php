...
class JApplicationCms extends JApplicationWeb
{
	...
	public function execute()
	{
		...
		if ($this->get('gzip') && !ini_get('zlib.output_compression') && (ini_get('output_handler') != 'ob_gzhandler') && ($_SERVER['HTTP_USER_AGENT'] != 'facebookexternalhit/1.1 (+http://www.facebook.com/externalhit_uatext.php)'))
		{
			$this->compress();
	...
	public function toString($compress = false)
	{
		...
		if ($compress && !ini_get('zlib.output_compression') && ini_get('output_handler') != 'ob_gzhandler' && ($_SERVER['HTTP_USER_AGENT'] != 'facebookexternalhit/1.1 (+http://www.facebook.com/externalhit_uatext.php)'))
		{
			$this->compress();
		}
