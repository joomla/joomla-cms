  ...
  class Overrider {
    ...
    insertResults(results) {
      ...
      if (!results.length) {
        ...
        noresult.innerHTML = Joomla.sanitizeHtmlJoomla.Text._('COM_LANGUAGES_VIEW_OVERRIDE_NO_RESULTS'));
