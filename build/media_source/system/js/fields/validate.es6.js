  ...
  markInvalid(element, empty) {
    ...
    if (!mesgCont) {
      ...
      if (empty && empty === 'checkbox') {
        elMsg.innerHTML = Joomla.sanitize(message) || Joomla.sanitize(Joomla.Text._('JLIB_FORM_FIELD_REQUIRED_CHECK'));
      } else if (empty && empty === 'value') {
        elMsg.innerHTML = Joomla.sanitize(message) || Joomla.sanitize(Joomla.Text._('JLIB_FORM_FIELD_REQUIRED_VALUE'));
      } else {
        elMsg.innerHTML = Joomla.sanitize(message) || Joomla.sanitize(Joomla.Text._('JLIB_FORM_FIELD_INVALID_VALUE'));
      }
