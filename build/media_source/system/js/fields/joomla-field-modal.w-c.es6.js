...
class JoomlaFieldModal extends HTMLElement {
  ...
  openModal(title, body, footer, modalOptions) {
    ...
    const mod = new bootstrap.Modal(modalWrapper, modalOptions);
    modalWrapper.addEventListener('hidden.bs.modal', () => modalWrapper.parentNode.removeChild(modalWrapper), { once: true });
    mod.show();
    Joomla.Modal.setCurrent(modalWrapper);

    const promise = new Promise((resolve, reject) => {
      modalWrapper.addEventListener('hide.bs.modal', () => {
...
customElements.define('joomla-field-modal', JoomlaFieldModal);
