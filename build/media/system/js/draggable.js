...
document.addEventListener('DOMContentLoaded', () => {
  ...
  let url; let formSelector; let direction; let isNested; let container = document.querySelector('.js-draggable');
  ...
  if (container) {
    ...
    const getOrderData = function (container, direction) {
      let i; let l; const result = [];
