...
module.exports.patchPackages = async (options) => {
  ...
  const chosenPath = `${dest}/${options.joomlaSettings.vendors['chosen-js'].js['chosen.jquery.js']}`;
  ...
  const shortandsweetPath = `${dest}/${options.joomlaSettings.vendors['short-and-sweet'].js['dist/short-and-sweet.min.js']}`;
