...
/**
 * Method that will crawl the media_source folder, compile `.mjs` files
 * and copy any ES5 files `.js` to the appropriate destination and minify them in place
 *
 * Expects ES6 files to have ext: .mjs
 *         ES5 files to have ext: .js
 *
