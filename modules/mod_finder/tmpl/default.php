...
<form id="mod-finder-searchform<?php echo $module->id; ?>" action="<?php echo JRoute::_($route); ?>" method="get" class="form-search"<?php if ($params->get('module_id')) : ?> id="<?php echo $params->get('module_id'); ?>"<?php endif;?>>
