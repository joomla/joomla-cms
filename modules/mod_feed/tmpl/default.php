...
else
{
	...
	if ($feed != false)
	{
		...
		?>
		<div style="direction: <?php echo $rssrtl ? 'rtl' :'ltr'; ?>; text-align: <?php echo $rssrtl ? 'right' :'left'; ?> ! important"  class="feed<?php echo $moduleclass_sfx; ?>"<?php if ($params->get('module_id')) : ?> id="<?php echo $params->get('module_id'); ?>"<?php endif;?>>
		<?php
		// Feed description
