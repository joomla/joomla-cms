	...
	<tr>
		<td>
			<div align="center">
				...
				&nbsp;
				<input type="button" name="option" class="button" value="<?php echo JText::_('Results'); ?>" onclick="document.location.href='<?php echo JRoute::_("index.php?option=com_poll&task=results&id=$item->id"); ?>'" />
			</div>
		</td>
	</tr>
</table>
