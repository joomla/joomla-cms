describe('Test in frontend that the related items module', () => {
  it('can display a list of related articles based on the metakey field', () => {
    cy.db_createArticle({ title: 'Main Article', metakey: 'joomla', featured: 1, created: '2022-09-09 20:00:00', modified: '2022-09-09 20:00:00', publish_up: '2022-09-09 20:00:00' })
