describe('Test in frontend that the privacy request view', () => {
  ...
  it('can submit an information request of type export without a menu item', () => {
    ...
    cy.task('getMails').then((mails) => {
      cy.get('.alert-message').should(
        'contain.text',
        'Your information request has been created. Before it can be processed, you must verify this request. An email has been sent to your address with additional instructions to complete this verification.',
      );
  ...
  it('can submit an information request of type export in a menu item', () => {
    cy.db_createMenuItem({
      title: 'Automated export information',
  ...
  it('can submit an information request of type remove in a menu item', () => {
    cy.db_createMenuItem({
      title: 'Automated remove information',
      link: 'index.php?option=com_privacy&view=request',
    }).then(() => {
      cy.visit('/');
  ...
  it('can verify link sent to user is valid', () => {
    ...
    cy.task('getMails').then((mails) => {
      ...
      cy.get('.alert-message').should(
        'have.text',
        'Your information request has been confirmed. We will process your request as soon as possible and the export will be sent to your email.',
      );
    });
  });
