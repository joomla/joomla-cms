describe('Test in frontend that the content', () => {
  it('can display an archived article in menu item', () => {
  ...
  it('can display an archived article without menu item', () => {
  ...
  it('can not display an unarchived article', () => {
    cy.db_createMenuItem({ title: 'automated test archive article', link: 'index.php?option=com_content&view=archive' })
      ...
      .then(() => {
        ...
        cy.contains('article 1').should('not.exist');
