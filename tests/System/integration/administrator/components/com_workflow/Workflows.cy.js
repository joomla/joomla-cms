describe('Test in backend that the workflows list', () => {
  ...
  it('can enable the workflow', () => {
    cy.db_createWorkflow({ title: 'Test workflow', extension: 'com_content.article', published: 0 }).then(() => {
      cy.reload();
  ...
  it('can disable the workflow', () => {
    cy.db_createWorkflow({ title: 'Test workflow', extension: 'com_content.article', published: 1 }).then(() => {
      cy.reload();
  ...
  it('can delete the workflow', () => {
    cy.db_createWorkflow({ title: 'Test workflow', extension: 'com_content.article', published: -2 }).then(() => {
      cy.reload();
  ...
  it('can set workflow as default (grid button)', () => {
    cy.db_createWorkflow({ title: 'Test workflow', extension: 'com_content.article', default: 0 }).then(() => {
      cy.reload();
      cy.searchForItem('Test workflow');
  ...
  it('can filter state', () => {
    cy.db_createWorkflow({ title: 'Test workflow 1', extension: 'com_content.article', published: 1 })
      .then(() => cy.db_createWorkflow({ title: 'Test workflow 2', extension: 'com_content.article', published: 0 }))
      .then(() => cy.db_createWorkflow({ title: 'Test workflow 3', extension: 'com_content.article', published: -2 }))
      .then(() => {
        cy.reload();
