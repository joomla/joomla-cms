describe('Test in backend that the Installer', () => {
  ...
  it('can install and uninstall a component from URL tab', () => {
    ...
    cy.get('button#installbutton_url').should(
      'contain.text',
      'Check & Install',
    );
    cy.get('input#install_url').type(
      'https://github.com/joomla-extensions/patchtester/releases/download/4.4.0/com_patchtester_4.4.0.zip',
      { force: true },
