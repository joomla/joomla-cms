describe('Test that field contact API endpoint', () => {
  ...
  it('can update a field', () => {
    cy.db_createField({ title: 'automated test field', access: 1, context: 'com_contact.contact' })
  ...
  it('can delete a field', () => {
    cy.db_createField({ title: 'automated test field', state: -2, context: 'com_contact.contact' })
