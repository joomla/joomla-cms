describe('Test that content API endpoint', () => {
  ...
  it('can deliver a list of articles filtered by the modified start and end filter', () => {
    cy.db_createArticle({
      title: 'automated test article before',
      modified: '2025-03-15 10:00:00',
    })
      .then(() =>
        cy.db_createArticle({
          title: 'automated test article within',
          modified: '2025-03-15 15:00:00',
        }),
      )
      .then(() =>
        cy.db_createArticle({
          title: 'automated test article after',
  ...
  it('can update an article', () => {
    cy.db_createArticle({ title: 'automated test article' })
      .then((article) =>
        cy.api_patch(`/content/articles/${article.id}`, {
