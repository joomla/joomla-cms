describe('Test that the featuring workflow plugin', () => {
  ...
  afterEach(() => {
    cy.task('queryDB', "DELETE FROM #__workflow_associations WHERE item_id = (SELECT id FROM #__content WHERE title = 'Article featuring') AND extension = 'com_content.article'");
