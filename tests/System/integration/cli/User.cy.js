describe('Test that console command user', () => {
  it('can list users', () => {
    cy.exec(`php ${Cypress.expose('cmsPath')}/cli/joomla.php user:list`)
      .its('stdout')
