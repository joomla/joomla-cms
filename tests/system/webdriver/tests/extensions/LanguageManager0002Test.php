...
class LanguageManager0002Test extends JoomlaWebdriverTestCase
{
  /**
	...
	public function setFilter_SetFilterValues_ShouldExecuteFilter()
	{
		...
		$this->languageManagerPage->deleteItem($langName);
	...
	public function setFilter_TestFilters_ShouldFilterTags()
	{
		...
		$image_prefix = 'Sample2'; //Other than the Default Value
		...
		$this->languageManagerPage->deleteItem($langName_1);
		$this->languageManagerPage->deleteItem($langName_2);
	}
