  ...
  /**
	...
	*/
	...
	public function changeFeedState_ChangeEnabledUsingToolbar_EnabledChanged()
	{
		...
		$this->newsFeedManagerPage->changeFeedState('Test Feed', 'published');
		$state = $this->newsFeedManagerPage->getState('Test Feed');
		$this->assertEquals('published', $state, 'State should be published');
		$this->newsFeedManagerPage->deleteItem('Test Feed');
	}
