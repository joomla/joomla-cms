...
class RedirectManager0002Test extends JoomlaWebdriverTestCase
{
  /**
	...
	public function setFilter_SetFilterValues_ShouldExecuteFilter()
	{
		...
		$this->redirectManagerPage->deleteItem($srcName);
	...
	{
		$srcName_1 = 'Test Filter 1';
		$srcName_2 = 'Test Filter 2';
		...
		$this->redirectManagerPage->deleteItem($srcName_1);
		$this->redirectManagerPage->deleteItem($srcName_2);
	}
