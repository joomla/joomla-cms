...
class WeblinkEditPage extends AdminEditPage
{
	 ...
	 * @since  3.2
	 */
	public $tabs = array('details', 'publishing', 'attrib-jbasic', 'attrib-images');
	...
	public $inputFields = array (
			...
			array('label' => 'First image', 'id' => 'jform_params_image_first', 'type' => 'input', 'tab' => 'attrib-images'),
			array('label' => 'Image Float', 'id' => 'jform_params_float_first', 'type' => 'select', 'tab' => 'attrib-images'),
			array('label' => 'Alt text', 'id' => 'jform_params_image_first_alt', 'type' => 'input', 'tab' => 'attrib-images'),
			array('label' => 'Caption', 'id' => 'jform_params_image_first_caption', 'type' => 'input', 'tab' => 'attrib-images'),
			array('label' => 'Second image', 'id' => 'jform_params_image_second', 'type' => 'input', 'tab' => 'attrib-images'),
			array('label' => 'Image Float', 'id' => 'jform_params_float_second', 'type' => 'select', 'tab' => 'attrib-images'),
			array('label' => 'Alt text', 'id' => 'jform_params_image_second_alt', 'type' => 'input', 'tab' => 'attrib-images'),
			array('label' => 'Caption', 'id' => 'jform_params_image_second_caption', 'type' => 'input', 'tab' => 'attrib-images'),
			);
