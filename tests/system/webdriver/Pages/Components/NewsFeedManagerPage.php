...
class NewsFeedManagerPage extends AdminManagerPage
{
  /**
	 ...
	 * 
	 * @param string    $link_news_feed Test URL for the News Feed
	 * 
	 ...
	 */
	public function addFeed($name='Test Feed', $link_news_feed= 'Test',$category= 'Sample Data-Newsfeeds', $description='Sample', $caption='',$alt='')
	{
		$new_name = $name;
		$this->clickButton('toolbar-new');
		$newsFeedEditPage = $this->test->getPageObject('NewsFeedEditPage');
		$newsFeedEditPage->setFieldValues(array('Title' => $name, 'Link' => $link_news_feed, 'Category'=>$category, 'Description'=>$description, 'Caption'=>$caption, 'Alt text'=>$alt));
