...
class NewsFeedManagerPage extends AdminManagerPage
{
  /**
	 ...
	 */
	public function addFeed($name='Test Tag', $category= 'Sample Data-Newsfeeds', $description='Sample', $caption='',$alt='')
	{
		$new_name = $name;
		$this->clickButton('toolbar-new');
		$newsFeedEditPage = $this->test->getPageObject('NewsFeedEditPage');
		$newsFeedEditPage->setFieldValues(array('Title' => $name, 'Category'=>$category, 'Description'=>$description, 'Caption'=>$caption, 'Alt text'=>$alt));
