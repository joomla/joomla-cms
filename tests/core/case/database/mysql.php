...
abstract class TestCaseDatabaseMysql extends TestCaseDatabase
{
	...
	protected function setUp()
	{
		...
		{
			$this->markTestSkipped('The JDatabaseDriverMysql test DSN has not been defined.');
		}
		else
		{
			$this->_dsn = defined('JTEST_DATABASE_MYSQL_DSN') ? JTEST_DATABASE_MYSQL_DSN : getenv('JTEST_DATABASE_MYSQL_DSN');
		}
	}
}
