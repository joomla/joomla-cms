...
abstract class TestCaseDatabaseMysqli extends TestCaseDatabase
{
	...
	protected function setUp()
	{
		...
		{
			$this->markTestSkipped('The JDatabaseDriverMysqli test DSN has not been defined.');
		}
		else
		{
			$this->_dsn = defined('JTEST_DATABASE_MYSQLI_DSN') ? JTEST_DATABASE_MYSQLI_DSN : getenv('JTEST_DATABASE_MYSQLI_DSN');
		}
	}
}
