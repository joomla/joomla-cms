...
class JFeedFactoryTest extends TestCase
{
	...
	{
		$this->_instance->getFeed(JPATH_BASE . '/test.bad.feed');
	}
	...
	{
		$this->_instance->getFeed(JPATH_BASE . '/test.myfeed.feed');
	}
	...
	public function testGetFeedMockParser()
	{
		...
		$this->assertEquals($this->_instance->getFeed(JPATH_BASE . '/test.myfeed.feed'), 'test');
	}
	...
	{
		$this->_instance->getFeed(JPATH_BASE . '/test.feed');
	}
