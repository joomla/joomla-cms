...
class JViewTest extends PHPUnit_Framework_TestCase
{
	...
	public function testGet()
	{
		...
		$test2->name = 'test2';
		$view->_models = array('test1' => new ModelMockupJView(), 'test2' => $test2);
		$view->_defaultModel = 'test1';

		$this->assertThat($view->get('name'), $this->equalTo('model'));

		$this->assertThat($view->get('test'), $this->equalTo('pass'));

		$this->assertThat($view->get('name', 'test2'), $this->equalTo('test2'));
	}
	...
	public function testGetLayout()
	{
		...
		$this->assertThat($view->getLayout(), $this->equalTo('default'));

		$view->_layout = 'test';

		$this->assertThat($view->getLayout(), $this->equalTo('test'));
	}
	...
	public function testGetModel()
	{
		...
		$this->assertThat($view->getModel('test'), $this->equalTo($model2));

		//Assert that the function returns the model with an unspecific key
		$this->assertThat($view->getModel('Model'), $this->equalTo($model1));

		//Assert that the function returns the default model
		$this->assertThat($view->getModel(), $this->equalTo($model3));
	}
	...
	public function testGetLayoutTemplate()
	{
		...
		$this->assertThat($view->getLayoutTemplate(), $this->equalTo('_'));

		$view->_layoutTemplate = '-';

		$this->assertThat($view->getLayoutTemplate(), $this->equalTo('-'));
	}
	...
	public function testGetName()
	{
		...
		$this->assertThat($view->getName(), $this->equalTo('inspector'));

		$view->name = 'inspector2';

		$this->assertThat($view->getName(), $this->equalTo('inspector2'));
	}
	...
	public function testSetModel()
	{
		...
		$this->assertThat($view->_models, $this->equalTo($models));

		//Assert that setModel() returns the model handed over
		$this->assertThat($view->setModel($model1), $this->equalTo($model1));
		$models['model'] = $model1;
		...
		$this->assertThat($view->_defaultModel, $this->equalTo(''));
		...
		$this->assertThat($view->_defaultModel, $this->equalTo('defaulttest'));
	}
	...
	public function testSetLayout()
	{
		...
		$this->assertThat($view->_layout, $this->equalTo('default'));

		$view->setLayout('test');

		$this->assertThat($view->_layout, $this->equalTo('test'));

		$this->assertThat($view->_layoutTemplate, $this->equalTo('_'));

		$view->setLayout('-:test2');

		$this->assertThat($view->_layout, $this->equalTo('test2'));

		$this->assertThat($view->_layoutTemplate, $this->equalTo('-'));
	}
	...
	public function testSetLayoutExt()
	{
		...
		$this->assertThat($view->_layoutExt, $this->equalTo('php'));

		$view->setLayoutExt('tmpl');

		$this->assertThat($view->_layoutExt, $this->equalTo('tmpl'));
	}
	...
	public function testSetEscape()
	{
		...
		$this->assertThat($view->_escape, $this->equalTo('htmlspecialchars'));

		$view->setEscape('escapefunc');

		$this->assertThat($view->_escape, $this->equalTo('escapefunc'));

		$view->setEscape(array('EscapeClass', 'func'));

		$this->assertThat($view->_escape, $this->equalTo(array('EscapeClass', 'func')));
	}
	...
	public function testAddTemplatePath()
	{
		...
		$this->assertThat($view->_path,
			$this->equalTo(array('helper' => array(), 'template' => array(JPATH_ROOT . '/libraries' . DIRECTORY_SEPARATOR))));
		...
		$this->assertThat($view->_path,
			$this->equalTo(
				array(
					'helper' => array(),
					'template' => array(JPATH_ROOT . '/tests' . DIRECTORY_SEPARATOR, JPATH_ROOT . '/libraries' . DIRECTORY_SEPARATOR))));
	}
	...
	public function testAddHelperPath()
	{
		...
		$this->assertThat($view->_path,
			$this->equalTo(array('helper' => array(JPATH_ROOT . '/libraries' . DIRECTORY_SEPARATOR), 'template' => array())));
		...
		$this->assertThat($view->_path,
			$this->equalTo(
				array(
					'helper' => array(JPATH_ROOT . '/tests' . DIRECTORY_SEPARATOR, JPATH_ROOT . '/libraries' . DIRECTORY_SEPARATOR),
					'template' => array())));
	}
	...
	public function test_addPath()
	{
		...
		$this->assertThat($view->_path,
			$this->equalTo(
				array(
					'helper' => array(JPATH_ROOT . '/tests' . DIRECTORY_SEPARATOR),
		...
		$this->assertThat($view->_path,
			$this->equalTo(
				array(
					'helper' => array(JPATH_ROOT . '/libraries' . DIRECTORY_SEPARATOR, JPATH_ROOT . '/tests' . DIRECTORY_SEPARATOR),
					'template' => array(JPATH_ROOT . '/tests' . DIRECTORY_SEPARATOR, JPATH_ROOT . '/libraries' . DIRECTORY_SEPARATOR))));
	}
