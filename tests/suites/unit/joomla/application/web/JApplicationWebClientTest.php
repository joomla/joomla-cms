...
class JApplicationWebClientTest extends PHPUnit_Framework_TestCase
{
	...
	public static function getUserAgentData()
	{
		...
		return array(
			array(JApplicationWebClient::WINDOWS, false, JApplicationWebClient::TRIDENT, JApplicationWebClient::IE, '10', 'Mozilla/5.0 (compatible; MSIE 10.0; Windows NT 6.1; WOW64; Trident/6.0)'),
			array(JApplicationWebClient::WINDOWS, false, JApplicationWebClient::TRIDENT, JApplicationWebClient::IE, '9', 'Mozilla/5.0 (Windows; U; MSIE 9.0; WIndows NT 9.0; en-US))'),
			array(JApplicationWebClient::WINDOWS, false, JApplicationWebClient::TRIDENT, JApplicationWebClient::IE, '8', 'Mozilla/5.0 (compatible; MSIE 8.0; Windows NT 6.0; Trident/4.0; WOW64; Trident/4.0; SLCC2; .NET CLR 2.0.50727; .NET CLR 3.5.30729; .NET CLR 3.0.30729; .NET CLR 1.0.3705; .NET CLR 1.1.4322)'),
			array(JApplicationWebClient::WINDOWS, false, JApplicationWebClient::TRIDENT, JApplicationWebClient::IE, '7.0b', 'Mozilla/4.0(compatible; MSIE 7.0b; Windows NT 6.0)'),
			array(JApplicationWebClient::WINDOWS, false, JApplicationWebClient::TRIDENT, JApplicationWebClient::IE, '7.0b', 'Mozilla/4.0 (compatible; MSIE 7.0b; Windows NT 5.1; Media Center PC 3.0; .NET CLR 1.0.3705; .NET CLR 1.1.4322; .NET CLR 2.0.50727; InfoPath.1)'),
			array(JApplicationWebClient::WINDOWS, false, JApplicationWebClient::TRIDENT, JApplicationWebClient::IE, '7', 'Mozilla/5.0 (Windows; U; MSIE 7.0; Windows NT 5.2)'),
			array(JApplicationWebClient::WINDOWS, false, JApplicationWebClient::TRIDENT, JApplicationWebClient::IE, '6.1', 'Mozilla/4.0 (compatible; MSIE 6.1; Windows XP)'),
			array(JApplicationWebClient::WINDOWS, false, JApplicationWebClient::TRIDENT, JApplicationWebClient::IE, '6', 'Mozilla/4.0 (compatible;MSIE 6.0;Windows 98;Q312461)'),
			array(JApplicationWebClient::WINDOWS, false, JApplicationWebClient::TRIDENT, JApplicationWebClient::IE, '7', 'Mozilla/4.0 (compatible; MSIE 7.0; AOL 9.6; AOLBuild 4340.128; Windows NT 5.1; Trident/4.0; .NET CLR 1.1.4322; .NET CLR 2.0.50727; .NET CLR 3.0.04506.648; .NET CLR 3.5.21022)'),
			array(JApplicationWebClient::WINDOWS, false, JApplicationWebClient::TRIDENT, JApplicationWebClient::IE, '8', 'Mozilla/4.0 (compatible; MSIE 8.0; Windows NT 6.1; Trident/4.0; SLCC2; .NET CLR 2.0.50727; .NET CLR 3.5.30729; .NET CLR 3.0.30729; .NET4.0C; Maxthon 2.0)'),
			array(JApplicationWebClient::WINDOWS, false, JApplicationWebClient::TRIDENT, JApplicationWebClient::IE, '7', 'Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 5.1; Trident/4.0; .NET CLR 2.0.50727; SlimBrowser)'),
			array(JApplicationWebClient::MAC, false, JApplicationWebClient::WEBKIT, JApplicationWebClient::CHROME, '13.0.782.32', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_6_3) AppleWebKit/535.1 (KHTML, like Gecko) Chrome/13.0.782.32 Safari/535.1'),
			array(JApplicationWebClient::WINDOWS, false, JApplicationWebClient::WEBKIT, JApplicationWebClient::CHROME, '12.0.742.113', 'Mozilla/5.0 (Windows NT 6.1) AppleWebKit/534.30 (KHTML, like Gecko) Chrome/12.0.742.113 Safari/534.30'),
			array(JApplicationWebClient::LINUX, false, JApplicationWebClient::WEBKIT, JApplicationWebClient::CHROME, '12.0.742.112', 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/534.30 (KHTML, like Gecko) Ubuntu/10.04 Chromium/12.0.742.112 Chrome/12.0.742.112 Safari/534.30'),
			...
			array(JApplicationWebClient::WINDOWS, false, JApplicationWebClient::GECKO, JApplicationWebClient::FIREFOX, '4.0b8pre', 'Mozilla/5.0 (Windows NT 6.1; Win64; x64; rv:2.0b8pre) Gecko/20101213 Firefox/4.0b8pre'),
			array(JApplicationWebClient::WINDOWS, false, JApplicationWebClient::GECKO, JApplicationWebClient::FIREFOX, '5', 'Mozilla/5.0 (Windows NT 6.1; Win64; x64; rv:5.0) Gecko/20100101 Firefox/5.0'),
			array(JApplicationWebClient::WINDOWS, false, JApplicationWebClient::GECKO, JApplicationWebClient::FIREFOX, '6', 'Mozilla/5.0 (Windows NT 5.0; WOW64; rv:6.0) Gecko/20100101 Firefox/6.0'),
			array(JApplicationWebClient::MAC, false, JApplicationWebClient::GECKO, '', '', 'Mozilla/5.0 (Macintosh; U; Intel Mac OS X 10.6; en; rv:1.9.2.14pre) Gecko/20101212 Camino/2.1a1pre (like Firefox/3.6.14pre)'),
			array(JApplicationWebClient::LINUX, false, JApplicationWebClient::KHTML, '', '', 'Mozilla/5.0 (compatible; Konqueror/4.4; Linux 2.6.32-22-generic; X11; en_US) KHTML/4.4.3 (like Gecko) Kubuntu'),
