...
/**
 * Class to expose protected properties and methods in JDatabaseImporterMysqli for testing purposes.
 *
 * @package     Joomla.UnitTest
 * @subpackage  Database
 * @since       11.1
 */
class JDatabaseImporterMysqliInspector extends JDatabaseImporterMysqli
{
	/**
