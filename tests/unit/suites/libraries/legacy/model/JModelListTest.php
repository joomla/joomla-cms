...
class JModelListTest extends TestCaseDatabase
{
	...
	public function testPopulateStateAppliesFilters()
	{
		...
		// Override a filter after being generated by populateState to test object access
		$this->object->setState('filter.search', 'overridenSearch');
		...
		$this->assertEquals('overridenSearch', $this->object->getState('filter.search'));
	}
