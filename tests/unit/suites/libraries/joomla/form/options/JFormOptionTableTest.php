...
JFormHelper::loadOptionClass('table');

/**
 * Test class for JFormOptionTable.
 *
 * @package     Joomla.UnitTest
 * @subpackage  Form
 * @since       12.3
 */
class JFormOptionTableTest extends TestCaseDatabase
{
	/**
	...
	{
		$element = simplexml_load_string('<option type="table" text_field="title" value_field="id" table="#__categories" />');
