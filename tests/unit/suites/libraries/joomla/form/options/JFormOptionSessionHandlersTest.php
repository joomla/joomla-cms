...
JFormHelper::loadOptionClass('sessionhandlers');

/**
 * Test class for JFormOptionSessionHandlers.
 *
 * @package     Joomla.UnitTest
 * @subpackage  Form
 * @since       12.3
 */
class JFormOptionSessionHandlersTest extends TestCase
{
	/**
	...
	public function testGetOptions()
	{
		...
		foreach ($options as $option)
		{
			...
			$this->assertEquals(
				$option->text,
				JText::_('JLIB_FORM_VALUE_SESSION_' . $option->value),
