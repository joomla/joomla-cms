...
class JFormTest extends TestCaseDatabase
{
	...
	public function testAddFieldOption()
	{
		...
		$this->assertThat(
			$form->addFieldOption('title', '3', 'Certainly', null, null, array('class' => 'disabled', 'selected' => 'selected')),
			$this->isTrue(),
			'Line:' . __LINE__ . ' The method should return true.'
		);
		...
		$form->addFieldOption('title', '4', 'Whatever', 'Group');
		...
		$form->addFieldOption('title', '5', 'Another', 'Group');
		...
		// Test adding an option inside an existing option group
		$form->addFieldOption('title', '6', 'More', 'Group 2');
