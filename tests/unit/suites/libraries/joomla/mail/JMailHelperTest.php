...
class JMailHelperTest extends TestCase
{
	...
	public function dataIsEmailAddress()
	{
		return array(
			...
			array("joe.bob@example.com", true),
			array("joe-bob[at]example.com", false),
			array("joe@his.example.com", true),
			array("joe@his.home.place", true),
			array("joe@example.org", true),
			array("joe@joebob.name", true),
			array("joe.@example.com", false),
			array(".joe@example.com", false),
			array("joe<>bob@example.com", false),
			array("joe&bob@example.com", true),
			...
			array("joe$@example.com", true),
			array("joe+bob@example.com", true),
			array("o'reilly@example.com", true),
			array("o’reilly@example.com", false),
			array("πάνταρει@example.com", false),
			array("joe@πάνταρει.gr", true),
			array("thislocalpartistoolongbyrfcstandardandshouldnotobeacceptedbyourrules@example.com",false),
			array("joe@thisdomainpartistoolongbyrfcstandardandshouldnotobeacceptedbyourrules.example.com",false)
		);
	}
