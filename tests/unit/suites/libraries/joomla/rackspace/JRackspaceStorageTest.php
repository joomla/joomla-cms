 ...
 * @since       ??.?
 */
class JRackspaceStorageTest extends PHPUnit_Framework_TestCase
{
	/**
	...
	{
		$this->assertThat(
			$this->object->storage->account,
			$this->isInstanceOf('JRackspaceStorageAccount')
		);
	}
	...
	{
		$this->assertThat(
			$this->object->storage->container,
			$this->isInstanceOf('JRackspaceStorageContainer')
		);
	}
	...
	public function test__GetObject()
	{
		$this->assertThat(
			...
			$this->isInstanceOf('JRackspaceStorageObject')
		);
	}
}
