 ...
 * @since       12.3
 */
class JOAuth1CredentialsStateTokenTest extends TestCase
{
	/**
	 * The test object.
	 * @var JOAuth1CredentialsStateToken
	 */
	protected $object;
	...
	protected function setUp()
	{
		...
		$this->object = $this->getMockBuilder('JOAuth1CredentialsStateToken')
	...
	public function testRevoke()
	{
		...
		$denied = $this->object->revoke();

		$this->assertInstanceOf('JOAuth1CredentialsStateRevoked', $denied);
	}
}
