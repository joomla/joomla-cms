...
CREATE TABLE [jos_content](
	...
	[featured] [tinyint] NOT NULL,
 	[featured_up] [datetime] NOT NULL,
	[featured_down] [datetime] NOT NULL,
	[language] [nvarchar](7) NOT NULL,
...
/****** Object:  Default [DF__jos_conte__featu__7513AEC3]    Script Date: 07/07/2017 16:19:16 ******/
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[DF__jos_conte__featu__7513AEC3]') AND parent_object_id = OBJECT_ID(N'[jos_content]'))
Begin
IF NOT EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[DF__jos_conte__featu__7513AEC3]') AND type = 'D')
BEGIN
ALTER TABLE [jos_content] ADD  DEFAULT ('1900-01-01 00:00:00') FOR [featured_up]
END


End;

/****** Object:  Default [DF__jos_conte__featu__CAE93F16]    Script Date: 07/07/2017 16:20:45 ******/
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[DF__jos_conte__featu__CAE93F16]') AND parent_object_id = OBJECT_ID(N'[jos_content]'))
Begin
IF NOT EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[DF__jos_conte__featu__CAE93F16]') AND type = 'D')
BEGIN
ALTER TABLE [jos_content] ADD  DEFAULT ('1900-01-01 00:00:00') FOR [featured_down]
END
...
INSERT INTO jos_update_sites (update_site_id,name ,type,location,enabled,last_check_timestamp) VALUES (1, 'Joomla Core', 'collection', 'https://update.joomla.org/core/list.xml', 1, 0);


INSERT INTO jos_update_sites (update_site_id ,name ,type,location,enabled,last_check_timestamp) VALUES (2, 'Joomla Extension Directory', 'collection', 'https://update.joomla.org/jed/list.xml', 1, 0);
