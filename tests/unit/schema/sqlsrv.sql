...
CREATE TABLE [jos_categories](
	...
	[rgt] [int] NOT NULL,
	[level] [bigint] NOT NULL,
	[path_published] [smallint] NOT NULL,
...
/****** Object:  Default [DF__jos_categ__publi__40F848ED]    Script Date: 11/08/2010 18:41:22 ******/
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[DF__jos_categ__publi__40F848ED]') AND parent_object_id = OBJECT_ID(N'[jos_categories]'))
Begin
IF NOT EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[DF__jos_categ__publi__40F848ED]') AND type = 'D')
BEGIN
ALTER TABLE [jos_categories] ADD  DEFAULT ((0)) FOR [path_published]
END
