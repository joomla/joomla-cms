...
define('JPATH_SITE_CONF', dirname(dirname(dirname(__FILE__))).'\configuration.php'); 
...
{   
    ...
    public function __construct()
	{
		...
		parent::__construct();
    $this->out(JPATH_BASE); 
         $this->out('db.'.$this->get('dbtype')); 
         $this->out('ho.'.$this->get('host')); 
         $this->out('us.'.$this->get('user')); 
         $this->out('ps.'.$this->get('password')); 
         $this->out('dn.'.$this->get('db')); 
