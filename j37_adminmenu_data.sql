...
--
-- Host: localhost
-- Generation Time: Nov 09, 2016 at 01:31 PM
...
--
-- Database: `j37_adminmenu`
--

--
-- Truncate table before insert `j37am_assets`
--

TRUNCATE TABLE `j37am_assets`;
--
-- Dumping data for table `j37am_assets`
--

INSERT INTO `j37am_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
(18, 1, 45, 94, 1, 'com_modules', 'com_modules', '{"core.admin":{"7":1},"core.manage":[],"core.create":[],"core.delete":[],"core.edit":[],"core.edit.state":[]}'),
...
(46, 18, 60, 61, 2, 'com_modules.module.12', 'Admin Menu', '{"core.delete":[],"core.edit":[],"core.edit.state":[],"module.edit.frontend":[]}'),
...
(63, 16, 38, 39, 2, 'com_menus.menu.1', 'Main Menu', '{}'),
(64, 16, 40, 41, 2, 'com_menus.menu.3', 'Admin Menu', '{}'),
(65, 18, 90, 91, 2, 'com_modules.module.94', 'Test Module', '{"core.delete":[],"core.edit":[],"core.edit.state":[],"module.edit.frontend":[]}'),
(66, 18, 92, 93, 2, 'com_modules.module.95', 'Admin Menu 2', '{"core.delete":[],"core.edit":[],"core.edit.state":[],"module.edit.frontend":[]}');

--
-- Truncate table before insert `j37am_associations`
--

TRUNCATE TABLE `j37am_associations`;
--
-- Truncate table before insert `j37am_banners`
--

TRUNCATE TABLE `j37am_banners`;
--
-- Truncate table before insert `j37am_banner_clients`
--

TRUNCATE TABLE `j37am_banner_clients`;
--
-- Truncate table before insert `j37am_banner_tracks`
--

TRUNCATE TABLE `j37am_banner_tracks`;
--
-- Truncate table before insert `j37am_categories`
--

TRUNCATE TABLE `j37am_categories`;
--
-- Dumping data for table `j37am_categories`
--

INSERT INTO `j37am_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
(1, 0, 0, 0, 11, 0, '', 'system', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{}', '', '', '{}', 443, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(2, 27, 1, 1, 2, 1, 'uncategorised', 'com_content', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 443, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(3, 28, 1, 3, 4, 1, 'uncategorised', 'com_banners', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 443, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(4, 29, 1, 5, 6, 1, 'uncategorised', 'com_contact', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 443, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(5, 30, 1, 7, 8, 1, 'uncategorised', 'com_newsfeeds', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 443, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(7, 32, 1, 9, 10, 1, 'uncategorised', 'com_users', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 443, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1);

--
-- Truncate table before insert `j37am_contact_details`
--

TRUNCATE TABLE `j37am_contact_details`;
--
-- Truncate table before insert `j37am_content`
--

TRUNCATE TABLE `j37am_content`;
--
-- Dumping data for table `j37am_content`
--

INSERT INTO `j37am_content` (`id`, `asset_id`, `title`, `alias`, `introtext`, `fulltext`, `state`, `catid`, `created`, `created_by`, `created_by_alias`, `modified`, `modified_by`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `images`, `urls`, `attribs`, `version`, `ordering`, `metakey`, `metadesc`, `access`, `hits`, `metadata`, `featured`, `language`, `xreference`) VALUES
(1, 61, 'Getting Started', 'getting-started', '<p>It''s easy to get started creating your website. Knowing some of the basics will help.</p><h3>What is a Content Management System?</h3><p>A content management system is software that allows you to create and manage webpages easily by separating the creation of your content from the mechanics required to present it on the web.</p><p>In this site, the content is stored in a <em>database</em>. The look and feel are created by a <em>template</em>. Joomla! brings together the template and your content to create web pages.</p><h3>Logging in</h3><p>To login to your site use the user name and password that were created as part of the installation process. Once logged-in you will be able to create and edit articles and modify some settings.</p><h3>Creating an article</h3><p>Once you are logged-in, a new menu will be visible. To create a new article, click on the "Submit Article" link on that menu.</p><p>The new article interface gives you a lot of options, but all you need to do is add a title and put something in the content area. To make it easy to find, set the state to published.</p><div>You can edit an existing article by clicking on the edit icon (this only displays to users who have the right to edit).</div><h3>Template, site settings, and modules</h3><p>The look and feel of your site is controlled by a template. You can change the site name, background colour, highlights colour and more by editing the template settings. Click the "Template Settings" in the user menu.</p><p>The boxes around the main content of the site are called modules. You can modify modules on the current page by moving your cursor to the module and clicking the edit link. Always be sure to save and close any module you edit.</p><p>You can change some site settings such as the site name and description by clicking on the "Site Settings" link.</p><p>More advanced options for templates, site settings, modules, and more are available in the site administrator.</p><h3>Site and Administrator</h3><p>Your site actually has two separate sites. The site (also called the front end) is what visitors to your site will see. The administrator (also called the back end) is only used by people managing your site. You can access the administrator by clicking the "Site Administrator" link on the "User Menu" menu (visible once you login) or by adding /administrator to the end of your domain name. The same user name and password are used for both sites.</p><h3>Learn more</h3><p>There is much more to learn about how to use Joomla! to create the website you envision. You can learn much more at the <a href="https://docs.joomla.org" target="_blank">Joomla! documentation site</a> and on the<a href="http://forum.joomla.org" target="_blank"> Joomla! forums</a>.</p>', '', 1, 2, '2013-11-16 00:00:00', 443, '', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', '2013-11-16 00:00:00', '0000-00-00 00:00:00', '{"image_intro":"","float_intro":"","image_intro_alt":"","image_intro_caption":"","image_fulltext":"","float_fulltext":"","image_fulltext_alt":"","image_fulltext_caption":""}', '{"urla":false,"urlatext":"","targeta":"","urlb":false,"urlbtext":"","targetb":"","urlc":false,"urlctext":"","targetc":""}', '{"show_title":"","link_titles":"","show_tags":"","show_intro":"","info_block_position":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_vote":"","show_hits":"","show_noauth":"","urls_position":"","alternative_readmore":"","article_layout":"","show_publishing_options":"","show_article_options":"","show_urls_images_backend":"","show_urls_images_frontend":""}', 1, 0, '', '', 1, 6, '{"robots":"","author":"","rights":"","xreference":""}', 0, '*', '');

--
-- Truncate table before insert `j37am_contentitem_tag_map`
--

TRUNCATE TABLE `j37am_contentitem_tag_map`;
--
-- Dumping data for table `j37am_contentitem_tag_map`
--

INSERT INTO `j37am_contentitem_tag_map` (`type_alias`, `core_content_id`, `content_item_id`, `tag_id`, `tag_date`, `type_id`) VALUES
('com_content.article', 1, 1, 2, '2013-11-16 06:00:00', 1);

--
-- Truncate table before insert `j37am_content_frontpage`
--

TRUNCATE TABLE `j37am_content_frontpage`;
--
-- Truncate table before insert `j37am_content_rating`
--

TRUNCATE TABLE `j37am_content_rating`;
--
-- Truncate table before insert `j37am_content_types`
--

TRUNCATE TABLE `j37am_content_types`;
--
-- Dumping data for table `j37am_content_types`
--

INSERT INTO `j37am_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
--
-- Truncate table before insert `j37am_core_log_searches`
--

TRUNCATE TABLE `j37am_core_log_searches`;
--
-- Truncate table before insert `j37am_extensions`
--

TRUNCATE TABLE `j37am_extensions`;
--
-- Dumping data for table `j37am_extensions`
--

INSERT INTO `j37am_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(20, 'com_templates', 'component', 'com_templates', '', 1, 1, 1, 1, '{"name":"com_templates","type":"component","creationDate":"April 2006","author":"Joomla! Project","copyright":"(C) 2005 - 2016 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"3.0.0","description":"COM_TEMPLATES_XML_DESCRIPTION","group":""}', '{"template_positions_display":"0","upload_limit":"15.59","image_formats":"gif,bmp,jpg,jpeg,png","source_formats":"txt,less,ini,xml,js,php,css","font_formats":"woff,ttf,otf","compressed_formats":"zip"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(103, 'LIB_JOOMLA', 'library', 'joomla', '', 0, 1, 1, 1, '{"name":"LIB_JOOMLA","type":"library","creationDate":"2008","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2016 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"https:\\/\\/www.joomla.org","version":"13.1","description":"LIB_JOOMLA_XML_DESCRIPTION","group":"","filename":"joomla"}', '{"mediaversion":"e8d10ac8095b3a4c87cc67bb336a4cdc"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(452, 'plg_system_updatenotification', 'plugin', 'updatenotification', 'system', 0, 1, 1, 0, '{"name":"plg_system_updatenotification","type":"plugin","creationDate":"May 2015","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2016 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"3.5.0","description":"PLG_SYSTEM_UPDATENOTIFICATION_XML_DESCRIPTION","group":"","filename":"updatenotification"}', '{"lastrun":1478691403}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(454, 'plg_system_stats', 'plugin', 'stats', 'system', 0, 1, 1, 0, '{"name":"plg_system_stats","type":"plugin","creationDate":"November 2013","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2016 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"3.5.0","description":"PLG_SYSTEM_STATS_XML_DESCRIPTION","group":"","filename":"stats"}', '{"mode":3,"lastrun":1476154611,"unique_id":"527f7981a50b5c587815b2bd2f8aeefef2e6bf95","interval":12}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(458, 'plg_quickicon_phpversioncheck', 'plugin', 'phpversioncheck', 'quickicon', 0, 1, 1, 1, '{"name":"plg_quickicon_phpversioncheck","type":"plugin","creationDate":"August 2016","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2016 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"3.7.0","description":"PLG_QUICKICON_PHPVERSIONCHECK_XML_DESCRIPTION","group":"","filename":"phpversioncheck"}', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(459, 'plg_editors-xtd_menu', 'plugin', 'menu', 'editors-xtd', 0, 1, 1, 0, '{"name":"plg_editors-xtd_menu","type":"plugin","creationDate":"August 2016","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2016 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"__DEPLOY_VERSION__","description":"PLG_EDITORS-XTD_MENU_XML_DESCRIPTION","group":"","filename":"menu"}', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(460, 'plg_editors-xtd_contact', 'plugin', 'contact', 'editors-xtd', 0, 1, 1, 0, '{"name":"plg_editors-xtd_contact","type":"plugin","creationDate":"October 2016","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2016 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"__DEPLOY_VERSION__","description":"PLG_EDITORS-XTD_CONTACT_XML_DESCRIPTION","group":"","filename":"contact"}', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(600, 'English (en-GB)', 'language', 'en-GB', '', 0, 1, 1, 1, '{"name":"English (en-GB)","type":"language","creationDate":"October 2016","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2016 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"3.6.3","description":"en-GB site language","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(601, 'English (en-GB)', 'language', 'en-GB', '', 1, 1, 1, 1, '{"name":"English (en-GB)","type":"language","creationDate":"October 2016","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2016 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"3.6.3","description":"en-GB administrator language","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(700, 'files_joomla', 'file', 'joomla', '', 0, 1, 1, 1, '{"name":"files_joomla","type":"file","creationDate":"June 2016","author":"Joomla! Project","copyright":"(C) 2005 - 2016 Open Source Matters. All rights reserved","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"3.7.0-dev","description":"FILES_JOOMLA_XML_DESCRIPTION","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(802, 'English (en-GB) Language Pack', 'package', 'pkg_en-GB', '', 0, 1, 1, 1, '{"name":"English (en-GB) Language Pack","type":"package","creationDate":"October 2016","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2016 Open Source Matters, Inc. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"3.6.3.1","description":"en-GB language pack","group":"","filename":"pkg_en-GB"}', '', '', '', 0, '0000-00-00 00:00:00', 0, 0);

--
-- Truncate table before insert `j37am_finder_filters`
--

TRUNCATE TABLE `j37am_finder_filters`;
--
-- Truncate table before insert `j37am_finder_links`
--

TRUNCATE TABLE `j37am_finder_links`;
--
-- Truncate table before insert `j37am_finder_links_terms0`
--

TRUNCATE TABLE `j37am_finder_links_terms0`;
--
-- Truncate table before insert `j37am_finder_links_terms1`
--

TRUNCATE TABLE `j37am_finder_links_terms1`;
--
-- Truncate table before insert `j37am_finder_links_terms2`
--

TRUNCATE TABLE `j37am_finder_links_terms2`;
--
-- Truncate table before insert `j37am_finder_links_terms3`
--

TRUNCATE TABLE `j37am_finder_links_terms3`;
--
-- Truncate table before insert `j37am_finder_links_terms4`
--

TRUNCATE TABLE `j37am_finder_links_terms4`;
--
-- Truncate table before insert `j37am_finder_links_terms5`
--

TRUNCATE TABLE `j37am_finder_links_terms5`;
--
-- Truncate table before insert `j37am_finder_links_terms6`
--

TRUNCATE TABLE `j37am_finder_links_terms6`;
--
-- Truncate table before insert `j37am_finder_links_terms7`
--

TRUNCATE TABLE `j37am_finder_links_terms7`;
--
-- Truncate table before insert `j37am_finder_links_terms8`
--

TRUNCATE TABLE `j37am_finder_links_terms8`;
--
-- Truncate table before insert `j37am_finder_links_terms9`
--

TRUNCATE TABLE `j37am_finder_links_terms9`;
--
-- Truncate table before insert `j37am_finder_links_termsa`
--

TRUNCATE TABLE `j37am_finder_links_termsa`;
--
-- Truncate table before insert `j37am_finder_links_termsb`
--

TRUNCATE TABLE `j37am_finder_links_termsb`;
--
-- Truncate table before insert `j37am_finder_links_termsc`
--

TRUNCATE TABLE `j37am_finder_links_termsc`;
--
-- Truncate table before insert `j37am_finder_links_termsd`
--

TRUNCATE TABLE `j37am_finder_links_termsd`;
--
-- Truncate table before insert `j37am_finder_links_termse`
--

TRUNCATE TABLE `j37am_finder_links_termse`;
--
-- Truncate table before insert `j37am_finder_links_termsf`
--

TRUNCATE TABLE `j37am_finder_links_termsf`;
--
-- Truncate table before insert `j37am_finder_taxonomy`
--

TRUNCATE TABLE `j37am_finder_taxonomy`;
--
-- Dumping data for table `j37am_finder_taxonomy`
--

INSERT INTO `j37am_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

--
-- Truncate table before insert `j37am_finder_taxonomy_map`
--

TRUNCATE TABLE `j37am_finder_taxonomy_map`;
--
-- Truncate table before insert `j37am_finder_terms`
--

TRUNCATE TABLE `j37am_finder_terms`;
--
-- Truncate table before insert `j37am_finder_terms_common`
--

TRUNCATE TABLE `j37am_finder_terms_common`;
--
-- Dumping data for table `j37am_finder_terms_common`
--

INSERT INTO `j37am_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Truncate table before insert `j37am_finder_tokens`
--

TRUNCATE TABLE `j37am_finder_tokens`;
--
-- Truncate table before insert `j37am_finder_tokens_aggregate`
--

TRUNCATE TABLE `j37am_finder_tokens_aggregate`;
--
-- Truncate table before insert `j37am_finder_types`
--

TRUNCATE TABLE `j37am_finder_types`;
--
-- Truncate table before insert `j37am_languages`
--

TRUNCATE TABLE `j37am_languages`;
--
-- Dumping data for table `j37am_languages`
--

INSERT INTO `j37am_languages` (`lang_id`, `asset_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 0, 'en-GB', 'English (UK)', 'English (UK)', 'en', 'en_gb', '', '', '', '', 1, 1, 1);

--
-- Truncate table before insert `j37am_menu`
--

TRUNCATE TABLE `j37am_menu`;
--
-- Dumping data for table `j37am_menu`
--

INSERT INTO `j37am_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
(7, 'menu', 'com_contact', 'Contacts', '', 'Contacts', 'index.php?option=com_contact', 'component', 1, 1, 1, 8, 0, '0000-00-00 00:00:00', 0, 0, 'class:contact', 0, '', 75, 80, 0, '*', 1),
(8, 'menu', 'com_contact', 'Contacts', '', 'Contacts/Contacts', 'index.php?option=com_contact', 'component', 1, 7, 2, 8, 0, '0000-00-00 00:00:00', 0, 0, 'class:contact', 0, '', 76, 77, 0, '*', 1),
(9, 'menu', 'com_contact_categories', 'Categories', '', 'Contacts/Categories', 'index.php?option=com_categories&extension=com_contact', 'component', 1, 7, 2, 6, 0, '0000-00-00 00:00:00', 0, 0, 'class:contact-cat', 0, '', 78, 79, 0, '*', 1),
(10, 'menu', 'com_messages', 'Messaging', '', 'Messaging', 'index.php?option=com_messages', 'component', 1, 1, 1, 15, 0, '0000-00-00 00:00:00', 0, 0, 'class:messages', 0, '', 81, 84, 0, '*', 1),
(11, 'menu', 'com_messages_add', 'New Private Message', '', 'Messaging/New Private Message', 'index.php?option=com_messages&task=message.add', 'component', 1, 10, 2, 15, 0, '0000-00-00 00:00:00', 0, 0, 'class:messages-add', 0, '', 82, 83, 0, '*', 1),
(13, 'menu', 'com_newsfeeds', 'News Feeds', '', 'News Feeds', 'index.php?option=com_newsfeeds', 'component', 1, 1, 1, 17, 0, '0000-00-00 00:00:00', 0, 0, 'class:newsfeeds', 0, '', 85, 90, 0, '*', 1),
(14, 'menu', 'com_newsfeeds_feeds', 'Feeds', '', 'News Feeds/Feeds', 'index.php?option=com_newsfeeds', 'component', 1, 13, 2, 17, 0, '0000-00-00 00:00:00', 0, 0, 'class:newsfeeds', 0, '', 86, 87, 0, '*', 1),
(15, 'menu', 'com_newsfeeds_categories', 'Categories', '', 'News Feeds/Categories', 'index.php?option=com_categories&extension=com_newsfeeds', 'component', 1, 13, 2, 6, 0, '0000-00-00 00:00:00', 0, 0, 'class:newsfeeds-cat', 0, '', 88, 89, 0, '*', 1),
(16, 'menu', 'com_redirect', 'Redirect', '', 'Redirect', 'index.php?option=com_redirect', 'component', 1, 1, 1, 24, 0, '0000-00-00 00:00:00', 0, 0, 'class:redirect', 0, '', 91, 92, 0, '*', 1),
(17, 'menu', 'com_search', 'Basic Search', '', 'Basic Search', 'index.php?option=com_search', 'component', 1, 1, 1, 19, 0, '0000-00-00 00:00:00', 0, 0, 'class:search', 0, '', 93, 94, 0, '*', 1),
(18, 'menu', 'com_finder', 'Smart Search', '', 'Smart Search', 'index.php?option=com_finder', 'component', 1, 1, 1, 27, 0, '0000-00-00 00:00:00', 0, 0, 'class:finder', 0, '', 95, 96, 0, '*', 1),
(19, 'menu', 'com_joomlaupdate', 'Joomla! Update', '', 'Joomla! Update', 'index.php?option=com_joomlaupdate', 'component', 0, 1, 1, 28, 0, '0000-00-00 00:00:00', 0, 0, 'class:joomlaupdate', 0, '', 97, 98, 0, '*', 1),
(20, 'main', 'com_tags', 'Tags', '', 'Tags', 'index.php?option=com_tags', 'component', 1, 1, 1, 29, 0, '0000-00-00 00:00:00', 0, 1, 'class:tags', 0, '', 99, 100, 0, '', 1),
...
(103, 'usermenu', 'Site Administrator', '2013-11-16-23-26-41', '', '2013-11-16-23-26-41', 'administrator', 'url', 1, 1, 1, 0, 0, '0000-00-00 00:00:00', 0, 6, '', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1}', 69, 70, 0, '*', 0),
...
(109, 'mainmenu', 'Test Search', 'test-search', '', 'test-search', 'index.php?option=com_finder&view=search', 'component', 1, 1, 1, 27, 0, '0000-00-00 00:00:00', 0, 1, ' ', 0, '{"show_date_filters":"","show_advanced":"","expand_advanced":"","show_description":"","description_length":255,"show_url":"","show_pagination_limit":"","show_pagination":"","show_pagination_results":"","allow_empty_query":"0","show_suggested_query":"1","show_explained_query":"1","sort_order":"","sort_direction":"","show_feed":"0","show_feed_text":"0","show_feed_link":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1,"page_title":"","show_page_heading":"","page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 105, 106, 0, '*', 0),
(111, 'adminmenu', 'System', 'system', '', 'system', '', 'heading', 1, 1, 1, 0, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1}', 11, 30, 0, '*', 1),
(112, 'adminmenu', 'Control Panel', 'control-panel', '', 'system/control-panel', 'index.php?option=com_cpanel&view=cpanel', 'component', 1, 111, 2, 9, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"images\\/joomla_black.png","menu_text":1,"menu_show":1}', 12, 13, 1, '*', 1),
(113, 'adminmenu', '-', '2016-10-22-09-52-24', '', 'system/2016-10-22-09-52-24', '', 'separator', 1, 111, 2, 0, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1}', 14, 15, 0, '*', 1),
(114, 'adminmenu', 'Global Configuration', 'global-configuration', '', 'system/global-configuration', 'index.php?option=com_config&view=application', 'component', 1, 111, 2, 23, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1}', 16, 17, 0, '*', 1),
(115, 'adminmenu', '-', '2016-10-22-10-51-28', '', 'system/2016-10-22-10-51-28', '', 'separator', 1, 111, 2, 0, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1}', 18, 19, 0, '*', 1),
(116, 'adminmenu', 'Global Check-in', 'global-check-in', '', 'system/global-check-in', 'index.php?option=com_checkin&view=checkin', 'component', 1, 111, 2, 7, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1}', 20, 21, 0, '*', 1),
(117, 'adminmenu', 'Clear Cache', 'clear-cache', '', 'system/clear-cache', 'index.php?option=com_cache&view=cache', 'component', 1, 111, 2, 5, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1}', 22, 23, 0, '*', 1),
(118, 'adminmenu', 'Clear Expired Cache', 'clear-cache-2', '', 'system/clear-cache-2', 'index.php?option=com_cache&view=purge', 'component', 1, 111, 2, 5, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1}', 24, 25, 0, '*', 1),
(119, 'adminmenu', '-', '2016-10-22-10-56-22', '', 'system/2016-10-22-10-56-22', '', 'separator', 1, 111, 2, 0, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1}', 26, 27, 0, '*', 1),
(120, 'adminmenu', 'System Information', 'system-information', '', 'system/system-information', 'index.php?option=com_admin&view=sysinfo', 'component', 1, 111, 2, 3, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1}', 28, 29, 0, '*', 1),
(121, 'adminmenu', 'Users', 'users', '', 'users', '', 'heading', 1, 1, 1, 0, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1}', 31, 64, 0, '*', 1),
(122, 'adminmenu', 'Manage', 'manage', '', 'users/manage', 'index.php?option=com_users&view=users', 'component', 1, 121, 2, 25, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1}', 34, 37, 0, '*', 1),
(123, 'adminmenu', 'Add New User', 'add-new-user', '', 'users/manage/add-new-user', 'index.php?option=com_users&view=user&layout=edit', 'component', 1, 122, 3, 25, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1}', 35, 36, 0, '*', 1),
(124, 'adminmenu', 'Groups', 'groups', '', 'users/groups', 'index.php?option=com_users&view=groups', 'component', 1, 121, 2, 25, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1}', 38, 41, 0, '*', 1),
(125, 'adminmenu', 'Add New Group', 'add-new-group', '', 'users/groups/add-new-group', 'index.php?option=com_users&view=group&layout=edit', 'component', 1, 124, 3, 25, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1}', 39, 40, 0, '*', 1),
(126, 'adminmenu', 'Access Levels', 'access-levels', '', 'users/access-levels', 'index.php?option=com_users&view=levels', 'component', 1, 121, 2, 25, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1}', 42, 45, 0, '*', 1),
(127, 'adminmenu', 'Add New Access Level', 'add-new-access-level', '', 'users/access-levels/add-new-access-level', 'index.php?option=com_users&view=level&layout=edit', 'component', 1, 126, 3, 25, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1}', 43, 44, 0, '*', 1),
(128, 'adminmenu', 'User Notes', 'user-notes', '', 'users/user-notes', 'index.php?option=com_users&view=notes', 'component', 1, 121, 2, 25, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1}', 50, 53, 0, '*', 1),
(129, 'adminmenu', 'Add User Note', 'add-user-note', '', 'users/user-notes/add-user-note', 'index.php?option=com_users&view=note&layout=edit', 'component', 1, 128, 3, 25, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1}', 51, 52, 0, '*', 1),
(130, 'adminmenu', '-', '2016-10-22-11-10-38', '', 'users/2016-10-22-11-10-38', '', 'separator', 1, 121, 2, 0, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1}', 46, 47, 0, '*', 1),
(131, 'adminmenu', 'User Note Categories', 'user-note-categories', '', 'users/user-note-categories', 'index.php?option=com_categories&view=categories&extension=com_users', 'component', 1, 121, 2, 6, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1}', 54, 57, 0, '*', 1),
(132, 'adminmenu', 'Add New Category', 'add-new-category', '', 'users/user-note-categories/add-new-category', 'index.php?option=com_categories&view=category&layout=edit&extension=com_users', 'component', 1, 131, 3, 6, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1}', 55, 56, 0, '*', 1),
(133, 'adminmenu', '-', '2016-10-22-11-34-43', '', 'users/2016-10-22-11-34-43', 'index.php?option=com_users&view=mail', 'separator', 1, 121, 2, 0, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1}', 58, 59, 0, '*', 1),
(134, 'adminmenu', 'Mass Mail Users', 'mass-mail-users', '', 'users/mass-mail-users', 'index.php?option=com_users&view=mail', 'component', 1, 121, 2, 25, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1}', 60, 61, 0, '*', 1),
(135, 'adminmenu', 'Menus', 'menus', '', 'menus', '', 'heading', 1, 1, 1, 0, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1}', 107, 130, 0, '*', 1),
(136, 'adminmenu', 'Manage', 'manage', '', 'menus/manage', 'index.php?option=com_menus&view=menus', 'component', 1, 135, 2, 14, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1}', 108, 111, 0, '*', 1),
(137, 'adminmenu', 'Add New Menu', 'add-new-menu', '', 'menus/manage/add-new-menu', 'index.php?option=com_menus&view=menu&layout=edit', 'component', 1, 136, 3, 14, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1}', 109, 110, 0, '*', 1),
(138, 'adminmenu', '-', '2016-10-22-11-45-36', '', 'menus/2016-10-22-11-45-36', '', 'separator', 1, 135, 2, 0, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1}', 112, 113, 0, '*', 1),
(139, 'adminmenu', 'All Menu Items', 'all-menu-items', '', 'menus/all-menu-items', 'index.php?option=com_menus&view=items', 'component', 1, 135, 2, 14, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1}', 114, 115, 0, '*', 1),
(140, 'adminmenu', '-', '2016-10-22-11-51-29', '', 'menus/2016-10-22-11-51-29', '', 'separator', 1, 135, 2, 0, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1}', 116, 117, 0, '*', 1),
(141, 'adminmenu', 'Admin Menu', 'admin-menu', '', 'menus/admin-menu', 'index.php?option=com_menus&view=items&menutype=adminmenu', 'component', 1, 135, 2, 14, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1}', 118, 121, 0, '*', 1),
(142, 'adminmenu', 'Main Menu', 'main-menu', '', 'menus/main-menu', 'index.php?option=com_menus&view=items&menutype=mainmenu', 'component', 1, 135, 2, 14, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1}', 122, 125, 0, '*', 1),
(143, 'adminmenu', 'User Menu', 'user-menu', '', 'menus/user-menu', 'index.php?option=com_menus&view=items&menutype=usermenu', 'component', 1, 135, 2, 14, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1}', 126, 129, 0, '*', 1),
(144, 'adminmenu', 'Add New Menu Item', 'add-new-menu-item', '', 'menus/admin-menu/add-new-menu-item', 'index.php?option=com_menus&view=item&layout=edit&menutype=adminmenu', 'component', 1, 141, 3, 14, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1}', 119, 120, 0, '*', 1),
(145, 'adminmenu', 'Add New Menu Item', 'add-new-menu-item', '', 'menus/main-menu/add-new-menu-item', 'index.php?option=com_menus&view=item&layout=edit&menutype=mainmenu', 'component', 1, 142, 3, 14, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1}', 123, 124, 0, '*', 1),
(146, 'adminmenu', 'Add New Menu Item', 'add-new-menu-item', '', 'menus/user-menu/add-new-menu-item', 'index.php?option=com_menus&view=item&layout=edit&menutype=usermenu', 'component', 1, 143, 3, 14, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1}', 127, 128, 0, '*', 1),
(147, 'adminmenu', 'Content', 'content', '', 'content', '', 'heading', 1, 1, 1, 0, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1}', 131, 146, 0, '*', 1),
(148, 'adminmenu', 'Articles', 'articles', '', 'content/articles', 'index.php?option=com_content&view=articles', 'component', 1, 147, 2, 22, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1}', 132, 135, 0, '*', 1),
(149, 'adminmenu', 'Add New Article', 'add-new-article', '', 'content/articles/add-new-article', 'index.php?option=com_content&view=article&layout=edit', 'component', 1, 148, 3, 22, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1}', 133, 134, 0, '*', 1),
(150, 'adminmenu', 'Categories', 'categories', '', 'content/categories', 'index.php?option=com_categories&view=categories&extension=com_content', 'component', 1, 147, 2, 6, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1}', 136, 139, 0, '*', 1),
(151, 'adminmenu', 'Add New Category', 'add-new-category', '', 'content/categories/add-new-category', 'index.php?option=com_categories&view=category&layout=edit&extension=com_content', 'component', 1, 150, 3, 6, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1}', 137, 138, 0, '*', 1),
(152, 'adminmenu', 'Featured Articles', 'featured-articles', '', 'content/featured-articles', 'index.php?option=com_content&view=featured', 'component', 1, 147, 2, 22, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1}', 140, 141, 0, '*', 1),
(153, 'adminmenu', '-', '2016-10-22-13-46-55', '', 'content/2016-10-22-13-46-55', '', 'separator', 1, 147, 2, 0, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1}', 142, 143, 0, '*', 1),
(154, 'adminmenu', 'Media', 'media', '', 'content/media', 'index.php?option=com_media&view=media', 'component', 1, 147, 2, 13, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1}', 144, 145, 0, '*', 1),
(155, 'adminmenu', 'Components', 'components-container', '', 'components-container', '', 'heading', 1, 1, 1, 0, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"components_container":1,"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1}', 147, 148, 0, '*', 1),
(156, 'adminmenu', 'Manage', 'manage', '', 'manage', '', 'heading', 1, 1, 1, 0, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"components_container":0,"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1}', 149, 196, 0, '*', 1),
(157, 'adminmenu', 'Joomla! Update', 'joomla-update', '', 'manage/joomla-update', 'index.php?option=com_joomlaupdate&view=default', 'component', 1, 156, 2, 28, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1}', 150, 151, 0, '*', 1),
(158, 'adminmenu', 'Post-installation Messages', 'post-installation-messages', '', 'manage/post-installation-messages', 'index.php?option=com_postinstall&view=messages', 'component', 1, 156, 2, 32, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1}', 152, 153, 0, '*', 1),
(159, 'adminmenu', 'System', 'system', '', 'manage/system', 'index.php?option=com_installer&view=database', 'component', 1, 156, 2, 10, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1}', 154, 161, 0, '*', 1),
(160, 'adminmenu', 'Database', 'database', '', 'manage/system/database', 'index.php?option=com_installer&view=database', 'component', 1, 159, 3, 10, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1}', 155, 156, 0, '*', 1),
(161, 'adminmenu', 'Warnings', 'warnings', '', 'manage/system/warnings', 'index.php?option=com_installer&view=warnings', 'component', 1, 159, 3, 10, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1}', 157, 158, 0, '*', 1),
(162, 'adminmenu', 'Update Sites', 'update-sites', '', 'manage/system/update-sites', 'index.php?option=com_installer&view=updatesites', 'component', 1, 159, 3, 10, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1}', 159, 160, 0, '*', 1),
(163, 'adminmenu', 'Extensions', 'extensions', '', 'manage/extensions', 'index.php?option=com_installer&view=install', 'component', 1, 156, 2, 10, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1}', 162, 175, 0, '*', 1),
(164, 'adminmenu', 'Install', 'install', '', 'manage/extensions/install', 'index.php?option=com_installer&view=install', 'component', 1, 163, 3, 10, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1}', 163, 164, 0, '*', 1),
(165, 'adminmenu', 'Update', 'update', '', 'manage/extensions/update', 'index.php?option=com_installer&view=update', 'component', 1, 163, 3, 10, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1}', 165, 166, 0, '*', 1),
(166, 'adminmenu', 'Manage', 'manage', '', 'manage/extensions/manage', 'index.php?option=com_installer&view=manage', 'component', 1, 163, 3, 10, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1}', 167, 168, 0, '*', 1),
(167, 'adminmenu', 'Discover', 'discover', '', 'manage/extensions/discover', 'index.php?option=com_installer&view=discover', 'component', 1, 163, 3, 10, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1}', 169, 170, 0, '*', 1),
(168, 'adminmenu', '-', '2016-10-22-14-17-30', '', 'manage/extensions/2016-10-22-14-17-30', '', 'separator', 1, 163, 3, 0, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{}', 171, 172, 0, '*', 1),
(169, 'adminmenu', 'Install Languages', 'install-languages', '', 'manage/extensions/install-languages', 'index.php?option=com_installer&view=languages', 'component', 1, 163, 3, 10, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1}', 173, 174, 0, '*', 1),
(170, 'adminmenu', 'Modules', 'modules', '', 'manage/modules', 'index.php?option=com_modules&view=modules', 'component', 1, 156, 2, 16, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1}', 178, 179, 0, '*', 1),
(171, 'adminmenu', 'Plugins', 'plugins', '', 'manage/plugins', 'index.php?option=com_plugins&view=plugins', 'component', 1, 156, 2, 18, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1}', 180, 181, 0, '*', 1),
(172, 'adminmenu', '-', '2016-10-22-14-21-31', '', 'manage/2016-10-22-14-21-31', '', 'separator', 1, 156, 2, 0, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{}', 176, 177, 0, '*', 1),
(173, 'adminmenu', 'Templates', 'templates', '', 'manage/templates', 'index.php?option=com_templates&view=styles', 'component', 1, 156, 2, 20, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1}', 182, 187, 0, '*', 1),
(174, 'adminmenu', 'Styles', 'styles', '', 'manage/templates/styles', 'index.php?option=com_templates&view=styles', 'component', 1, 173, 3, 20, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1}', 183, 184, 0, '*', 1),
(175, 'adminmenu', 'Templates', 'templates', '', 'manage/templates/templates', 'index.php?option=com_templates&view=templates', 'component', 1, 173, 3, 20, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1}', 185, 186, 0, '*', 1),
(176, 'adminmenu', 'Language(s)', 'language-s', '', 'manage/language-s', 'index.php?option=com_languages&view=languages', 'component', 1, 156, 2, 11, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1}', 188, 195, 0, '*', 1),
(177, 'adminmenu', 'Installed', 'installed', '', 'manage/language-s/installed', 'index.php?option=com_languages&view=installed', 'component', 1, 176, 3, 11, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1}', 189, 190, 0, '*', 1),
(178, 'adminmenu', 'Content Languages', 'content-languages', '', 'manage/language-s/content-languages', 'index.php?option=com_languages&view=languages', 'component', 1, 176, 3, 11, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1}', 191, 192, 0, '*', 1),
(179, 'adminmenu', 'Overrides', 'overrides', '', 'manage/language-s/overrides', 'index.php?option=com_languages&view=overrides', 'component', 1, 176, 3, 11, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1}', 193, 194, 0, '*', 1),
(180, 'adminmenu', 'Help', 'help', '', 'help', '', 'heading', 1, 1, 1, 0, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"components_container":0,"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1}', 197, 226, 0, '*', 1),
(181, 'adminmenu', 'Joomla! Help', 'joomla-help', '', 'help/joomla-help', 'index.php?option=com_admin&view=help', 'component', 1, 180, 2, 3, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1}', 198, 199, 0, '*', 1),
(182, 'adminmenu', '-', '2016-10-22-14-35-08', '', 'help/2016-10-22-14-35-08', '', 'separator', 1, 180, 2, 0, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{}', 200, 201, 0, '*', 1),
(183, 'adminmenu', 'Official Support Forum', 'official-support-forum', '', 'help/official-support-forum', 'http://forum.joomla.org', 'url', 1, 180, 2, 0, 0, '0000-00-00 00:00:00', 1, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu-anchor_rel":"","menu_image":"","menu_text":1,"menu_show":1}', 202, 203, 0, '*', 1),
(184, 'adminmenu', 'Official Language Forums', 'official-language-forums', '', 'help/official-language-forums', 'http://forum.joomla.org/viewforum.php?f=511', 'url', 1, 180, 2, 0, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu-anchor_rel":"","menu_image":"","menu_text":1,"menu_show":1}', 204, 205, 0, '*', 1),
(185, 'adminmenu', 'Documentation Wiki', 'documentation-wiki', '', 'help/documentation-wiki', 'https://docs.joomla.org', 'url', 1, 180, 2, 0, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu-anchor_rel":"","menu_image":"","menu_text":1,"menu_show":1}', 206, 207, 0, '*', 1),
(186, 'adminmenu', 'Joomla! Extensions', 'joomla-extensions', '', 'help/joomla-extensions', 'https://extensions.joomla.org/', 'url', 1, 180, 2, 0, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu-anchor_rel":"","menu_image":"","menu_text":1,"menu_show":1}', 210, 211, 0, '*', 1),
(187, 'adminmenu', 'Joomla! Translations', 'joomla-translations', '', 'help/joomla-translations', 'https://community.joomla.org/translations.html', 'url', 1, 180, 2, 0, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu-anchor_rel":"","menu_image":"","menu_text":1,"menu_show":1}', 212, 213, 0, '*', 1),
(188, 'adminmenu', 'Joomla! Resources', 'joomla-resources', '', 'help/joomla-resources', 'http://resources.joomla.org', 'url', 1, 180, 2, 0, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu-anchor_rel":"","menu_image":"","menu_text":1,"menu_show":1}', 214, 215, 0, '*', 1),
(189, 'adminmenu', 'Community Portal', 'community-portal', '', 'help/community-portal', 'https://community.joomla.org', 'url', 1, 180, 2, 0, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu-anchor_rel":"","menu_image":"","menu_text":1,"menu_show":1}', 216, 217, 0, '*', 1),
(190, 'adminmenu', 'Security Centre', 'security-centre', '', 'help/security-centre', 'https://developer.joomla.org/security-centre.html', 'url', 1, 180, 2, 0, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu-anchor_rel":"","menu_image":"","menu_text":1,"menu_show":1}', 218, 219, 0, '*', 1),
(191, 'adminmenu', 'Developer Resources', 'developer-resources', '', 'help/developer-resources', 'https://developer.joomla.org', 'url', 1, 180, 2, 0, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu-anchor_rel":"","menu_image":"","menu_text":1,"menu_show":1}', 220, 221, 0, '*', 1),
(192, 'adminmenu', 'Stack Exchange', 'stack-exchange', '', 'help/stack-exchange', 'https://joomla.stackexchange.com', 'url', 1, 180, 2, 0, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu-anchor_rel":"","menu_image":"","menu_text":1,"menu_show":1}', 222, 223, 0, '*', 1),
(193, 'adminmenu', 'Joomla! Shop', 'joomla-shop', '', 'help/joomla-shop', 'https://community.joomla.org/the-joomla-shop.html', 'url', 1, 180, 2, 0, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu-anchor_rel":"","menu_image":"","menu_text":1,"menu_show":1}', 224, 225, 0, '*', 1),
(194, 'adminmenu', '-', '2016-10-22-14-44-48', '', 'help/2016-10-22-14-44-48', '', 'separator', 1, 180, 2, 0, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{}', 208, 209, 0, '*', 1),
(195, 'adminmenu', 'T', 't', '', 'users/t', '', 'separator', 1, 121, 2, 0, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{}', 32, 33, 0, '*', 1),
(196, 'adminmenu', 'T 2', 't-2', '', 'users/t-2', '', 'separator', 1, 121, 2, 0, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{}', 62, 63, 0, '*', 1),
(197, 'adminmenu', 'T 3', 't-3', '', 'users/t-3', '', 'separator', 1, 121, 2, 0, 0, '0000-00-00 00:00:00', 0, 0, ' ', 0, '{}', 48, 49, 0, '*', 1);

--
-- Truncate table before insert `j37am_menu_types`
--

TRUNCATE TABLE `j37am_menu_types`;
--
-- Dumping data for table `j37am_menu_types`
--

INSERT INTO `j37am_menu_types` (`id`, `asset_id`, `menutype`, `title`, `description`, `client_id`) VALUES
(1, 63, 'mainmenu', 'Main Menu', 'The main menu for the site', 0),
(2, 0, 'usermenu', 'User Menu', 'A Menu for logged-in Users', 0),
(3, 64, 'adminmenu', 'Admin Menu', 'This is a test admin menu set', 1);

--
-- Truncate table before insert `j37am_messages`
--

TRUNCATE TABLE `j37am_messages`;
--
-- Truncate table before insert `j37am_messages_cfg`
--

TRUNCATE TABLE `j37am_messages_cfg`;
--
-- Truncate table before insert `j37am_modules`
--

TRUNCATE TABLE `j37am_modules`;
--
-- Dumping data for table `j37am_modules`
--

INSERT INTO `j37am_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
(12, 46, 'Admin Menu', '', '', 1, 'menu', 0, '0000-00-00 00:00:00', '2016-11-07 08:58:30', '0000-00-00 00:00:00', 0, 'mod_menu', 3, 1, '{"menutype":"*","layout":"_:default","moduleclass_sfx":"","shownew":"1","showhelp":"1","forum_url":false,"module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 1, '*'),
...
(94, 65, 'Test Module', '', '', 1, 'menu', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'mod_menu', 3, 1, '{"menutype":"mainmenu","layout":"_:default","moduleclass_sfx":"","shownew":"1","showhelp":"1","forum_url":false,"module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 1, '*'),
(95, 66, 'Admin Menu 2', '', '', 1, 'menu', 0, '0000-00-00 00:00:00', '2016-11-02 08:58:00', '0000-00-00 00:00:00', 1, 'mod_menu', 3, 1, '{"menutype":"adminmenu","layout":"_:default","moduleclass_sfx":"","shownew":"1","showhelp":"1","forum_url":false,"module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 1, '*');

--
-- Truncate table before insert `j37am_modules_menu`
--

TRUNCATE TABLE `j37am_modules_menu`;
--
-- Dumping data for table `j37am_modules_menu`
--

INSERT INTO `j37am_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Truncate table before insert `j37am_newsfeeds`
--

TRUNCATE TABLE `j37am_newsfeeds`;
--
-- Truncate table before insert `j37am_overrider`
--

TRUNCATE TABLE `j37am_overrider`;
--
-- Truncate table before insert `j37am_postinstall_messages`
--

TRUNCATE TABLE `j37am_postinstall_messages`;
--
-- Dumping data for table `j37am_postinstall_messages`
--

INSERT INTO `j37am_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
--
-- Truncate table before insert `j37am_redirect_links`
--

TRUNCATE TABLE `j37am_redirect_links`;
--
-- Truncate table before insert `j37am_schemas`
--

TRUNCATE TABLE `j37am_schemas`;
--
-- Dumping data for table `j37am_schemas`
--

INSERT INTO `j37am_schemas` (`extension_id`, `version_id`) VALUES
(700, '3.7.0-2016-10-02');

--
-- Truncate table before insert `j37am_session`
--

TRUNCATE TABLE `j37am_session`;
--
-- Dumping data for table `j37am_session`
--

--
-- Truncate table before insert `j37am_tags`
--

TRUNCATE TABLE `j37am_tags`;
--
-- Dumping data for table `j37am_tags`
--

INSERT INTO `j37am_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
(1, 0, 0, 3, 0, '', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{}', '', '', '', 443, '2011-01-01 00:00:01', '', 0, '0000-00-00 00:00:00', '', '', 0, '*', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(2, 1, 1, 2, 1, 'joomla', 'Joomla', 'joomla', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"tag_layout":"","tag_link_class":"label label-info","image_intro":"","float_intro":"","image_intro_alt":"","image_intro_caption":"","image_fulltext":"","float_fulltext":"","image_fulltext_alt":"","image_fulltext_caption":""}', '', '', '{"author":"","robots":""}', 443, '2013-11-16 00:00:00', '', 0, '0000-00-00 00:00:00', '', '', 0, '*', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00');

--
-- Truncate table before insert `j37am_template_styles`
--

TRUNCATE TABLE `j37am_template_styles`;
--
-- Dumping data for table `j37am_template_styles`
--

INSERT INTO `j37am_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
...
--
-- Truncate table before insert `j37am_update_sites_extensions`
--

TRUNCATE TABLE `j37am_update_sites_extensions`;
--
-- Dumping data for table `j37am_update_sites_extensions`
--

INSERT INTO `j37am_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(3, 802),
(4, 28);
...
--
-- Truncate table before insert `j37am_usergroups`
--

TRUNCATE TABLE `j37am_usergroups`;
--
-- Dumping data for table `j37am_usergroups`
--

INSERT INTO `j37am_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Truncate table before insert `j37am_users`
--

TRUNCATE TABLE `j37am_users`;
--
-- Dumping data for table `j37am_users`
--

INSERT INTO `j37am_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`, `requireReset`) VALUES
(443, 'Super User', 'admin', 'izharaazmi@gmail.com', '$2y$10$0Z78f8vdCths.xjMvwSx8.PEhi0E2ET9yeNpu4A9W7vI7.GFNvRxe', 0, 1, '2016-10-11 02:56:24', '2016-11-07 08:56:53', '0', '', '0000-00-00 00:00:00', 0, '', '', 0);

--
-- Truncate table before insert `j37am_user_keys`
--

TRUNCATE TABLE `j37am_user_keys`;
--
-- Truncate table before insert `j37am_user_notes`
--

TRUNCATE TABLE `j37am_user_notes`;
--
-- Truncate table before insert `j37am_user_profiles`
--

TRUNCATE TABLE `j37am_user_profiles`;
--
-- Truncate table before insert `j37am_user_usergroup_map`
--

TRUNCATE TABLE `j37am_user_usergroup_map`;
--
-- Dumping data for table `j37am_user_usergroup_map`
--

INSERT INTO `j37am_user_usergroup_map` (`user_id`, `group_id`) VALUES
(443, 8);

--
-- Truncate table before insert `j37am_utf8_conversion`
--

TRUNCATE TABLE `j37am_utf8_conversion`;
--
-- Dumping data for table `j37am_utf8_conversion`
--

INSERT INTO `j37am_utf8_conversion` (`converted`) VALUES
(2);

--
-- Truncate table before insert `j37am_viewlevels`
--

TRUNCATE TABLE `j37am_viewlevels`;
--
-- Dumping data for table `j37am_viewlevels`
--

INSERT INTO `j37am_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
