...
if(c&&c.index>0){return null;}if(c&&b!==false){this.pos+=c[0].length;}return c;}},current:function(){return this.string.slice(this.start,this.pos);}};exports.StringStream=StringStream;
exports.startState=function(c,b,a){return c.startState?c.startState(b,a):true;};var modes=exports.modes={},mimeModes=exports.mimeModes={};exports.defineMode=function(a,c){if(arguments.length>2){c.dependencies=[];
for(var b=2;b<arguments.length;++b){c.dependencies.push(arguments[b]);}}modes[a]=c;};exports.defineMIME=function(b,a){mimeModes[b]=a;};exports.defineMode("null",function(){return{token:function(a){a.skipToEnd();
}};});exports.defineMIME("text/plain","null");exports.getMode=function(c,a){if(typeof a=="string"&&mimeModes.hasOwnProperty(a)){a=mimeModes[a];}if(typeof a=="string"){var e=a,b={};
}else{if(a!=null){var e=a.name,b=a;}}var d=modes[e];if(!d){throw new Error("Unknown mode: "+a);}return d(c,b||{});};exports.runMode=function(g,c,k){var f=exports.getMode({indentUnit:2},c);
var l=splitLines(g),b=exports.startState(f);for(var d=0,h=l.length;d<h;++d){if(d){k("\n");}var j=new exports.StringStream(l[d]);while(!j.eol()){var a=f.token(j,b);
k(j.current(),a,d,j.start);j.start=j.pos;}}};