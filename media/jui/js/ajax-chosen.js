      ...
      $(options.selector + '_chzn input').keyup(function(event) {
        ...
        if (this.value && this.value.length >= options.minTermLength && (event.which === 13 || event.which === 188)) {
          ...
          if (event.which === 13 && highlighted.text() !== '')
          {
            ...
            var tagOption = $(options.selector + ' option').filter(function () { return $(this).html() == highlighted.text(); });
          ...
          else
          {
            ...
            var tagOption = $(options.selector + ' option').filter(function () { return $(this).html() == customTag; });
            if (tagOption.text() !== '')
            {
              tagOption.attr('selected', 'selected');
            }
