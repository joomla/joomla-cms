...
{var bootstrapArrowWidth=16;var pos=this.icon.offset();this.panel.css({left:pos.left+this.icon.outerHeight(),top:pos.top-((this.panel.outerHeight()-this.icon.outerHeight())/2)-1});this.panel.show(this.options.delay);},hide:function()
