(function () {
  ...
  var elSearch = document.getElementById('comCronjobsSelectSearch');
  var elSearchContainer = document.getElementById('comCronjobsSelectSearchContainer');
  var elSearchHeader = document.getElementById('comCronjobsSelectTypeHeader');
  var elSearchResults = document.getElementById('comCronjobsSelectResultsContainer');
  var alertElement = document.querySelector('.jobs-alert');
  var elCards = [].slice.call(document.querySelectorAll('.comCronjobsSelectCard'));
  ...
  if (elSearch && elSearchContainer) {
    ...
    elSearch.addEventListener('keyup', function (event) {
      ...
      elCards.forEach(function (card) {
          // First remove the class which hides the job cards
          ...
          var cardHeader = card.querySelector('.new-job-title');
          var cardBody = card.querySelector('.card-body');
          var title = cardHeader ? cardHeader.textContent : '';
          var description = cardBody ? cardBody.textContent : ''; // If the job title and description don’t match add a class to hide it.
