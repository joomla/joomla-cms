...
var _createClass = function () {
  ...
  var style = document.createElement('style');style.id = 'joomla-switcher-style', style.innerHTML = '{{stylesheet}}', document.head.appendChild(style);
  ...
  function b() {
    _classCallCheck(this, b);var a = _possibleConstructorReturn(this, (b.__proto__ || Object.getPrototypeOf(b)).call(this));return a.inputs = [], a.spans = [], a.inputsContainer = '', a.spansContainer = '', a.newActive = '', a;
      ...
      var a = 0,
          b = this,
          c = document.createElement('span');c.classList.add('switcher'), c.setAttribute('tabindex', 0), this.type || this.setAttribute('type', 'success');var d = document.createElement('span');d.classList.add('switch'), this.inputs.forEach(function (b, d) {
        b.setAttribute('tabindex', '-1'), b.checked && c.setAttribute('aria-checked', !0), c.appendChild(b), 1 === d && b.checked && (a = 1);
      }), c.appendChild(d);var e = document.createElement('span');e.classList.add('switcher-labels');var f = document.createElement('span');f.classList.add('switcher-label-0'), f.innerText = this.offText;var g = document.createElement('span');g.classList.add('switcher-label-1'), g.innerText = this.onText, 0 == a ? f.classList.add('active') : g.classList.add('active'), this.spans.push(f), this.spans.push(g), e.appendChild(f), e.appendChild(g), this.appendChild(c), this.appendChild(e);
