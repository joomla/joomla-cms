...
Locale.define('cs-CZ', 'Date', {
	...
	months_abbr: ['ledna', '??nora', 'b??ezna', 'dubna', 'kv??tna', '??ervna', '??ervence', 'srpna', 'z??????', '????jna', 'listopadu', 'prosince'],
	...
	lessThanMinuteAgo: 'p??ed chv??l??',
	minuteAgo: 'p??ibli??n?? p??ed minutou',
	minutesAgo: function(delta){ return 'p??ed {delta} ' + pluralize(delta, 'minutou', 'minutami', 'minutami'); },
	hourAgo: 'p??ibli??n?? p??ed hodinou',
	hoursAgo: function(delta){ return 'p??ed {delta} ' + pluralize(delta, 'hodinou', 'hodinami', 'hodinami'); },
	dayAgo: 'p??ed dnem',
	daysAgo: function(delta){ return 'p??ed {delta} ' + pluralize(delta, 'dnem', 'dny', 'dny'); },
	weekAgo: 'p??ed t??dnem',
	weeksAgo: function(delta){ return 'p??ed {delta} ' + pluralize(delta, 't??dnem', 't??dny', 't??dny'); },
	monthAgo: 'p??ed m??s??cem',
	monthsAgo: function(delta){ return 'p??ed {delta} ' + pluralize(delta, 'm??s??cem', 'm??s??ci', 'm??s??ci'); },
	yearAgo: 'p??ed rokem',
	yearsAgo: function(delta){ return 'p??ed {delta} ' + pluralize(delta, 'rokem', 'lety', 'lety'); },

	lessThanMinuteUntil: 'za chv??li',
	minuteUntil: 'p??ibli??n?? za minutu',
	minutesUntil: function(delta){ return 'za {delta} ' + pluralize(delta, 'minutu', 'minuty', 'minut'); },
	hourUntil: 'p??ibli??n?? za hodinu',
	hoursUntil: function(delta){ return 'za {delta} ' + pluralize(delta, 'hodinu', 'hodiny', 'hodin'); },
	dayUntil: 'za den',
	daysUntil: function(delta){ return 'za {delta} ' + pluralize(delta, 'den', 'dny', 'dn??'); },
	weekUntil: 'za t??den',
	weeksUntil: function(delta){ return 'za {delta} ' + pluralize(delta, 't??den', 't??dny', 't??dn??'); },
	monthUntil: 'za m??s??c',
	monthsUntil: function(delta){ return 'za {delta} ' + pluralize(delta, 'm??s??c', 'm??s??ce', 'm??s??c??'); },
	yearUntil: 'za rok',
...
Locale.define('cs-CZ', 'FormValidator', {
	...
	required: 'Tato polo??ka je povinn??.',
	minLength: 'Zadejte pros??m alespo?? {minLength} znak?? (naps??no {length} znak??).',
	maxLength: 'Zadejte pros??m m??n?? ne?? {maxLength} znak?? (n??ps??no {length} znak??).',
	integer: 'Zadejte pros??m cel?? ????slo. Desetinn?? ????sla (nap??. 1.25) nejsou povolena.',
	numeric: 'Zadejte jen ????seln?? hodnoty (tj. "1" nebo "1.1" nebo "-1" nebo "-1.1").',
	digits: 'Zadejte pros??m pouze ????sla a interpunk??n?? znam??nka(nap????klad telefonn?? ????slo s poml??kami nebo te??kami je povoleno).',
	alpha: 'Zadejte pros??m pouze p??smena (a-z). Mezery nebo jin?? znaky nejsou povoleny.',
	alphanum: 'Zadejte pros??m pouze p??smena (a-z) nebo ????slice (0-9). Mezery nebo jin?? znaky nejsou povoleny.',
	...
	oneRequired: 'Zadejte pros??m alespo?? jednu hodnotu pro tyto polo??ky.',
	errorPrefix: 'Chyba: ',
	warningPrefix: 'Upozorn??n??: ',

	// Form.Validator.Extras
	noSpace: 'V t??to polo??ce nejsou povoleny mezery',
	reqChkByNode: 'Nejsou vybr??ny ????dn?? polo??ky.',
	requiredChk: 'Tato polo??ka je vy??adov??na.',
	reqChkByName: 'Pros??m vyberte {label}.',
	match: 'Tato polo??ka se mus?? shodovat s polo??kou {matchName}',
	startDate: 'datum zah??jen??',
	endDate: 'datum ukon??en??',
	currendDate: 'aktu??ln?? datum',
	afterDate: 'Datum by m??lo b??t stejn?? nebo v??t???? ne?? {label}.',
	beforeDate: 'Datum by m??lo b??t stejn?? nebo men???? ne?? {label}.',
	startMonth: 'Vyberte po????te??n?? m??s??c.',
	sameMonth: 'Tyto dva datumy mus?? b??t ve stejn??m m??s??ci - zm????te jeden z nich.',
	creditcard: 'Zadan?? ????slo kreditn?? karty je neplatn??. Pros??m opravte ho. Bylo zad??no {length} ????sel.'
...
Locale.define('de-DE', 'FormValidator', {
	...
	required: 'Dieses Eingabefeld muss ausgef??llt werden.',
	...
	dateSuchAs: 'Geben Sie bitte ein g??ltiges Datum ein (z.B. "{date}").',
	dateInFormatMDY: 'Geben Sie bitte ein g??ltiges Datum im Format TT.MM.JJJJ ein (z.B. "31.12.1999").',
	email: 'Geben Sie bitte eine g??ltige E-Mail-Adresse ein (z.B. "max@mustermann.de").',
	url: 'Geben Sie bitte eine g??ltige URL ein (z.B. "http://www.example.com").',
	currencyDollar: 'Geben Sie bitte einen g??ltigen Betrag in EURO ein (z.B. 100.00???).',
	oneRequired: 'Bitte f??llen Sie mindestens ein Eingabefeld aus.',
	errorPrefix: 'Fehler: ',
	warningPrefix: 'Warnung: ',
	...
	requiredChk: 'Dieses Feld muss ausgef??llt werden.',
	...
	beforeDate: 'Das Datum sollte zur gleichen Zeit oder fr??her sein als {label}.',
	startMonth: 'W??hlen Sie bitte einen Anfangsmonat',
	sameMonth: 'Diese zwei Datumsangaben m??ssen im selben Monat sein - Sie m??ssen eines von beiden ver??ndern.',
	creditcard: 'Die eingegebene Kreditkartennummer ist ung??ltig. Bitte ??berpr??fen Sie diese und versuchen Sie es erneut. {length} Zahlen eingegeben.'
...
Locale.define('fr-FR', 'Date', {
	...
	months_abbr: ['janv.', 'f??vr.', 'mars', 'avr.', 'mai', 'juin', 'juil.', 'ao??t', 'sept.', 'oct.', 'nov.', 'd??c.'],
...
Locale.define('hu-HU', 'Date', {
	...
	days: ['Vas??rnap', 'H??tf??', 'Kedd', 'Szerda', 'Cs??t??rt??k', 'P??ntek', 'Szombat'],
...
Locale.define('hu-HU', 'FormValidator', {
	...
	minLength: 'Legal??bb {minLength} karakter megad??sa sz??ks??ges (megadva {length} karakter).',
	maxLength: 'Legfeljebb {maxLength} karakter megad??sa lehets??ges (megadva {length} karakter).',
	integer: 'Eg??sz sz??m megad??sa sz??ks??ges. A tizedesjegyek (pl. 1.25) nem enged??lyezettek.',
	numeric: 'Sz??m megad??sa sz??ks??ges (pl. "1" vagy "1.1" vagy "-1" vagy "-1.1").',
	digits: 'Csak sz??mok ??s ??r??sjelek megad??sa lehets??ges (pl. telefonsz??m k??t??jelek ??s/vagy perjelekkel).',
	...
	dateSuchAs: 'Val??s d??tum megad??sa sz??ks??ges (pl. {date}).',
	...
	url: 'Val??s URL megad??sa sz??ks??ges (pl. http://www.example.com).',
	currencyDollar: 'Val??s p??nz??sszeg megad??sa sz??ks??ges (pl. 100.00 Ft.).',
	oneRequired: 'Az al??bbi mez??k legal??bb egyik??nek kit??lt??se k??telez??.',
	errorPrefix: 'Hiba: ',
	warningPrefix: 'Figyelem: ',

	// Form.Validator.Extras
	noSpace: 'A mez?? nem tartalmazhat sz??k??z??ket.',
	reqChkByNode: 'Nincs egyetlen kijel??lt elem sem.',
	requiredChk: 'A mez?? kit??lt??se k??telez??.',
	reqChkByName: 'Egy {label} kiv??laszt??sa sz??ks??ges.',
	match: 'A mez??nek egyeznie kell a(z) {matchName} mez??vel.',
	...
	startMonth: 'Kezdeti h??nap megad??sa sz??ks??ges.',
...
Locale.define('pl-PL', 'FormValidator', {
	...
	minLength: 'Wymagane jest przynajmniej {minLength} znak??w (wpisanych zosta??o tylko {length}).',
	maxLength: 'Dozwolone jest nie wi??cej ni?? {maxLength} znak??w (wpisanych zosta??o {length})',
	...
	url: 'Prosimy poda?? prawid??owy adres URL, np. http://www.example.com.',
...
Locale.define('si-SI', 'FormValidator', {
	...
	numeric: 'Prosim, vnesite samo numeri??ne vrednosti (kot "1" ali "1.1" ali "-1" ali "-1.1").',
	digits: 'Prosim, uporabite ??tevilke in lo??ila le na tem polju (na primer, dovoljena je telefonska ??tevilka z pomi??laji ali pikami).',
	...
	// Form.Validator.Extras
	noSpace: 'To vnosno polje ne dopu????a presledkov.',
	reqChkByNode: 'Ni?? niste izbrali.',
	requiredChk: 'To polje je obvezno',
	reqChkByName: 'Prosim, izberite {label}.',
	match: 'To polje se mora ujemati z poljem {matchName}',
	startDate: 'datum za??etka',
	endDate: 'datum konca',
	currendDate: 'trenuten datum',
	afterDate: 'Datum bi moral biti isti ali po {label}.',
	beforeDate: 'Datum bi moral biti isti ali pred {label}.',
	startMonth: 'Prosim, vnesite za??etni datum',
