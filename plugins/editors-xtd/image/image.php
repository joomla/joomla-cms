...
class PlgButtonImage extends JPlugin
{
	...
	public function onDisplay($name, $asset, $author)
	{
		...
		{
			$link = 'index.php?option=com_media&amp;view=images&amp;controller=media.display.images&amp;tmpl=component&amp;e_name=' . $name . '&amp;asset=' . $asset . '&amp;author=' . $author;
			...
			$button->name = 'picture';
			$button->options = "{handler: 'iframe', size: {x: 1100, y: 600}}";
