...
$editor          = 'editor="' . Uri::root(false) . ltrim(HTMLHelper::_('script',  $basePath . 'lib/jcm' . $extJS, ['version' => 'auto', 'pathOnly' => true]), '/') . '"';
...
?>
<joomla-editor-codemirror <?php echo $editor, $modPath, $fsCombo, $option; ?>>
