...
class PlgQuickiconPrivacyCheck extends CMSPlugin
{
    ...
    public function onGetIcons($context)
    {
        ...
        return [['link'  => $privacy . '&view=requests&filter[status]=1&list[fullordering]=a.requested_at ASC', 'image' => 'icon-users', 'icon'  => '', 'text'  => Text::_('PLG_QUICKICON_PRIVACYCHECK_CHECKING'), 'id'    => 'plg_quickicon_privacycheck', 'group' => 'MOD_QUICKICON_USERS']];
    }
}
