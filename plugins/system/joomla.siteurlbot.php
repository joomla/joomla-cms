...
function botJoomlaSiteUrl( ) {
	...
	if ( isset ( $_SERVER['PHP_SELF'] ) ) {
		...
		$mainframe->_registry->_registry['JConfig']['data']->unsecure_site = 'http://' . $siteHost . $sitePath;
		$mainframe->_registry->_registry['JConfig']['data']->live_site = $siteProtocol . '://' . $siteHost . $sitePath;
