		...
		if ($this->app->isClient('administrator')){
			$joomla_shortcut_keys = array(
				'new' => array(
				  ...
				  'selector' => $this->params->get('new_selector', 'joomla-toolbar-button button.button-new')
				),
				'apply' => array(
				  'keyEvent' => $this->params->get('apply_keyEvent', 's'),
				  'hasShift' => $this->params->get('apply_hasShift', 0),
				  'hasAlt' => $this->params->get('apply_hasAlt', 1),
				  'hasControl' => $this->params->get('apply_hasControl', 1),
				  'selector' => $this->params->get('apply_selector', 'joomla-toolbar-button button.button-apply')
				),
				'save' => array(
				  'keyEvent' => $this->params->get('save_keyEvent', 'w'),
				  'hasShift' => $this->params->get('save_hasShift', 0),
				  'hasAlt' => $this->params->get('save_hasAlt', 1),
				  'hasControl' => $this->params->get('save_hasControl', 1),
				  'selector' => $this->params->get('save_selector', 'joomla-toolbar-button button.button-save')
				),
				'saveNew' => array(
				  'keyEvent' => $this->params->get('saveNew_keyEvent', 'w'),
				  'hasShift' => $this->params->get('saveNew_hasShift', 1),
				  'hasAlt' => $this->params->get('saveNew_hasAlt', 1),
				  'hasControl' => $this->params->get('saveNew_hasControl', 1),
				  'selector' => $this->params->get('saveNew_selector', 'joomla-toolbar-button button.button-save-new')
				),
				'help' => array(
				  'keyEvent' => $this->params->get('help_keyEvent', 'h'),
				  'hasShift' => $this->params->get('help_hasShift', 0),
				  'hasAlt' => $this->params->get('help_hasAlt', 1),
				  'hasControl' => $this->params->get('help_hasControl', 1),
				  'selector' => $this->params->get('help_selector', 'joomla-toolbar-button button.button-help')
				),
				'cancel' => array(
				  ...
				  'hasControl' => $this->params->get('cancel_hasControl', 1),
				  'selector' => $this->params->get('cancel_selector', 'joomla-toolbar-button button.button-cancel')
				),
				'copy' => array(
				  'keyEvent' => $this->params->get('copy_keyEvent', 'c'),
				  'hasShift' => $this->params->get('copy_hasShift', 1),
				  'hasAlt' => $this->params->get('copy_hasAlt', 1),
				  'hasControl' => $this->params->get('copy_hasControl', 1),
				  'selector' => $this->params->get('copy_selector', 'joomla-toolbar-button button.button-button-copy')
				),
				'article' => array(
				  ...
				  'selector' => $this->params->get('article_selector', 'joomla-editor-option~article_modal')
				),
				'contact' => array(
				  ...
				  'selector' => $this->params->get('contact_selector', 'joomla-editor-option~contact_modal')
				),
				'fields' => array(
				  ...
				  'selector' => $this->params->get('fields_selector', 'joomla-editor-option~fields_modal')
				),
				'image' => array(
				  ...
				  'selector' => $this->params->get('image_selector', 'joomla-editor-option~image_modal')
				),
				'menu' => array(
				  ...
				  'selector' => $this->params->get('menu_selector', 'joomla-editor-option~menu_modal')
				),
				'module' => array(
				  ...
				  'selector' => $this->params->get('module_selector', 'joomla-editor-option~module_modal')
				),
				'pagebreak' => array(
				  ...
				  'selector' => $this->params->get('pagebreak_selector', 'joomla-editor-option~pagebreak_modal')
				),
				'readmore' => array(
				  ...
				  'selector' => $this->params->get('readmore_selector', 'joomla-editor-option~read_more')
				)
			);
