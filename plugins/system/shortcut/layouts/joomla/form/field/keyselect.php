...
<button id="<?php echo $id; ?>_btn" data-bs-toggle="modal" data-bs-target="#keySelectModal" class="btn btn-secondary <?php echo $class; ?>" type="button" data-class="<?php echo $class; ?>"><?php echo $value; ?></button>
