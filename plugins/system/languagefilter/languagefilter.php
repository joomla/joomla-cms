...
class PlgSystemLanguageFilter extends CMSPlugin
{
	...
	private function setLanguageCookie($languageCode)
	{
		...
		{
			Factory::getApplication()->getSession()->set('plg_system_languagefilter.language', $languageCode);
		}
	}
	...
	private function getLanguageCookie()
	{
		...
		{
			$languageCode = Factory::getApplication()->getSession()->get('plg_system_languagefilter.language');
		}
