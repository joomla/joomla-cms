...
<form method="post" action="<?php echo htmlspecialchars($uri->toString(), ENT_COMPAT, 'UTF-8'); ?>" class="form-inline">
	<span class="content_vote">
		...
		<?php echo HTMLHelper::_('select.genericlist', $options, 'user_rating', 'class="form-control w-25"', 'value', 'text', '5', 'content_vote_' . (int) $row->id); ?>
		<input class="btn btn-primary mt-1" type="submit" name="submit_vote" value="<?php echo Text::_('PLG_VOTE_RATE'); ?>">
