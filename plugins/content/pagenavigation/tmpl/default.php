...
<nav class="pagenavigation">
    ...
    <?php if ($row->prev) :
        $direction = $lang->isRtl() ? 'right' : 'left'; ?>
            ...
            <span class="visually-hidden">
                <?php echo sprintf($lang->_('JPREVIOUS_TITLE'), htmlspecialchars($rows[$location - 1]->title)); ?>
            </span>
    ...
    <?php if ($row->next) :
        $direction = $lang->isRtl() ? 'left' : 'right'; ?>
            ...
            <span class="visually-hidden">
                <?php echo sprintf($lang->_('JNEXT_TITLE'), htmlspecialchars($rows[$location + 1]->title)); ?>
            </span>
