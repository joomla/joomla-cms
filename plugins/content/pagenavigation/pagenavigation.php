		...
		if ($params->get('show_item_navigation') && ($context == 'com_content.article') && ($view == 'article')) {
			...
			switch ($order_method) {
				...
				case 'order' :
					...
					break;
				case 'author' :
					$orderby = 'a.created_by_alias, CONCAT_WS(' ', u.firstname, u.middlename, u.surname)';
					break;
				case 'rauthor' :
					$orderby = 'a.created_by_alias DESC, CONCAT_WS(' ', u.firstname, u.middlename, u.surname) DESC';
					break;
				case 'front' :
					$orderby = 'f.ordering';
					break;
