...
class PlgUserProfile extends JPlugin
{
	 ...
	 * No Description available
	 *
	 * @param   string  $value  No Description available
	 *
	 * @return  string
	 */
	 ...
	 * No Description available
	 *
	 * @param   unknown  $value  No Description available
	 *
	 * @return  unknown
	 */
	 ...
	 * No Description available
	 *
	 * @param   unkown  $data    No Description available
	 * @param   unkown  $isNew   No Description available
	 * @param   unkown  $result  No Description available
	 * @param   unkown  $error   No Description available
	 *
	 * @return  boolean
	 */
