						...
						<div class="j-install-step-form">
							<div class="alert preinstall-alert">
								...
								<div class="alert-text">
									...
									<p class="form-text text-muted small"><span class="badge bg-default"><?php echo $this->error->getCode(); ?></span> <?php echo htmlspecialchars($this->error->getMessage(), ENT_QUOTES, 'UTF-8'); ?></p>
								</div>
							</div>
							<?php if ($this->debug) : ?>
								<div>
