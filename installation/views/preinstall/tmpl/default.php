...
<div id="step">
	<div class="buttons">
		<div class="button"><a href="index.php?view=preinstall" class="refresh" onclick="return Install.goToPage('preinstall');" title="<?php echo JText::_('JCheck_Again'); ?>"><?php echo JText::_('JCheck_Again'); ?></a></div>
		<div class="button"><a href="index.php?view=language" onclick="return Install.goToPage('language');" rel="prev" title="<?php echo JText::_('JPrevious'); ?>"><?php echo JText::_('JPrevious'); ?></a></div>
	<?php if ($this->sufficient) : ?>
		<div class="button"><a href="index.php?view=license" onclick="return Install.goToPage('license');" rel="next" title="<?php echo JText::_('JNext'); ?>"><?php echo JText::_('JNext'); ?></a></div>
	<?php endif; ?>
	</div>
