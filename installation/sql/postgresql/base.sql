...
INSERT INTO "#__menu" ("id", "menutype", "title", "alias", "note", "path", "link", "type", "published", "parent_id", "level", "component_id", "browserNav", "access", "img", "template_style_id", "params", "lft", "rgt", "home", "language", "client_id", "publish_up", "publish_down")
SELECT 22, 'main', 'com_cookiemanager', 'Cookiemanager', '', 'Cookiemanager', 'index.php?option=com_cookiemanager', 'component', 1, 1, 1, "extension_id", 0, 1, 'class:cokie', 0, '', 41, 50, 0, '*', 1, NULL, NULL FROM "#__extensions" WHERE "name" = 'com_cookiemanager';
INSERT INTO "#__menu" ("id", "menutype", "title", "alias", "note", "path", "link", "type", "published", "parent_id", "level", "component_id", "browserNav", "access", "img", "template_style_id", "params", "lft", "rgt", "home", "language", "client_id", "publish_up", "publish_down")
