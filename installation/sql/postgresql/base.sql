...
(0, 'com_actionlogs', 'component', 'com_actionlogs', '', 1, 1, 1, 0, 1, '', '(0, ''com_actionlogs'', ''component'', ''com_actionlogs'', '''', 1, 1, 1, 0, 1, '''', ''{"ip_logging":0,"csv_delimiter":",","loggable_extensions":["com_content","com_banners","com_cache","com_categories","com_checkin","com_config","com_contact","com_installer","com_media","com_menus","com_messages","com_modules","com_newsfeeds","com_plugins","com_redirect","com_tags","com_templates","com_users"],"loggable_api":0,"loggable_verbs":["GET"]}''),', 0, 0),
