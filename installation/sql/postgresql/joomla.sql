...
CREATE TABLE IF NOT EXISTS "#__ucm_content" (
  ...
  "core_created_time" timestamp without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
  "core_modified_user_id" bigint DEFAULT 0 NOT NULL,
  "core_modified_time" timestamp without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
