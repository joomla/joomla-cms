...
VALUES (97,'RotateLogs','rotation.logs', CONCAT('{"rule-type":"interval-days","interval-days":"30","exec-day":"01","exec-time":"', TO_CHAR(CURRENT_TIMESTAMP, 'HH24:00'), '"}'), '{"type":"interval","exp":"P30D"}', 1, 0, '{}', CURRENT_TIMESTAMP);
