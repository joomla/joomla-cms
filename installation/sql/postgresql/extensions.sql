...
--
-- Table structure for table `#__content_preview_tokens`
--
...
CREATE UNIQUE INDEX "#__content_preview_tokens_idx_token" ON "#__content_preview_tokens" ("token");
CREATE INDEX "#__content_preview_tokens_idx_article_id" ON "#__content_preview_tokens" ("article_id");
CREATE INDEX "#__content_preview_tokens_idx_expires" ON "#__content_preview_tokens" ("expires");
