...
SELECT "extension_id", 'PLG_MULTIFACTORAUTH_TOTP_POSTINSTALL_TITLE', 'PLG_MULTIFACTORAUTH_TOTP_POSTINSTALL_BODY', 'PLG_MULTIFACTORAUTH_TOTP_POSTINSTALL_ACTION', 'plg_multifactorauth_totp', 1, 'action', 'site://plugins/multifactorauth/totp/postinstall/actions.php', 'multifactorauth_postinstall_action', 'site://plugins/multifactorauth/totp/postinstall/actions.php', 'multifactorauth_postinstall_condition', '3.2.0', 1 FROM "#__extensions" WHERE "name" = 'files_joomla';
INSERT INTO "#__postinstall_messages" ("extension_id", "title_key", "description_key", "action_key", "language_extension", "language_client_id", "type", "action_file", "action", "condition_file", "condition_method", "version_introduced", "enabled")
