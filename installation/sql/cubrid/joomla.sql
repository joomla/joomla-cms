...
CREATE TABLE IF NOT EXISTS `#__assets` (
  ...
  `level` integer NOT NULL DEFAULT 0 COMMENT 'The cached level in the nested tree.',
...
CREATE TABLE IF NOT EXISTS `#__associations` (
  ...
  `context` varchar(50) NOT NULL DEFAULT '' COMMENT 'The context of the associated item.',
...
CREATE TABLE IF NOT EXISTS `#__banners` (
  ...
  `metakey` varchar(65535) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `#__banner_clients` (
  ...
  `extrainfo` varchar(65535) NOT NULL DEFAULT '',
  `state` short NOT NULL DEFAULT 0,
  `checked_out` integer NOT NULL DEFAULT 0,
  `checked_out_time` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `metakey` varchar(65535) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `#__banner_tracks` (
  `track_date` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
...
CREATE TABLE IF NOT EXISTS `#__contact_details` (
  ...
  `modified_by` integer NOT NULL DEFAULT 0,
  `metakey` varchar(65535) NOT NULL DEFAULT '',
  `metadesc` varchar(65535) NOT NULL DEFAULT '',
  `metadata` varchar(65535) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `#__content` (
  ...
  `title` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(400) CHARSET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
  `introtext` varchar(16777215) NOT NULL DEFAULT '',
  `fulltext` varchar(16777215) NOT NULL DEFAULT '',
  `state` short NOT NULL DEFAULT 0,
  `catid` integer NOT NULL DEFAULT 0,
  `created` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `created_by` integer NOT NULL DEFAULT 0,
  ...
  `publish_up` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `publish_down` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `images` varchar(65535) NOT NULL DEFAULT '',
  `urls` varchar(65535) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `#__content_types` (
  ...
  `rules` varchar(65535) NOT NULL DEFAULT '',
  `field_mappings` varchar(65535) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `#__contentitem_tag_map` (
  ...
  `core_content_id` integer NOT NULL DEFAULT 0 COMMENT 'PK from the core content table',
  `content_item_id` bigint NOT NULL COMMENT 'PK from the content type table',
  `tag_id` integer NOT NULL DEFAULT 0 COMMENT 'PK from the tag table',
  `tag_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Date of most recent save for this tag-item',
  `type_id` integer NOT NULL DEFAULT 0 COMMENT 'PK from the content_type table',
...
CREATE TABLE IF NOT EXISTS `#__extensions` (
  ...
  `manifest_cache` varchar(65535) NOT NULL DEFAULT '',
  `params` varchar(65535) NOT NULL DEFAULT '',
  `custom_data` varchar(65535) NOT NULL DEFAULT '',
  `system_data` varchar(65535) NOT NULL DEFAULT '',
  `checked_out` integer NOT NULL DEFAULT 0,
  `checked_out_time` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
...
CREATE TABLE IF NOT EXISTS `#__fields` (
  ...
  `ordering` bigint NOT NULL DEFAULT '0',
  `params` varchar(65535) NOT NULL DEFAULT '',
  `fieldparams` varchar(65535) NOT NULL DEFAULT '',
  `language` char(7) NOT NULL DEFAULT '',
  `created_time` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `created_user_id` integer NOT NULL DEFAULT '0',
  `modified_time` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
...
CREATE TABLE IF NOT EXISTS `#__fields_values` (
  ...
  `item_id` varchar(255) NOT NULL DEFAULT '' COMMENT 'Allow references to items which have strings as ids, eg. none db systems.',
...
CREATE TABLE IF NOT EXISTS `#__finder_filters` (
  ...
  `data` varchar(65535) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `#__finder_tokens_aggregate` (
  ...
  `common` short NOT NULL DEFAULT 0,
  `phrase` short NOT NULL DEFAULT 0,
  `term_weight` float NOT NULL DEFAULT 0.0,
  `context` short NOT NULL DEFAULT 2,
  `context_weight` float NOT NULL DEFAULT 0.0,
...
CREATE TABLE IF NOT EXISTS `#__menu` (
  ...
  `params` varchar(65535) NOT NULL DEFAULT '' COMMENT 'JSON encoded data for the menu item.',
  `lft` bigint NOT NULL DEFAULT 0 COMMENT 'Nested set lft.',
  `rgt` bigint NOT NULL DEFAULT 0 COMMENT 'Nested set rgt.',
...
CREATE TABLE IF NOT EXISTS `#__menu_types` (
  `id` integer NOT NULL AUTO_INCREMENT,
  `asset_id` integer NOT NULL DEFAULT 0,
  `menutype` varchar(24) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `#__overrider` (
  ...
  `string` varchar(65535) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `#__ucm_base` (
  `ucm_id` integer NOT NULL DEFAULT 0,
  `ucm_item_id` integer NOT NULL DEFAULT 0,
  `ucm_type_id` bigint NOT NULL DEFAULT 0,
  `ucm_language_id` bigint NOT NULL DEFAULT 0,
  PRIMARY KEY (`ucm_id`),
...
CREATE TABLE IF NOT EXISTS `#__ucm_history` (
  ...
  `version_data` varchar(16777215) NOT NULL DEFAULT '' COMMENT 'json-encoded string of version data',
...
CREATE TABLE IF NOT EXISTS `#__updates` (
  ...
  `data` varchar(65535) NOT NULL DEFAULT '',
  `detailsurl` varchar(65535) NOT NULL DEFAULT '',
  `infourl` varchar(65535) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `#__update_sites` (
  ...
  `name` varchar(100) DEFAULT '',
  `type` varchar(20) DEFAULT '',
  `location` varchar(65535) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `#__user_keys` (
  ...
  `invalid` short NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `#__user_profiles` (
  ...
  `profile_value` varchar(65535) NOT NULL DEFAULT '',
  `ordering` bigint NOT NULL DEFAULT 0,
