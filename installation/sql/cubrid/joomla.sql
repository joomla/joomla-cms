...
CREATE TABLE IF NOT EXISTS `#__assets` (
  ...
  `parent_id` bigint NOT NULL DEFAULT 0 COMMENT 'Nested set parent.',
  `lft` bigint NOT NULL DEFAULT 0 COMMENT 'Nested set lft.',
  `rgt` bigint NOT NULL DEFAULT 0 COMMENT 'Nested set rgt.',
  `level` integer NOT NULL COMMENT 'The cached level in the nested tree.',
...
) CHARSET utf8 COLLATE utf8_ko_cs;
...
CREATE TABLE IF NOT EXISTS `#__associations` (
  `id` bigint NOT NULL COMMENT 'A reference to the associated item.',
...
CREATE TABLE IF NOT EXISTS `#__banners` (
  ...
  `alias` varchar(400) CHARSET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
  `imptotal` bigint NOT NULL DEFAULT 0,
  `impmade` bigint NOT NULL DEFAULT 0,
  `clicks` bigint NOT NULL DEFAULT 0,
  `clickurl` varchar(200) NOT NULL DEFAULT '',
  `state` short NOT NULL DEFAULT 0,
  `catid` integer NOT NULL DEFAULT 0,
  `description` varchar(65535) NOT NULL,
  `custombannercode` varchar(2048) NOT NULL,
  `sticky` short NOT NULL DEFAULT 0,
  `ordering` bigint NOT NULL DEFAULT 0,
  `metakey` varchar(65535) NOT NULL,
  `params` varchar(65535) NOT NULL,
  `own_prefix` short NOT NULL DEFAULT 0,
  `metakey_prefix` varchar(400) NOT NULL DEFAULT '',
  `purchase_type` short NOT NULL DEFAULT -1,
  `track_clicks` short NOT NULL DEFAULT -1,
  `track_impressions` short NOT NULL DEFAULT -1,
  ...
  `reset` datetime NOT NULL DEFAULT '1970-01-01 00:00:00',
...
CREATE TABLE IF NOT EXISTS `#__banner_clients` (
  ...
  `extrainfo` varchar(65535) NOT NULL,
  `state` short NOT NULL DEFAULT 0,
  `checked_out` integer NOT NULL DEFAULT 0,
  `checked_out_time` datetime NOT NULL DEFAULT '1970-01-01 00:00:00',
  `metakey` varchar(65535) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `#__categories` (
  ...
  `description` varchar(16777215) NOT NULL DEFAULT '',
  `published` short NOT NULL DEFAULT 0,
  `checked_out` bigint NOT NULL DEFAULT 0,
  `checked_out_time` datetime NOT NULL DEFAULT '1970-01-01 00:00:00',
  `access` integer NOT NULL DEFAULT 0,
  `params` varchar(65535) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `#__contact_details` (
  ...
  `alias` varchar(400) CHARSET utf8 COLLATE utf8_bin NOT NULL,
  ...
  `fax` varchar(255),
  `misc` varchar(16777215),
  `image` varchar(255),
  `email_to` varchar(255),
  `default_con` short NOT NULL DEFAULT 0,
  `published` short NOT NULL DEFAULT 0,
  `checked_out` integer NOT NULL DEFAULT 0,
  `checked_out_time` datetime NOT NULL DEFAULT '1970-01-01 00:00:00',
  `ordering` bigint NOT NULL DEFAULT 0,
  ...
  `modified_by` integer NOT NULL DEFAULT 0,
  `metakey` varchar(65535) NOT NULL,
  `metadesc` varchar(65535) NOT NULL,
  `metadata` varchar(65535) NOT NULL,
  `featured` short NOT NULL DEFAULT 0 COMMENT 'Set if contact is featured.',
...
CREATE TABLE IF NOT EXISTS `#__content` (
  ...
  `title` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(400) CHARSET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
  `introtext` varchar(16777215) NOT NULL,
  `fulltext` varchar(16777215) NOT NULL,
  `state` short NOT NULL DEFAULT 0,
  `catid` integer NOT NULL DEFAULT 0,
  `created` datetime NOT NULL DEFAULT '1970-01-01 00:00:00',
  `created_by` integer NOT NULL DEFAULT 0,
  ...
  `hits` integer NOT NULL DEFAULT 0,
  `metadata` varchar(65535) NOT NULL,
  `featured` short NOT NULL DEFAULT 0 COMMENT 'Set if article is featured.',
...
CREATE TABLE IF NOT EXISTS `#__contentitem_tag_map` (
  ...
  `core_content_id` integer NOT NULL COMMENT 'PK from the core content table',
  `content_item_id` bigint NOT NULL COMMENT 'PK from the content type table',
  `tag_id` integer NOT NULL COMMENT 'PK from the tag table',
  `tag_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Date of most recent save for this tag-item',
  `type_id` integer NOT NULL COMMENT 'PK from the content_type table',
  UNIQUE KEY `uc_ItemnameTagid` (`type_id`,`content_item_id`,`tag_id`),
  KEY `idx_tag_type` (`tag_id`,`type_id`),
  KEY `idx_date_id` (`tag_date`,`tag_id`),
  KEY `idx_core_content_id` (`core_content_id`)
) CHARSET utf8 COLLATE utf8_ko_cs COMMENT='Maps items from content tables to tags';
...
CREATE TABLE IF NOT EXISTS `#__extensions` (
  ...
  `package_id` bigint NOT NULL DEFAULT 0 COMMENT 'Parent package ID for extensions installed as a package.',
  `name` varchar(100) NOT NULL,
  `type` varchar(20) NOT NULL,
  `element` varchar(100) NOT NULL,
  `folder` varchar(100) NOT NULL,
  `client_id` short NOT NULL,
  `enabled` short NOT NULL DEFAULT 0,
  `access` integer NOT NULL DEFAULT 1,
  `protected` short NOT NULL DEFAULT 0,
  `manifest_cache` varchar(65535) NOT NULL,
  `params` varchar(65535) NOT NULL,
  `custom_data` varchar(65535) NOT NULL,
  `system_data` varchar(65535) NOT NULL,
  `checked_out` integer NOT NULL DEFAULT 0,
  `checked_out_time` datetime NOT NULL DEFAULT '1970-01-01 00:00:00',
...
CREATE TABLE IF NOT EXISTS `#__fields` (
  ...
  `default_value` varchar(65535) NOT NULL DEFAULT '',
  `type` varchar(255) NOT NULL DEFAULT 'text',
  `note` varchar(255) NOT NULL DEFAULT '',
  `description` varchar(65535) NOT NULL,
  `state` short NOT NULL DEFAULT '0',
  `required` short NOT NULL DEFAULT '0',
  `checked_out` bigint NOT NULL DEFAULT '0',
  `checked_out_time` datetime NOT NULL DEFAULT '1970-01-01 00:00:00',
  `ordering` bigint NOT NULL DEFAULT '0',
  `params` varchar(65535) NOT NULL,
  `fieldparams` varchar(65535) NOT NULL,
  `language` char(7) NOT NULL DEFAULT '',
  `created_time` datetime NOT NULL DEFAULT '1970-01-01 00:00:00',
  `created_user_id` integer NOT NULL DEFAULT '0',
  `modified_time` datetime NOT NULL DEFAULT '1970-01-01 00:00:00',
...
CREATE TABLE IF NOT EXISTS `#__finder_filters` (
  ...
  `state` short NOT NULL DEFAULT 1,
  `created` datetime NOT NULL DEFAULT '1970-01-01 00:00:00',
  ...
  `params` varchar(16777215),
  PRIMARY KEY (`filter_id`)
) CHARSET utf8 COLLATE utf8_en_ci;
...
CREATE TABLE IF NOT EXISTS `#__finder_links` (
  ...
  `indexdate` datetime NOT NULL DEFAULT '1970-01-01 00:00:00',
  `md5sum` varchar(32) DEFAULT NULL,
  `published` short NOT NULL DEFAULT 1,
  `state` short DEFAULT 1,
  `access` short DEFAULT 0,
  `language` varchar(8) NOT NULL,
  `publish_start_date` datetime NOT NULL DEFAULT '1970-01-01 00:00:00',
  `publish_end_date` datetime NOT NULL DEFAULT '1970-01-01 00:00:00',
...
CREATE TABLE IF NOT EXISTS `#__finder_taxonomy` (
  ...
  `title` varchar(255) NOT NULL,
  `state` short NOT NULL DEFAULT 1,
  `access` short NOT NULL DEFAULT 0,
  `ordering` short NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `#__finder_terms` (
  ...
  `common` short NOT NULL DEFAULT 0,
  `phrase` short NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `#__finder_tokens` (
  ...
  `context` short NOT NULL DEFAULT 2,
  `language` char(3) NOT NULL DEFAULT '',
  KEY `idx_word` (`term`),
...
CREATE TABLE IF NOT EXISTS `#__finder_tokens_aggregate` (
  ...
  `common` short NOT NULL DEFAULT 0,
  `phrase` short NOT NULL DEFAULT 0,
  `term_weight` float NOT NULL,
  `context` short NOT NULL DEFAULT 2,
  `context_weight` float NOT NULL,
...
CREATE TABLE IF NOT EXISTS `#__languages` (
  ...
  `asset_id` integer NOT NULL DEFAULT 0,
  `lang_code` char(7) CHARSET utf8 COLLATE utf8_bin NOT NULL,
...
CREATE TABLE IF NOT EXISTS `#__menu` (
  ...
  `alias` varchar(400) CHARSET utf8 COLLATE utf8_bin NOT NULL COMMENT 'The SEF alias of the menu item.',
  `note` varchar(255) NOT NULL DEFAULT '',
  `path` varchar(1024) NOT NULL COMMENT 'The computed path of the menu item based on the alias field.',
  `link` varchar(1024) NOT NULL COMMENT 'The actually link the menu item refers to.',
  `type` varchar(16) NOT NULL COMMENT 'The type of link: Component, URL, Alias, Separator',
  `published` short NOT NULL DEFAULT 0 COMMENT 'The published state of the menu link.',
  `parent_id` integer NOT NULL DEFAULT 1 COMMENT 'The parent menu item in the menu tree.',
  `level` integer NOT NULL DEFAULT 0 COMMENT 'The relative level in the tree.',
  `component_id` integer NOT NULL DEFAULT 0 COMMENT 'FK to #__extensions.id',
  `checked_out` integer NOT NULL DEFAULT 0 COMMENT 'FK to #__users.id',
  `checked_out_time` datetime NOT NULL DEFAULT '1970-01-01 00:00:00' COMMENT 'The time the menu item was checked out.',
  `browserNav` short NOT NULL DEFAULT 0 COMMENT 'The click behaviour of the link.',
  `access` integer NOT NULL DEFAULT 0 COMMENT 'The access level required to view the menu item.',
  `img` varchar(255) NOT NULL COMMENT 'The image of the menu item.',
  `template_style_id` integer NOT NULL DEFAULT 0,
  `params` varchar(65535) NOT NULL COMMENT 'JSON encoded data for the menu item.',
  `lft` bigint NOT NULL DEFAULT 0 COMMENT 'Nested set lft.',
  `rgt` bigint NOT NULL DEFAULT 0 COMMENT 'Nested set rgt.',
  `home` short NOT NULL DEFAULT 0 COMMENT 'Indicates if this menu item is the home or default page.',
  `language` char(7) NOT NULL DEFAULT '',
  `client_id` short NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`),
  ...
  KEY `idx_path` (`path`),
  KEY `idx_language` (`language`)
) CHARSET utf8 COLLATE utf8_ko_cs AUTO_INCREMENT=102;
...
CREATE TABLE IF NOT EXISTS `#__messages` (
  ...
  `folder_id` short NOT NULL DEFAULT 0,
  `date_time` datetime NOT NULL DEFAULT '1970-01-01 00:00:00',
  `state` short NOT NULL DEFAULT 0,
  `priority` short NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `#__modules` (
  ...
  `access` integer NOT NULL DEFAULT 0,
  `showtitle` short NOT NULL DEFAULT 1,
  `params` varchar(65535) NOT NULL,
  `client_id` short NOT NULL DEFAULT 0,
  ...
  KEY `idx_language` (`language`)
) CHARSET utf8 COLLATE utf8_ko_cs AUTO_INCREMENT=87;
...
CREATE TABLE IF NOT EXISTS `#__postinstall_messages` (
  `postinstall_message_id` bigint NOT NULL AUTO_INCREMENT,
  ...
  `language_client_id` short NOT NULL DEFAULT '1',
  ...
  `enabled` short NOT NULL DEFAULT 1,
...
CREATE TABLE IF NOT EXISTS `#__session` (
  ...
  `client_id` short DEFAULT NULL,
  `guest` short DEFAULT 1,
...
CREATE TABLE IF NOT EXISTS `#__tags` (
  ...
  `alias` varchar(400) CHARSET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
  `note` varchar(255) NOT NULL DEFAULT '',
  `description` varchar(16777215) NOT NULL,
  `published` short NOT NULL DEFAULT 0,
  `checked_out` bigint NOT NULL DEFAULT 0,
  `checked_out_time` datetime NOT NULL DEFAULT '1970-01-01 00:00:00',
  `access` integer NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `#__template_styles` (
  ...
  KEY `idx_home` (`home`)
) CHARSET utf8 COLLATE utf8_ko_cs AUTO_INCREMENT=9;
...
CREATE TABLE IF NOT EXISTS `#__ucm_content` (
  `core_content_id` integer NOT NULL AUTO_INCREMENT,
  `core_type_alias` varchar(400) NOT NULL DEFAULT '' COMMENT 'FK to the content types table',
  `core_title` varchar(400) NOT NULL DEFAULT '',
  `core_alias` varchar(400) CHARSET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
  `core_body` varchar(16777215) NOT NULL DEFAULT '',
  `core_state` short NOT NULL DEFAULT 0,
  `core_checked_out_time` varchar(255) NOT NULL DEFAULT '1970-01-01 00:00:00',
  `core_checked_out_user_id` integer NOT NULL DEFAULT 0,
  `core_access` integer NOT NULL DEFAULT 0,
  `core_params` varchar(65535) NOT NULL DEFAULT '',
  `core_featured` short NOT NULL DEFAULT 0,
  `core_metadata` varchar(2048) NOT NULL DEFAULT '' COMMENT 'JSON encoded metadata properties.',
  `core_created_user_id` integer NOT NULL DEFAULT 0,
  `core_created_by_alias` varchar(255) NOT NULL DEFAULT '',
  `core_created_time` datetime NOT NULL DEFAULT '1970-01-01 00:00:00',
  `core_modified_user_id` integer NOT NULL DEFAULT 0 COMMENT 'Most recent user that modified',
  `core_modified_time` datetime NOT NULL DEFAULT '1970-01-01 00:00:00',
  `core_language` char(7) NOT NULL DEFAULT '',
  `core_publish_up` datetime NOT NULL DEFAULT '1970-01-01 00:00:00',
  `core_publish_down` datetime NOT NULL DEFAULT '1970-01-01 00:00:00',
  `core_content_item_id` integer NOT NULL DEFAULT 0 COMMENT 'ID from the individual type table',
  `asset_id` integer NOT NULL DEFAULT 0 COMMENT 'FK to the #__assets table.',
  `core_images` varchar(65535) NOT NULL DEFAULT '',
  `core_urls` varchar(65535) NOT NULL DEFAULT '',
  `core_hits` integer NOT NULL DEFAULT 0,
  `core_version` integer NOT NULL DEFAULT 1,
  `core_ordering` bigint NOT NULL DEFAULT 0,
  `core_metakey` varchar(65535) NOT NULL DEFAULT '',
  `core_metadesc` varchar(65535) NOT NULL DEFAULT '',
 ...
 ) CHARSET utf8 COLLATE utf8_ko_cs COMMENT='Contains core content data in name spaced fields';
...
CREATE TABLE IF NOT EXISTS `#__ucm_history` (
  ...
  `save_date` datetime NOT NULL DEFAULT '1970-01-01 00:00:00',
  `editor_user_id` integer NOT NULL DEFAULT 0,
  `character_count` integer NOT NULL DEFAULT 0 COMMENT 'Number of characters in this version.',
  `sha1_hash` varchar(50) NOT NULL DEFAULT '' COMMENT 'SHA1 hash of the version_data column.',
  `version_data` varchar(16777215) NOT NULL COMMENT 'json-encoded string of version data',
  `keep_forever` short NOT NULL DEFAULT 0 COMMENT '0=auto delete; 1=keep',
...
CREATE TABLE IF NOT EXISTS `#__updates` (
  ...
  `client_id` short DEFAULT 0,
  `version` varchar(32) DEFAULT '',
  `data` varchar(65535) NOT NULL,
  `detailsurl` varchar(65535) NOT NULL,
  `infourl` varchar(65535) NOT NULL,
  `extra_query` varchar(1000) DEFAULT '',
  PRIMARY KEY (`update_id`)
) CHARSET utf8 COLLATE utf8_ko_cs COMMENT='Available Updates';
...
CREATE TABLE IF NOT EXISTS `#__update_sites` (
  `update_site_id` bigint NOT NULL AUTO_INCREMENT,
  `name` varchar(100) DEFAULT '',
  `type` varchar(20) DEFAULT '',
...
) CHARSET utf8 COLLATE utf8_ko_cs COMMENT='Update Sites';
...
) CHARSET utf8 COLLATE utf8_ko_cs COMMENT='Links extensions to update sites';
...
CREATE TABLE IF NOT EXISTS `#__usergroups` (
  `id` integer NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `parent_id` integer NOT NULL DEFAULT 0 COMMENT 'Adjacency List Reference Id',
  `lft` bigint NOT NULL DEFAULT 0 COMMENT 'Nested set lft.',
  `rgt` bigint NOT NULL DEFAULT 0 COMMENT 'Nested set rgt.',
  `title` varchar(100) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `#__users` (
  ...
  `block` short NOT NULL DEFAULT 0,
  `sendEmail` short DEFAULT 0,
  ...
  `params` varchar(65535) NOT NULL,
  `lastResetTime` datetime NOT NULL DEFAULT '1970-01-01 00:00:00' COMMENT 'Date of last password reset',
  `resetCount` bigint NOT NULL DEFAULT 0 COMMENT 'Count of password resets since lastResetTime',
  `otpKey` varchar(1000) NOT NULL DEFAULT '' COMMENT 'Two factor authentication encrypted keys',
  `otep` varchar(1000) NOT NULL DEFAULT '' COMMENT 'One time emergency passwords',
  `requireReset` short NOT NULL DEFAULT 0 COMMENT 'Require user to reset password on next login',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `#__user_notes` (
  ...
  `modified_time` datetime NOT NULL DEFAULT '1970-01-01 00:00:00',
  `review_time` datetime NOT NULL DEFAULT '1970-01-01 00:00:00',
  `publish_up` datetime NOT NULL DEFAULT '1970-01-01 00:00:00',
  `publish_down` datetime NOT NULL DEFAULT '1970-01-01 00:00:00',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `#__user_profiles` (
  ...
  `profile_value` varchar(65535) NOT NULL,
  `ordering` bigint NOT NULL DEFAULT 0,
  UNIQUE KEY `idx_user_id_profile_key` (`user_id`,`profile_key`)
) CHARSET utf8 COLLATE utf8_ko_cs COMMENT='Simple user profile storage table';
...
CREATE TABLE IF NOT EXISTS `#__user_usergroup_map` (
  `user_id` integer NOT NULL DEFAULT 0 COMMENT 'Foreign Key to #__users.id',
  `group_id` integer NOT NULL DEFAULT 0 COMMENT 'Foreign Key to #__usergroups.id',
...
CREATE TABLE IF NOT EXISTS `#__utf8_conversion` (
  `converted` short NOT NULL DEFAULT 0
) CHARSET utf8 COLLATE utf8_ko_cs;
...
) CHARSET utf8 COLLATE utf8_ko_cs AUTO_INCREMENT=7;
