...
UNION ALL
SELECT 700, 'COM_CPANEL_MSG_NOTMYSQL_TITLE', 'COM_CPANEL_MSG_NOTMYSQL_BODY', '', 'com_cpanel', 1, 'message', '', '', 'admin://components/com_admin/postinstall/notmysql.php', 'admin_postinstall_notmysql_condition', '3.5.0', 1;
