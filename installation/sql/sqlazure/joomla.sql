...
/****** Object:  Default [DF__#__user___group__70A8B9AE]    Script Date: 11/08/2010 18:41:22 ******/
...
/****** Object:  Default [DF__#__user___order__6DCC4D03]    Script Date: 11/08/2010 18:41:22 ******/
IF Not EXISTS (SELECT * FROM sys.default_constraints WHERE object_id = OBJECT_ID(N'[DF__#__user___order__6DCC4D03]') AND parent_object_id = OBJECT_ID(N'[#__user_profiles]'))
Begin
IF NOT EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[DF__#__user___order__6DCC4D03]') AND type = 'D')
BEGIN
...
/****** Object:  Table [#__messages]    Script Date: 11/08/2010 18:41:22 ******/
...
SELECT 1,'','Menu_Item_Root','root','','','','',1,0,0,0,0,0,'1900-01-01 00:00:00',0,0,'',0,'',0,41,0,'*',0
UNION ALL
SELECT 2,'menu','com_banners','Banners','','Banners','index.php?option=com_banners','component',0,1,1,4,0,0,'1900-01-01 00:00:00',0,0,'class:banners',0,'',1,10,0,'*', 1
UNION ALL
SELECT 3,'menu','com_banners','Banners','','Banners/Banners','index.php?option=com_banners','component',0,2,2,4,0,0,'1900-01-01 00:00:00',0,0,'class:banners',0,'',2,3,0,'*', 1
UNION ALL
SELECT 4,'menu','com_banners_clients','Clients','','Banners/Clients','index.php?option=com_banners&view=clients','component',0,2,2,4,0,0,'1900-01-01 00:00:00',0,0,'class:banners-clients',0,'',4,5,0,'*', 1
UNION ALL
SELECT 5,'menu','com_banners_tracks','Tracks','','Banners/Tracks','index.php?option=com_banners&view=tracks','component',0,2,2,4,0,0,'1900-01-01 00:00:00',0,0,'class:banners-tracks',0,'',6,7,0,'*', 1
UNION ALL
SELECT 6,'menu','com_banners_categories','Categories','','Banners/Categories','index.php?option=com_categories&extension=com_banners','component',0,2,2,6,0,0,'1900-01-01 00:00:00',0,0,'class:banners-cat',0,'',8,9,0,'*', 1
UNION ALL
SELECT 7,'menu','com_contact','Contacts','','Contacts','index.php?option=com_contact','component',0,1,1,8,0,0,'1900-01-01 00:00:00',0,0,'class:contact',0,'',11,16,0,'*', 1
UNION ALL
SELECT 8,'menu','com_contact','Contacts','','Contacts/Contacts','index.php?option=com_contact','component',0,7,2,8,0,0,'1900-01-01 00:00:00',0,0,'class:contact',0,'',12,13,0,'*', 1
UNION ALL
SELECT 9,'menu','com_contact_categories','Categories','','Contacts/Categories','index.php?option=com_categories&extension=com_contact','component',0,7,2,6,0,0,'1900-01-01 00:00:00',0,0,'class:contact-cat',0,'',14,15,0,'*', 1
UNION ALL
SELECT 10,'menu','com_messages','Messaging','','Messaging','index.php?option=com_messages','component',0,1,1,15,0,0,'1900-01-01 00:00:00',0,0,'class:messages',0,'',17,22,0,'*', 1
UNION ALL
SELECT 11,'menu','com_messages_add','New Private Message','','Messaging/New Private Message','index.php?option=com_messages&task=message.add','component',0,10,2,15,0,0,'1900-01-01 00:00:00',0,0,'class:messages-add',0,'',18,19,0,'*', 1
UNION ALL
SELECT 12,'menu','com_messages_read','Read Private Message','','Messaging/Read Private Message','index.php?option=com_messages','component',0,10,2,15,0,0,'1900-01-01 00:00:00',0,0,'class:messages-read',0,'',20,21,0,'*', 1
UNION ALL
SELECT 13,'menu','com_newsfeeds','News Feeds','','News Feeds','index.php?option=com_newsfeeds','component',0,1,1,17,0,0,'1900-01-01 00:00:00',0,0,'class:newsfeeds',0,'',23,28,0,'*', 1
UNION ALL
SELECT 14,'menu','com_newsfeeds_feeds','Feeds','','News Feeds/Feeds','index.php?option=com_newsfeeds','component',0,13,2,17,0,0,'1900-01-01 00:00:00',0,0,'class:newsfeeds',0,'',24,25,0,'*', 1
UNION ALL
SELECT 15,'menu','com_newsfeeds_categories','Categories','','News Feeds/Categories','index.php?option=com_categories&extension=com_newsfeeds','component',0,13,2,6,0,0,'1900-01-01 00:00:00',0,0,'class:newsfeeds-cat',0,'',26,27,0,'*', 1
UNION ALL
SELECT 16,'menu','com_redirect','Redirect','','Redirect','index.php?option=com_redirect','component',0,1,1,24,0,0,'1900-01-01 00:00:00',0,0,'class:redirect',0,'',37,38,0,'*', 1
UNION ALL
SELECT 17,'menu','com_search','Search','','Search','index.php?option=com_search','component',0,1,1,19,0,0,'1900-01-01 00:00:00',0,0,'class:search',0,'',29,30,0,'*', 1
UNION ALL
SELECT 18,'menu','com_weblinks','Weblinks','','Weblinks','index.php?option=com_weblinks','component',0,1,1,21,0,0,'1900-01-01 00:00:00',0,0,'class:weblinks',0,'',31,36,0,'*', 1
UNION ALL
SELECT 19,'menu','com_weblinks_links','Links','','Weblinks/Links','index.php?option=com_weblinks','component',0,18,2,21,0,0,'1900-01-01 00:00:00',0,0,'class:weblinks',0,'',32,33,0,'*', 1
UNION ALL
SELECT 20,'menu','com_weblinks_categories','Categories','','Weblinks/Categories','index.php?option=com_categories&extension=com_weblinks','component',0,18,2,6,0,0,'1900-01-01 00:00:00',0,0,'class:weblinks-cat',0,'',34,35,0,'*', 1
UNION ALL
...
SELECT 1, 'en-GB', 'English (UK)', 'English (UK)', 'en', 'en', '', '', '', 1,1;
...
UNION ALL
SELECT 406, 'plg_content_loadmodule', 'plugin', 'loadmodule', 'content', 0, 1, 1, 0, '', '{"style":"none"}', '', '', 0, '1900-01-01 00:00:00', 3, 0
UNION ALL
...
UNION ALL
SELECT 502, 'bluestork', 'template', 'bluestork', '', 1, 1, 1, 0, 'a:11:{s:6:"legacy";b:0;s:4:"name";s:9:"bluestork";s:4:"type";s:8:"template";s:12:"creationDate";s:8:"07/02/09";s:6:"author";s:12:"Ron Severdia";s:9:"copyright";s:72:"Copyright (C) 2005 - 2010 Open Source Matters, Inc. All rights reserved.";s:11:"authorEmail";s:25:"contact@kontentdesign.com";s:9:"authorUrl";s:28:"http://www.kontentdesign.com";s:7:"version";s:5:"1.6.0";s:11:"description";s:29:"TPL_BLUESTORK_XML_DESCRIPTION";s:5:"group";s:0:"";}', '{"useRoundedCorners":"1","showSiteName":"0","textBig":"0","highContrast":"0"}', '', '', 0, '1900-01-01 00:00:00', 0, 0
UNION ALL
