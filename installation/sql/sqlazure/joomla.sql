...
UNION ALL
SELECT 110, 'menu', 'COM_FINDER_INDEXED_CONTENT', 'Indexed Content', '', 'Smart Search/Indexed Content', 'index.php?option=com_finder', 'component', 0, 18, 2, 27, 0, '1900-01-01 00:00:00', 0, 0, 'class:finder', 0, '', 43, 44, 0, '*', 1
UNION ALL
SELECT 111, 'menu', 'COM_FINDER_CONTENT_MAPS', 'Content Maps', '', 'Smart Search/Content Maps', 'index.php?option=com_finder&view=maps', 'component', 0, 18, 2, 27, 0, '1900-01-01 00:00:00', 0, 0, 'class:finder-maps', 0, '', 44, 45, 0, '*', 1
UNION ALL,
SELECT 112, 'menu', 'COM_FINDER_FILTERS', 'Filters', '', 'Smart Search/Filters', 'index.php?option=com_finder&view=filters', 'component', 0, 18, 2, 27, 0, '1900-01-01 00:00:00', 0, 0, 'class:finder-filters', 0, '', 46, 47, 0, '*', 1
