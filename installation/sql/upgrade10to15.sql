...
INSERT INTO `jos_mambots` VALUES (0, 'Joomla SEF URLs', 'sefurl', 'system', 0, 2, 1, 1, 0, 0, '0000-00-00 00:00:00', '');
...
#AE: 27-Mar-2006
ALTER TABLE `jos_menu` ADD COLUMN `control` TEXT NOT NULL DEFAULT '';
...
# 31-May-2006 Andrew Eddie

ALTER TABLE `jos_banner`
  MODIFY COLUMN `type` VARCHAR(30) NOT NULL DEFAULT 'banner',
  MODIFY COLUMN `name` VARCHAR(255) NOT NULL DEFAULT '';

ALTER TABLE `jos_bannerclient`
  MODIFY COLUMN `name` VARCHAR(255) NOT NULL DEFAULT '',
  MODIFY COLUMN `contact` VARCHAR(255) NOT NULL DEFAULT '',
  MODIFY COLUMN `email` VARCHAR(255) NOT NULL DEFAULT '';

# 02-Jun-2006 Andrew Eddie

ALTER TABLE `jos_menu` ADD COLUMN `home` INTEGER(1) UNSIGNED NOT NULL DEFAULT 0;

ALTER TABLE `jos_categories`
  MODIFY COLUMN `name` VARCHAR(255) NOT NULL DEFAULT '',
  MODIFY COLUMN `image` TEXT NOT NULL DEFAULT '',
  MODIFY COLUMN `title` VARCHAR(255) NOT NULL DEFAULT '',
  MODIFY COLUMN `image_position` VARCHAR(30) NOT NULL DEFAULT '';

ALTER TABLE `jos_content`
  MODIFY COLUMN `title` VARCHAR(255) NOT NULL DEFAULT '',
  MODIFY COLUMN `title_alias` VARCHAR(255) NOT NULL DEFAULT '',
  MODIFY COLUMN `created_by_alias` VARCHAR(255) NOT NULL DEFAULT '';

ALTER TABLE `jos_menu`
  MODIFY COLUMN `menutype` VARCHAR(75) NOT NULL DEFAULT '',
  MODIFY COLUMN `name` VARCHAR(75) NOT NULL DEFAULT '';
