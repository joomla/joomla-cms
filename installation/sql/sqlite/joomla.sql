...
UNION SELECT '2', '27', '1', '1', '2', '1', 'uncategorised', 'com_content', 'Uncategorised', 'uncategorised', '', '', '1', '0', '0000-00-00 00:00:00', '1', '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', '42', '2011-01-01 00:00:01', '0', '0000-00-00 00:00:00', '0', '*', '1'
UNION SELECT '3', '28', '1', '3', '4', '1', 'uncategorised', 'com_banners', 'Uncategorised', 'uncategorised', '', '', '1', '0', '0000-00-00 00:00:00', '1', '{"target":"","image":"","foobar":""}', '', '', '{"page_title":"","author":"","robots":""}', '42', '2011-01-01 00:00:01', '0', '0000-00-00 00:00:00', '0', '*', '1'
UNION SELECT '4', '29', '1', '5', '6', '1', 'uncategorised', 'com_contact', 'Uncategorised', 'uncategorised', '', '', '1', '0', '0000-00-00 00:00:00', '1', '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', '42', '2011-01-01 00:00:01', '0', '0000-00-00 00:00:00', '0', '*', '1'
UNION SELECT '5', '30', '1', '7', '8', '1', 'uncategorised', 'com_newsfeeds', 'Uncategorised', 'uncategorised', '', '', '1', '0', '0000-00-00 00:00:00', '1', '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', '42', '2011-01-01 00:00:01', '0', '0000-00-00 00:00:00', '0', '*', '1'
UNION SELECT '6', '31', '1', '9', '10', '1', 'uncategorised', 'com_weblinks', 'Uncategorised', 'uncategorised', '', '', '1', '0', '0000-00-00 00:00:00', '1', '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', '42', '2011-01-01 00:00:01', '0', '0000-00-00 00:00:00', '0', '*', '1'
UNION SELECT '7', '32', '1', '11', '12', '1', 'uncategorised', 'com_users', 'Uncategorised', 'uncategorised', '', '', '1', '0', '0000-00-00 00:00:00', '1', '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', '42', '2011-01-01 00:00:01', '0', '0000-00-00 00:00:00', '0', '*', '1'
;
-- Table data for table #__content_types

INSERT INTO #__content_types
      SELECT '1' AS type_id, 'Article' AS type_title, 'com_content.article' AS type_alias, '{"special":{"dbtable":"#__content","key":"id","type":"Content","prefix":"JTable","config":"array()"},"common":{"dbtable":"#__ucm_content","key":"ucm_id","type":"Corecontent","prefix":"JTable","config":"array()"}}' AS 'table', '' AS rules, '{"common":{"core_content_item_id":"id","core_title":"title","core_state":"state","core_alias":"alias","core_created_time":"created","core_modified_time":"modified","core_body":"introtext", "core_hits":"hits","core_publish_up":"publish_up","core_publish_down":"publish_down","core_access":"access", "core_params":"attribs", "core_featured":"featured", "core_metadata":"metadata", "core_language":"language", "core_images":"images", "core_urls":"urls", "core_version":"version", "core_ordering":"ordering", "core_metakey":"metakey", "core_metadesc":"metadesc", "core_catid":"catid", "core_xreference":"xreference", "asset_id":"asset_id"}, "special":{"fulltext":"fulltext"}}' AS field_mappings, 'ContentHelperRoute::getArticleRoute' AS router, '{"form_file":"administrator\/components\/com_content\/models\/forms\/article.xml",  "hide_fields":["asset_id","checked_out","checked_out_time","version"],  "display_lookup":[ {"source_column":"catid","target_table":"#__categories","target_column":"id","display_column":"title"},  {"source_column":"created_by","target_table":"#__users","target_column":"id","display_column":"name"}, {"source_column":"access","target_table":"#__viewlevels","target_column":"id","display_column":"title"}, {"source_column":"modified_by","target_table":"#__users","target_column":"id","display_column":"name"} ]}' AS content_history_options
...
UNION SELECT '13', 'Banner Client', 'com_banners.client', '{"special":{"dbtable":"#__banner_clients","key":"id","type":"Client","prefix":"BannersTable"}}', '', '', '', '{"form_file":"administrator\/components\/com_banners\/models\/forms\/client.xml", "hide_fields":["checked_out","checked_out_time"],"display_lookup":[]}'
UNION SELECT '14', 'User Notes', 'com_users.note', '{"special":{"dbtable":"#__user_notes","key":"id","type":"Note","prefix":"UsersTable"}}', '', '', '', '{"form_file":"administrator\/components\/com_users\/models\/forms\/note.xml", "hide_fields":["checked_out","checked_out_time", "publish_up", "publish_down"],"display_lookup":[  {"source_column":"catid","target_table":"#__categories","target_column":"id","display_column":"title"},    {"source_column":"created_user_id","target_table":"#__users","target_column":"id","display_column":"name"}, {"source_column":"user_id","target_table":"#__users","target_column":"id","display_column":"name"}, {"source_column":"modified_user_id","target_table":"#__users","target_column":"id","display_column":"name"}  ]}'
...
UNION SELECT '4', 'com_banners', 'component', 'com_banners', '', '1', '1', '1', '0', '', '{"purchase_type":"3","track_impressions":"0","track_clicks":"0","metakey_prefix":"","save_history":"1","history_limit":5}', '', '', '0', '0000-00-00 00:00:00', '0', '0'
...
UNION SELECT '450', 'plg_twofactorauth_yubikey', 'plugin', 'yubikey', 'twofactorauth', '0', '1', '1', '0', '', '', '', '', '0', '0000-00-00 00:00:00', '0', '0'
...
UNION SELECT '700', 'Joomla! CMS', 'file', 'joomla', '', '0', '1', '1', '1', '', '', '', '', '0', '0000-00-00 00:00:00', '0', '0'
;
...
UNION SELECT '22', 'menu', 'com_joomlaupdate', 'Joomla! Update', '', 'Joomla! Update', 'index.php?option=com_joomlaupdate', 'component', '1', '1', '1', '32', '0', '0000-00-00 00:00:00', '0', '0', 'class:joomlaupdate', '0', '', '41', '42', '0', '*', '1'
...
UNION SELECT '4', '700', 'PLG_USER_JOOMLA_POSTINSTALL_STRONGPW_TITLE', 'PLG_USER_JOOMLA_POSTINSTALL_STRONGPW_TEXT', 'PLG_USER_JOOMLA_POSTINSTALL_STRONGPW_BTN', 'plg_user_joomla', '1', 'action', 'site://plugins/user/joomla/postinstall/actions.php', 'plguserjoomla_postinstall_action', 'site://plugins/user/joomla/postinstall/actions.php', 'plguserjoomla_postinstall_condition', '3.2.0', '1'
;
