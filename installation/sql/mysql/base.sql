...
(1, '', 'Menu_Item_Root', 'root', '', '', '', '', 1, 0, 0, 0, 0, 0, '', 0, '', 0, 50, 0, '*', 0, NULL, NULL);
...
INSERT INTO `#__menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`, `publish_up`, `publish_down`)
SELECT 22, 'main', 'com_cookiemanager', 'Cookiemanager', '', 'Cookiemanager', 'index.php?option=com_cookiemanager', 'component', 1, 1, 1, `extension_id`, 0, 1, 'class:component', 0, '', 41, 46, 0, '*', 1, NULL, NULL FROM `#__extensions` WHERE `name` = 'com_cookiemanager';
INSERT INTO `#__menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`, `publish_up`, `publish_down`)
SELECT 23, 'main', 'com_cookiemanager_cookies', 'Cookies', '', 'Cookiemanager/Cookies', 'index.php?option=com_cookiemanager&view=cookies', 'component', 1, 22, 2, `extension_id`, 0, 1, 'class:component', 0, '', 42, 43, 0, '*', 1, NULL, NULL FROM `#__extensions` WHERE `name` = 'com_cookiemanager';
INSERT INTO `#__menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`, `publish_up`, `publish_down`)
SELECT 24, 'main', 'com_cookiemanager_categories', 'Categories', '', 'Cookiemanager/Categories', 'index.php?option=com_categories&view=categories&extension=com_cookiemanager', 'component', 1, 22, 2, `extension_id`, 0, 1, 'class:component', 0, '', 44, 45, 0, '*', 1, NULL, NULL FROM `#__extensions` WHERE `name` = 'com_categories';
INSERT INTO `#__menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`, `publish_up`, `publish_down`)
SELECT 25, 'main', 'com_cookiemanager_scripts', 'Scripts', '', 'Cookiemanager/Scripts', 'index.php?option=com_cookiemanager&view=scripts', 'component', 1, 22, 2, `extension_id`, 0, 1, 'class:component', 0, '', 46, 47, 0, '*', 1, NULL, NULL FROM `#__extensions` WHERE `name` = 'com_cookiemanager';
INSERT INTO `#__menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`, `publish_up`, `publish_down`)
SELECT 101, 'mainmenu', 'Home', 'home', '', 'home', 'index.php?option=com_content&view=featured', 'component', 1, 1, 1, `extension_id`, 0, 1, '', 0, '{"featured_categories":[""],"layout_type":"blog","blog_class_leading":"","blog_class":"","num_leading_articles":"1","num_intro_articles":"3","num_links":"0","link_intro_image":"","orderby_pri":"","orderby_sec":"front","order_date":"","show_pagination":"2","show_pagination_results":"1","show_title":"","link_titles":"","show_intro":"","info_block_position":"","info_block_show_title":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_associations":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_vote":"","show_readmore":"","show_readmore_title":"","show_hits":"","show_tags":"","show_noauth":"","show_feed_link":"1","feed_summary":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_image_css":"","menu_text":1,"menu_show":1,"page_title":"","show_page_heading":"1","page_heading":"","pageclass_sfx":"","menu-meta_description":"","robots":""}', 48, 49, 1, '*', 0, NULL, NULL FROM `#__extensions` WHERE `name` = 'com_content';
