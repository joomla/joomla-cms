...
INSERT INTO `#__menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`, `publish_up`, `publish_down`)
SELECT 219, 'main', 'com_cookiemanager', 'Cookiemanager', '', 'Cookiemanager', 'index.php?option=com_cookiemanager', 'component', 1, 1, 1, `extension_id`, 0, 1, 'class:component', 0, '', 91, 96, 0, '*', 1, NULL, NULL FROM `#__extensions` WHERE `name` = 'com_cookiemanager';
INSERT INTO `#__menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`, `publish_up`, `publish_down`)
SELECT 220, 'main', 'com_cookiemanager_cookies', 'Cookies', '', 'Cookiemanager/Cookies', 'index.php?option=com_cookiemanager&view=cookies', 'component', 1, 219, 2, `extension_id`, 0, 1, 'class:component', 0, '', 92, 93, 0, '*', 1, NULL, NULL FROM `#__extensions` WHERE `name` = 'com_cookiemanager';
INSERT INTO `#__menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`, `publish_up`, `publish_down`)
SELECT 221, 'main', 'com_cookiemanager_categories', 'Categories', '', 'Cookiemanager/Categories', 'index.php?option=com_categories&view=categories&extension=com_cookiemanager', 'component', 1, 219, 2, `extension_id`, 0, 1, 'class:component', 0, '', 94, 95, 0, '*', 1, NULL, NULL FROM `#__extensions` WHERE `name` = 'com_categories';
