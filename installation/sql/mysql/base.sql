...
(1, 0, 1, 194, 0, 'root.1', 'Root Asset', '{"core.login.site":{"6":1,"2":1},"core.login.admin":{"6":1},"core.login.api":{"8":1},"core.login.offline":{"6":1},"core.admin":{"8":1},"core.manage":{"7":1},"core.create":{"6":1,"3":1},"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"core.edit.own":{"6":1,"3":1}}'),
(2, 1, 2, 3, 1, 'com_admin', 'com_admin', '{}'),
(3, 1, 4, 7, 1, 'com_banners', 'com_banners', '{"core.admin":{"7":1},"core.manage":{"6":1}}'),
...
(7, 1, 14, 17, 1, 'com_contact', 'com_contact', '{"core.admin":{"7":1},"core.manage":{"6":1}}'),
(8, 1, 18, 41, 1, 'com_content', 'com_content', '{"core.admin":{"7":1},"core.manage":{"6":1},"core.create":{"3":1},"core.edit":{"4":1},"core.edit.state":{"5":1},"core.execute.transition":{"6":1,"5":1}}'),
(9, 1, 42, 43, 1, 'com_cpanel', 'com_cpanel', '{}'),
(10, 1, 44, 45, 1, 'com_installer', 'com_installer', '{"core.manage":{"7":0},"core.delete":{"7":0},"core.edit.state":{"7":0}}'),
(11, 1, 46, 49, 1, 'com_languages', 'com_languages', '{"core.admin":{"7":1}}'),
(12, 11, 47, 48, 2, 'com_languages.language.1', 'English (en-GB)', '{}'),
(13, 1, 50, 51, 1, 'com_login', 'com_login', '{}'),
(14, 1, 52, 53, 1, 'com_mails', 'com_mails', '{}'),
(15, 1, 54, 55, 1, 'com_media', 'com_media', '{"core.admin":{"7":1},"core.manage":{"6":1},"core.create":{"3":1},"core.delete":{"5":1}}'),
(16, 1, 56, 59, 1, 'com_menus', 'com_menus', '{"core.admin":{"7":1}}'),
(17, 1, 60, 61, 1, 'com_messages', 'com_messages', '{"core.admin":{"7":1},"core.manage":{"7":1}}'),
(18, 1, 62, 137, 1, 'com_modules', 'com_modules', '{"core.admin":{"7":1}}'),
(19, 1, 138, 141, 1, 'com_newsfeeds', 'com_newsfeeds', '{"core.admin":{"7":1},"core.manage":{"6":1}}'),
(20, 1, 142, 143, 1, 'com_plugins', 'com_plugins', '{"core.admin":{"7":1}}'),
(21, 1, 144, 145, 1, 'com_redirect', 'com_redirect', '{"core.admin":{"7":1}}'),
(23, 1, 146, 147, 1, 'com_templates', 'com_templates', '{"core.admin":{"7":1}}'),
(24, 1, 148, 151, 1, 'com_users', 'com_users', '{"core.admin":{"7":1}}'),
(26, 1, 152, 153, 1, 'com_wrapper', 'com_wrapper', '{}'),
(27, 8, 19, 20, 2, 'com_content.category.2', 'Uncategorised', '{}'),
(28, 3, 5, 6, 2, 'com_banners.category.3', 'Uncategorised', '{}'),
(29, 7, 15, 16, 2, 'com_contact.category.4', 'Uncategorised', '{}'),
(30, 19, 139, 140, 2, 'com_newsfeeds.category.5', 'Uncategorised', '{}'),
(32, 24, 149, 150, 2, 'com_users.category.7', 'Uncategorised', '{}'),
(33, 1, 154, 155, 1, 'com_finder', 'com_finder', '{"core.admin":{"7":1},"core.manage":{"6":1}}'),
(34, 1, 156, 157, 1, 'com_joomlaupdate', 'com_joomlaupdate', '{}'),
(35, 1, 158, 159, 1, 'com_tags', 'com_tags', '{}'),
(36, 1, 160, 161, 1, 'com_contenthistory', 'com_contenthistory', '{}'),
(37, 1, 162, 163, 1, 'com_ajax', 'com_ajax', '{}'),
(38, 1, 164, 165, 1, 'com_postinstall', 'com_postinstall', '{}'),
(39, 18, 63, 64, 2, 'com_modules.module.1', 'Main Menu', '{}'),
(40, 18, 65, 66, 2, 'com_modules.module.2', 'Login', '{}'),
(41, 18, 67, 68, 2, 'com_modules.module.3', 'Popular Articles', '{}'),
(42, 18, 69, 70, 2, 'com_modules.module.4', 'Recently Added Articles', '{}'),
(43, 18, 71, 72, 2, 'com_modules.module.8', 'Toolbar', '{}'),
(44, 18, 73, 74, 2, 'com_modules.module.9', 'Notifications', '{}'),
(45, 18, 75, 76, 2, 'com_modules.module.10', 'Logged-in Users', '{}'),
(46, 18, 77, 78, 2, 'com_modules.module.12', 'Admin Menu', '{}'),
(49, 18, 83, 84, 2, 'com_modules.module.15', 'Title', '{}'),
(50, 18, 85, 86, 2, 'com_modules.module.16', 'Login Form', '{}'),
(51, 18, 87, 88, 2, 'com_modules.module.17', 'Breadcrumbs', '{}'),
(52, 18, 89, 90, 2, 'com_modules.module.79', 'Multilanguage status', '{}'),
(53, 18, 93, 94, 2, 'com_modules.module.86', 'Joomla Version', '{}'),
(54, 16, 57, 58, 2, 'com_menus.menu.1', 'Main Menu', '{}'),
(55, 18, 97, 98, 2, 'com_modules.module.87', 'Sample Data', '{}'),
(56, 8, 21, 40, 2, 'com_content.workflow.1', 'COM_WORKFLOW_BASIC_WORKFLOW', '{}'),
(57, 56, 22, 23, 3, 'com_content.stage.1', 'COM_WORKFLOW_BASIC_STAGE', '{}'),
(58, 56, 24, 25, 3, 'com_content.transition.1', 'Unpublish', '{}'),
(59, 56, 26, 27, 3, 'com_content.transition.2', 'Publish', '{}'),
(60, 56, 28, 29, 3, 'com_content.transition.3', 'Trash', '{}'),
(61, 56, 30, 31, 3, 'com_content.transition.4', 'Archive', '{}'),
(62, 56, 32, 33, 3, 'com_content.transition.5', 'Feature', '{}'),
(63, 56, 34, 35, 3, 'com_content.transition.6', 'Unfeature', '{}'),
(64, 56, 36, 37, 3, 'com_content.transition.7', 'Publish & Feature', '{}'),
(65, 1, 166, 167, 1, 'com_privacy', 'com_privacy', '{}'),
(66, 1, 168, 169, 1, 'com_actionlogs', 'com_actionlogs', '{}'),
(67, 18, 79, 80, 2, 'com_modules.module.88', 'Latest Actions', '{}'),
(68, 18, 81, 82, 2, 'com_modules.module.89', 'Privacy Dashboard', '{}'),
(70, 18, 91, 92, 2, 'com_modules.module.103', 'Site', '{}'),
(71, 18, 95, 96, 2, 'com_modules.module.104', 'System', '{}'),
(72, 18, 99, 100, 2, 'com_modules.module.91', 'System Dashboard', '{}'),
(73, 18, 101, 102, 2, 'com_modules.module.92', 'Content Dashboard', '{}'),
(74, 18, 103, 104, 2, 'com_modules.module.93', 'Menus Dashboard', '{}'),
(75, 18, 105, 106, 2, 'com_modules.module.94', 'Components Dashboard', '{}'),
(76, 18, 107, 108, 2, 'com_modules.module.95', 'Users Dashboard', '{}'),
(77, 18, 109, 110, 2, 'com_modules.module.99', 'Frontend Link', '{}'),
(78, 18, 111, 112, 2, 'com_modules.module.100', 'Messages', '{}'),
(79, 18, 113, 114, 2, 'com_modules.module.101', 'Post Install Messages', '{}'),
(80, 18, 115, 116, 2, 'com_modules.module.102', 'User Status', '{}'),
(82, 18, 117, 118, 2, 'com_modules.module.105', '3rd Party', '{}'),
(83, 18, 119, 120, 2, 'com_modules.module.106', 'Help Dashboard', '{}'),
(84, 18, 121, 122, 2, 'com_modules.module.107', 'Privacy Requests', '{}'),
(85, 18, 123, 124, 2, 'com_modules.module.108', 'Privacy Status', '{}'),
(86, 18, 125, 126, 2, 'com_modules.module.96', 'Popular Articles', '{}'),
(87, 18, 127, 128, 2, 'com_modules.module.97', 'Recently Added Articles', '{}'),
(88, 18, 129, 130, 2, 'com_modules.module.98', 'Logged-in Users', '{}'),
(89, 18, 131, 132, 2, 'com_modules.module.90', 'Login Support', '{}'),
(90, 1, 170, 171, 1, 'com_scheduler', 'com_scheduler', '{}'),
(91, 1, 172, 173, 1, 'com_associations', 'com_associations', '{}'),
(92, 1, 174, 175, 1, 'com_categories', 'com_categories', '{}'),
(93, 1, 176, 177, 1, 'com_fields', 'com_fields', '{}'),
(94, 1, 178, 179, 1, 'com_workflow', 'com_workflow', '{}'),
(95, 1, 180, 181, 1, 'com_guidedtours', 'com_guidedtours', '{}'),
(96, 18, 133, 135, 2, 'com_modules.module.109', 'Guided Tours', '{}'),
(97, 18, 136, 137, 2, 'com_modules.module.110', 'Joomla! Community and News', '{}');
...
(110, 97, 'Joomla! Community and News', '', '', 1, 'cpanel', NULL, NULL, 1, 'mod_community_info', 1, 1, '{"endpoint":"https://djumla.dev/joomla-community-api/links.php","fallback-location":"en-UK","location":"","location_name":"","auto_location":"1","layout":"_:default","moduleclass_sfx":"","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 1, '*');
