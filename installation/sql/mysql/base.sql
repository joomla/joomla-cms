...
INSERT INTO `#__menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`, `publish_up`, `publish_down`)
SELECT 23, 'main', 'com_cookiemanager_cookies', 'Cookies', '', 'Cookiemanager/Cookies', 'index.php?option=com_cookiemanager&view=cookies', 'component', 1, 22, 2, `extension_id`, 0, 1, 'class:cookies', 0, '', 42, 43, 0, '*', 1, NULL, NULL FROM `#__extensions` WHERE `name` = 'com_cookiemanager';
INSERT INTO `#__menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`, `publish_up`, `publish_down`)
