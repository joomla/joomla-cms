...
(2, 1, 1, 2, 1, 'com_workflow', 'com_workflow', '{}'),
(3, 1, 3, 4, 1, 'com_mails', 'com_mails', '{}'),
(4, 1, 5, 6, 1, 'com_fields', 'com_fields', '{}'),
(5, 1, 7, 8, 1, 'com_categories', 'com_categories', '{}'),
(6, 1, 9, 10, 1, 'com_associations', 'com_associations', '{}'),
(7, 1, 11, 12, 1, 'com_admin', 'com_admin', '{}'),
(8, 1, 13, 16, 1, 'com_banners', 'com_banners', '{"core.admin":{"7":1},"core.manage":{"6":1}}'),
(9, 8, 14, 15, 2, 'com_banners.category.3', 'Uncategorised', '{}'),
(10, 1, 17, 18, 1, 'com_cache', 'com_cache', '{"core.admin":{"7":1},"core.manage":{"7":1}}'),
(11, 1, 19, 20, 1, 'com_checkin', 'com_checkin', '{"core.admin":{"7":1},"core.manage":{"7":1}}'),
(12, 1, 21, 22, 1, 'com_config', 'com_config', '{}'),
(13, 1, 23, 26, 1, 'com_contact', 'com_contact', '{"core.admin":{"7":1},"core.manage":{"6":1}}'),
(14, 13, 24, 25, 2, 'com_contact.category.4', 'Uncategorised', '{}'),
(15, 1, 27, 48, 1, 'com_content', 'com_content', '{"core.admin":{"7":1},"core.manage":{"6":1},"core.create":{"3":1},"core.edit":{"4":1},"core.edit.state":{"5":1},"core.execute.transition":{"6":1,"5":1}}'),
(16, 15, 28, 29, 2, 'com_content.category.2', 'Uncategorised', '{}'),
(17, 15, 30, 47, 2, 'com_content.workflow.1', 'COM_WORKFLOW_BASIC_WORKFLOW', '{}'),
(18, 17, 31, 32, 3, 'com_content.state.1', 'COM_WORKFLOW_BASIC_STAGE', '{}'),
(19, 17, 33, 34, 3, 'com_content.transition.1', 'Publish', '{}'),
(20, 17, 35, 36, 3, 'com_content.transition.2', 'Unpublish', '{}'),
(21, 17, 37, 38, 3, 'com_content.transition.3', 'Archive', '{}'),
(22, 17, 39, 40, 3, 'com_content.transition.4', 'Trash', '{}'),
(23, 17, 41, 42, 3, 'com_content.transition.5', 'Feature', '{}'),
(24, 17, 43, 44, 3, 'com_content.transition.6', 'Unfeature', '{}'),
(25, 17, 45, 46, 3, 'com_content.transition.7', 'Publish & Feature', '{}'),
(26, 1, 49, 50, 1, 'com_cpanel', 'com_cpanel', '{}'),
(27, 1, 51, 52, 1, 'com_installer', 'com_installer', '{"core.manage":{"7":0},"core.delete":{"7":0},"core.edit.state":{"7":0}}'),
(28, 1, 53, 56, 1, 'com_languages', 'com_languages', '{"core.admin":{"7":1}}'),
(29, 28, 54, 55, 2, 'com_languages.language.1', 'English (en-GB)', '{}'),
(30, 1, 57, 58, 1, 'com_login', 'com_login', '{}'),
(31, 1, 59, 60, 1, 'com_media', 'com_media', '{"core.admin":{"7":1},"core.manage":{"6":1},"core.create":{"3":1},"core.delete":{"5":1}}'),
(32, 1, 61, 64, 1, 'com_menus', 'com_menus', '{"core.admin":{"7":1}}'),
(33, 32, 62, 63, 2, 'com_menus.menu.1', 'Main Menu', '{}'),
(34, 1, 65, 66, 1, 'com_messages', 'com_messages', '{"core.admin":{"7":1},"core.manage":{"7":1}}'),
(35, 1, 67, 138, 1, 'com_modules', 'com_modules', '{"core.admin":{"7":1}}'),
(36, 35, 68, 69, 2, 'com_modules.module.108', 'Privacy Status', '{}'),
(37, 35, 70, 71, 2, 'com_modules.module.107', 'Privacy Requests', '{}'),
(38, 35, 72, 73, 2, 'com_modules.module.98', 'Logged-in Users', '{}'),
(39, 35, 74, 75, 2, 'com_modules.module.97', 'Recently Added Articles', '{}'),
(40, 35, 76, 77, 2, 'com_modules.module.96', 'Popular Articles', '{}'),
(41, 35, 78, 79, 2, 'com_modules.module.90', 'Login Support', '{}'),
(42, 35, 80, 81, 2, 'com_modules.module.1', 'Main Menu', '{}'),
(43, 35, 82, 83, 2, 'com_modules.module.2', 'Login', '{}'),
(44, 35, 84, 85, 2, 'com_modules.module.3', 'Popular Articles', '{}'),
(45, 35, 86, 87, 2, 'com_modules.module.4', 'Recently Added Articles', '{}'),
(46, 35, 88, 89, 2, 'com_modules.module.8', 'Toolbar', '{}'),
(47, 35, 90, 91, 2, 'com_modules.module.9', 'Update Checks', '{}'),
(48, 35, 92, 93, 2, 'com_modules.module.10', 'Logged-in Users', '{}'),
(49, 35, 94, 95, 2, 'com_modules.module.88', 'Latest Actions', '{}'),
(50, 35, 96, 97, 2, 'com_modules.module.12', 'Admin Menu', '{}'),
(51, 35, 98, 99, 2, 'com_modules.module.89', 'Privacy Dashboard', '{}'),
(52, 35, 100, 101, 2, 'com_modules.module.15', 'Title', '{}'),
(53, 35, 102, 103, 2, 'com_modules.module.16', 'Login Form', '{}'),
(54, 35, 104, 105, 2, 'com_modules.module.17', 'Breadcrumbs', '{}'),
(55, 35, 106, 107, 2, 'com_modules.module.79', 'Multilanguage status', '{}'),
(56, 35, 108, 109, 2, 'com_modules.module.86', 'Joomla Version', '{}'),
(57, 35, 110, 111, 2, 'com_modules.module.103', 'Site', '{}'),
(58, 35, 112, 113, 2, 'com_modules.module.87', 'Sample Data', '{}'),
(59, 35, 114, 115, 2, 'com_modules.module.104', 'System', '{}'),
(60, 35, 116, 117, 2, 'com_modules.module.91', 'System Dashboard', '{}'),
(61, 35, 118, 119, 2, 'com_modules.module.92', 'Content Dashboard', '{}'),
(62, 35, 120, 121, 2, 'com_modules.module.93', 'Menus Dashboard', '{}'),
(63, 35, 122, 123, 2, 'com_modules.module.94', 'Components Dashboard', '{}'),
(64, 35, 124, 125, 2, 'com_modules.module.95', 'Users Dashboard', '{}'),
(65, 35, 126, 127, 2, 'com_modules.module.99', 'Frontend Link', '{}'),
(66, 35, 128, 129, 2, 'com_modules.module.100', 'Messages', '{}'),
(67, 35, 130, 131, 2, 'com_modules.module.101', 'Post Install Messages', '{}'),
(68, 35, 132, 133, 2, 'com_modules.module.102', 'User Status', '{}'),
(69, 35, 134, 135, 2, 'com_modules.module.105', '3rd Party', '{}'),
(70, 35, 136, 137, 2, 'com_modules.module.106', 'Help Dashboard', '{}'),
(71, 1, 139, 142, 1, 'com_newsfeeds', 'com_newsfeeds', '{"core.admin":{"7":1},"core.manage":{"6":1}}'),
(72, 71, 140, 141, 2, 'com_newsfeeds.category.5', 'Uncategorised', '{}'),
(73, 1, 143, 144, 1, 'com_plugins', 'com_plugins', '{"core.admin":{"7":1}}'),
(74, 1, 145, 146, 1, 'com_redirect', 'com_redirect', '{"core.admin":{"7":1}}'),
(75, 1, 147, 148, 1, 'com_privacy', 'com_privacy', '{}'),
(76, 1, 149, 150, 1, 'com_templates', 'com_templates', '{"core.admin":{"7":1}}'),
(77, 1, 151, 152, 1, 'com_actionlogs', 'com_actionlogs', '{}'),
(78, 1, 153, 156, 1, 'com_users', 'com_users', '{"core.admin":{"7":1}}'),
(79, 78, 154, 155, 2, 'com_users.category.7', 'Uncategorised', '{}'),
(80, 1, 157, 158, 1, 'com_wrapper', 'com_wrapper', '{}'),
(81, 1, 159, 160, 1, 'com_finder', 'com_finder', '{"core.admin":{"7":1},"core.manage":{"6":1}}'),
(82, 1, 161, 162, 1, 'com_joomlaupdate', 'com_joomlaupdate', '{}'),
(83, 1, 163, 164, 1, 'com_tags', 'com_tags', '{}'),
(84, 1, 165, 166, 1, 'com_contenthistory', 'com_contenthistory', '{}'),
(85, 1, 167, 168, 1, 'com_ajax', 'com_ajax', '{}'),
(86, 1, 169, 170, 1, 'com_postinstall', 'com_postinstall', '{}'),
(87, 1, 171, 172, 1, 'com_csp', 'com_csp', '{}');
...
(9, 44, 'Update Checks', '', '', 3, 'icon', NULL, NULL, 1, 'mod_quickicon', 3, 1, '{"context":"update_quickicon","header_icon":"icon-sync","show_jupdate":"1","show_eupdate":"1","show_oupdate":"1","show_privacy":"1","layout":"_:default","moduleclass_sfx":"","cache":1,"cache_time":900,"style":"0","module_tag":"div","bootstrap_size":"12","header_tag":"h3","header_class":""}', 1, '*'),
