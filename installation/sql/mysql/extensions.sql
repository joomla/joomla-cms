...
(1, 1, 'Click here!', 1, '<p>This Tour will show you that how you can create a new Guided Tour in Joomla! Backend</p>', 0, 1, 'bottom', '.button-new','administrator/index.php?option=com_guidedtours' ,'', 430, '', 430),
...
(5, 1, 'URL', 1, '<p>Add URL of the page from where you want to start your Tour. </p>', 0, 1, 'bottom', '#jform_url', ' administrator/index.php?option=com_guidedtours&view=tour&layout=edit','', 430, '', 430),
...
(7, 1, 'save and close', 1, '', 0, 1, 'bottom', '#save-group-children-save',' administrator/index.php?option=com_guidedtours&view=tour&layout=edit' ,'', 430, '', 430),
(8, 1, 'Create steps for your Tour', 1, '<p>Click on steps icon in the right</p>', 0, 1, 'right', '.btn-info ','administrator/index.php?option=com_guidedtours' ,'', 430, '', 430),
(9, 1, 'Click here!', 1, '<p>Click here to create a new Step for your Tour</p>', 0, 1, 'bottom', '.button-new', 'administrator/index.php?option=com_guidedtours&view=steps','', 430, '', 430),
...
(12, 1, 'Position ', 1, '<p>here add the position of the Step you want. e.g. right, left, top, bottom.</p>', 0, 1, 'bottom', '#jform_position','administrator/index.php?option=com_guidedtours&view=step&layout=edit' ,'', 430, '', 430),
...
(14, 1, 'Multi-page', 1, '<p>Select this if the next step is on different page</p>', 0, 1, 'bottom', '#jform_multipage1','administrator/index.php?option=com_guidedtours&view=step&layout=edit' ,'', 430, '', 430),
...
(16, 1, 'Congratulations!!!', 1, '<p>You successfully created your first Guided Tour!</p>', 0, 1, 'bottom', '.hero-example', 'administrator/index.php?option=com_guidedtours','', 430, '', 430);