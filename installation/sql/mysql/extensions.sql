...
INSERT INTO `#__guidedtour_steps` (`id`, `tour_id`, `title`, `published`, `description`, `ordering`, `step-no`, `position`, `target`, `type`, `validation`, `url`, `created`, `created_by`, `modified`, `modified_by`) VALUES
...
(80, 8, 'Click here!', 1, '<p>This Tour will show you how you can create News Feeds in Joomla!</p>', 0, 1, 'bottom', '.button-new','administrator/index.php?option=com_newsfeeds&view=newsfeeds', CURRENT_TIMESTAMP(), 0, CURRENT_TIMESTAMP(), 0),
(81, 8, 'Add title for your News Feeds', 1, '<p>Here you have to add the title of your News Feeds.</p>', 0, 1, 'bottom', '#jform_title', 'administrator/index.php?option=com_newsfeeds&view=newsfeed&layout=edit', CURRENT_TIMESTAMP(), 0, CURRENT_TIMESTAMP(), 0),
(82, 8, 'Alias', 1, '<p>You can write the internal name of this news feed. You can leave this blank and Joomla will fill a default value in lower case with dashes instead of spaces.</p>', 0, 1, 'bottom', '#jform_alias','administrator/index.php?option=com_newsfeeds&view=newsfeed&layout=edit', CURRENT_TIMESTAMP(), 0, CURRENT_TIMESTAMP(), 0),
(83, 8, 'Add Link', 1, '<p>Add the Link of this News Feeds here!</p>', 0, 1, 'bottom', '#jform_link', 'administrator/index.php?option=com_newsfeeds&view=newsfeed&layout=edit', CURRENT_TIMESTAMP(), 0, CURRENT_TIMESTAMP(), 0),
(84, 8, 'Add Content', 1, '<p>Add the content of your News Feeds here!</p>', 0, 1, 'bottom', '#details', 'administrator/index.php?option=com_newsfeeds&view=newsfeed&layout=edit', CURRENT_TIMESTAMP(), 0, CURRENT_TIMESTAMP(), 0),
(85, 8, 'Status', 1, '<p>Here you can select Status for your news feeds.</p>', 0, 1, 'bottom', '#jform_state','administrator/index.php?option=com_newsfeeds&view=newsfeed&layout=edit', CURRENT_TIMESTAMP(), 0, CURRENT_TIMESTAMP(), 0),
(86, 8, 'Category', 1, '<p>Select the Category for this news feeds.</p>', 0, 1, 'bottom', '.choices__inner', 'administrator/index.php?option=com_newsfeeds&view=newsfeed&layout=edit', CURRENT_TIMESTAMP(), 0, CURRENT_TIMESTAMP(), 0),
(87, 8, 'Access Level', 1, '<p>Here you can select Access level from Public, Guest, Registered, Special and Super Users.</p>', 0, 1, 'bottom', '#jform_access','administrator/index.php?option=com_newsfeeds&view=newsfeed&layout=edit', CURRENT_TIMESTAMP(), 0, CURRENT_TIMESTAMP(), 0),
(88, 8, 'Tags', 1, '<p>Select Tags for your news feeds. You can also enter a new tag by typing the name in the field and pressing enter.</p>', 0, 1, 'bottom', '.choices__input choices__input--cloned', 'administrator/index.php?option=com_newsfeeds&view=newsfeed&layout=edit', CURRENT_TIMESTAMP(), 0, CURRENT_TIMESTAMP(), 0),
(89, 8, 'Version Note', 1, '<p>This is an optional field to identify the version of this news feeds.</p>', 0, 1, 'bottom', '#jform_version_note', 'administrator/index.php?option=com_newsfeeds&view=newsfeed&layout=edit','', CURRENT_TIMESTAMP(), 0, CURRENT_TIMESTAMP(), 0),
(90, 8, 'Save and Close ', 1, '<p>Save and close the News Feeds.</p>', 0, 1, 'bottom', '#save-group-children-save','administrator/index.php?option=com_newsfeeds&view=newsfeed&layout=edit', CURRENT_TIMESTAMP(), 0, CURRENT_TIMESTAMP(), 0),
(91, 8, 'Congratulations!!!', 1, '<p>You successfully created your News Feeds in Joomla!</p>', 0, 1, 'bottom', '', 'administrator/index.php?option=com_newsfeeds&view=newsfeed&layout=edit','', CURRENT_TIMESTAMP(), 0, CURRENT_TIMESTAMP(), 0),

(92, 9, 'Click here!', 1, '<p>This Tour will show you how you can create Smart Search in Joomla!</p>', 0, 1, 'bottom', '.button-new','administrator/index.php?option=com_finder&view=filters', CURRENT_TIMESTAMP(), 0, CURRENT_TIMESTAMP(), 0),
(93, 9, 'Add title for your Smart Search', 1, '<p>Here you have to add the title of your Smart Search.</p>', 0, 1, 'bottom', '#jform_title', 'administrator/index.php?option=com_finder&view=filter&layout=edit', CURRENT_TIMESTAMP(), 0, CURRENT_TIMESTAMP(), 0),
(94, 9, 'Alias', 1, '<p>You can write the internal name of this smart search. You can leave this blank and Joomla will fill a default value in lower case with dashes instead of spaces.</p>', 0, 1, 'bottom', '#jform_alias','administrator/index.php?option=com_finder&view=filter&layout=edit', CURRENT_TIMESTAMP(), 0, CURRENT_TIMESTAMP(), 0),
(95, 9, 'Add Content', 1, '<p>Add the content of your Smart Search here!</p>', 0, 1, 'bottom', '#details', 'administrator/index.php?option=com_finder&view=filter&layout=edit', CURRENT_TIMESTAMP(), 0, CURRENT_TIMESTAMP(), 0),
(96, 9, 'Status', 1, '<p>Here you can select Status for your smart search.</p>', 0, 1, 'bottom', '#jform_state','administrator/index.php?option=com_finder&view=filter&layout=edit', CURRENT_TIMESTAMP(), 0, CURRENT_TIMESTAMP(), 0),
(97, 9, 'Save and Close ', 1, '<p>Save and close the Smart Search.</p>', 0, 1, 'bottom', '#save-group-children-save','administrator/index.php?option=com_finder&view=filter&layout=edit', CURRENT_TIMESTAMP(), 0, CURRENT_TIMESTAMP(), 0),
(98, 9, 'Congratulations!!!', 1, '<p>You successfully created your Smart Search in Joomla!</p>', 0, 1, 'bottom', '', 'administrator/index.php?option=com_finder&view=filter&layout=edit','', CURRENT_TIMESTAMP(), 0, CURRENT_TIMESTAMP(), 0),

(99, 10, 'Click here!', 1, '<p>This will show you how you can create Users in Joomla!</p>', 0, 1, 'bottom', '.button-new','administrator/index.php?option=com_users&view=user&layout=edit', CURRENT_TIMESTAMP(), 0, CURRENT_TIMESTAMP(), 0),
(100, 10, 'Add Name of the User', 1, '<p>Here you have to add the name of the User.</p>', 0, 1, 'bottom', '#jform_name', 'administrator/index.php?option=com_users&view=user&layout=edit', CURRENT_TIMESTAMP(), 0, CURRENT_TIMESTAMP(), 0),
(101, 10, 'Add Login Name', 1, '<p>Enter the login name (Username) for the user.</p>', 0, 1, 'bottom', '#jform_username','administrator/index.php?option=com_users&view=user&layout=edit', CURRENT_TIMESTAMP(), 0, CURRENT_TIMESTAMP(), 0),
(102, 10, 'Password', 1, '<p>Fill in a (new) password. Although this field is not required, the user will not be able to log in when no password is set.</p>', 0, 1, 'bottom', '#jform_password', 'administrator/index.php?option=com_users&view=user&layout=edit', CURRENT_TIMESTAMP(), 0, CURRENT_TIMESTAMP(), 0),
(103, 10, 'Confirm Password', 1, '<p>Fill in the password from the field above again, to verify it. This field is required when you filled in the New password field.</p>', 0, 1, 'bottom', '#jform_password2','administrator/index.php?option=com_users&view=user&layout=edit', CURRENT_TIMESTAMP(), 0, CURRENT_TIMESTAMP(), 0),
(104, 10, 'Email', 1, '<p>Enter an email address for the user.</p>', 0, 1, 'bottom', '#jform_email', 'administrator/index.php?option=com_users&view=user&layout=edit', CURRENT_TIMESTAMP(), 0, CURRENT_TIMESTAMP(), 0),
(105, 10, 'Receive System Emails', 1, '<p>Set to yes, if you want to receive system emails.</p>', 0, 1, 'bottom', '#jform_sendEmail','administrator/index.php?option=com_users&view=user&layout=edit', CURRENT_TIMESTAMP(), 0, CURRENT_TIMESTAMP(), 0),
(106, 10, 'User Status', 1, '<p>Enable or block this user.</p>', 0, 1, 'bottom', '#jform_block0', 'administrator/index.php?option=com_users&view=user&layout=edit', CURRENT_TIMESTAMP(), 0, CURRENT_TIMESTAMP(), 0),
(107, 10, 'Require Password Reset', 1, '<p>If set to yes, the user will have to reset their password the next time they log into the site.</p>', 0, 1, 'bottom', '#jform_requireReset0','administrator/index.php?option=com_users&view=user&layout=edit', CURRENT_TIMESTAMP(), 0, CURRENT_TIMESTAMP(), 0),
(108, 10, 'Save and Close ', 1, '<p>Save and close the User.</p>', 0, 1, 'bottom', '#save-group-children-save','administrator/index.php?option=com_users&view=user&layout=edit', CURRENT_TIMESTAMP(), 0, CURRENT_TIMESTAMP(), 0),
(109, 10, 'Congratulations!!!', 1, '<p>You successfully created your User in Joomla!</p>', 0, 1, 'bottom', '', 'administrator/index.php?option=com_users&view=user&layout=edit','', CURRENT_TIMESTAMP(), 0, CURRENT_TIMESTAMP(), 0);