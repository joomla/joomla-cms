...
CREATE TABLE IF NOT EXISTS `#__menu` (
  ...
  KEY `idx_path` (`path`(100)),
  KEY `idx_language` (`language`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 DEFAULT COLLATE=utf8mb4_unicode_ci AUTO_INCREMENT=113;
...
(110, 'menu', 'COM_FINDER_INDEXED_CONTENT', 'Indexed Content', '', 'Smart Search/Indexed Content', 'index.php?option=com_finder', 'component', 0, 18, 2, 27, 0, '0000-00-00 00:00:00', 0, 0, 'class:finder', 0, '', 43, 44, 0, '*', 1),
(111, 'menu', 'COM_FINDER_CONTENT_MAPS', 'Content Maps', '', 'Smart Search/Content Maps', 'index.php?option=com_finder&view=maps', 'component', 0, 18, 2, 27, 0, '0000-00-00 00:00:00', 0, 0, 'class:finder-maps', 0, '', 44, 45, 0, '*', 1),
(112, 'menu', 'COM_FINDER_FILTERS', 'Filters', '', 'Smart Search/Filters', 'index.php?option=com_finder&view=filters', 'component', 0, 18, 2, 27, 0, '0000-00-00 00:00:00', 0, 0, 'class:finder-filters', 0, '', 46, 47, 0, '*', 1);
