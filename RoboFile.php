...
class RoboFile extends \Robo\Tasks
{
	...
	public function createTestingSite($useHtaccess = false)
	{
		...
		$exclude = ['tests', 'tests-phpunit', '.run', '.github', '.git', 'test-install', 'libraries/vendor/codeception', 'libraries/vendor/behat', 'libraries/vendor/joomla-projects', 'libraries/vendor/consolidation/'];
