...
<form action="<?php echo $this->action; ?>" method="post" name="adminForm" id="adminForm">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      <td colspan="5"><table>
          <tr>
            ...
            <td align="left" width="60%" class="nowrap"><?php echo JText::_($this->params->get('filter_type') . ' Filter').'&#160;'; ?>
            ...
            <td align="right" width="40%" class="nowrap"><?php
    ...
    <tr>
      ...
      <td class="sectiontableheader<?php echo $this->escape($this->params->get('pageclass_sfx')); ?>" width="45%"><?php echo JHTML::_('grid.sort',  'ITEM_TITLE', 'a.title', $this->lists['order_Dir'], $this->lists['order'] ); ?> </td>
      <?php endif; ?>
      <?php if ($this->params->get('show_date')) : ?>
      <td class="sectiontableheader<?php echo $this->escape($this->params->get('pageclass_sfx')); ?>" width="25%"><?php echo JHTML::_('grid.sort',  'Date', 'a.created', $this->lists['order_Dir'], $this->lists['order'] ); ?> </td>
      <?php endif; ?>
      ...
      <td class="sectiontableheader<?php echo $this->escape($this->params->get('pageclass_sfx')); ?>" width="5%">
    ...
    <tr class="sectiontableentry<?php echo ($item->odd +1 ) . $this->escape($this->params->get('pageclass_sfx')); ?>" >
      ...
      <td><?php
		...
		?>
        <a href="<?php echo $fullURL; ?>"> <?php echo JText::_( 'Register to read more...' ); ?></a> </td>
      <?php endif; ?>
      <?php endif; ?>
      <?php if ($this->params->get('show_date')) : ?>
      ...
      <?php endif; ?>
      <?php if ($this->params->get('show_hits')) : ?>
      <td align="center"><?php echo $this->escape($item->hits) ? $this->escape($item->hits) : '-'; ?> </td>
      <?php endif; ?>
    </tr>
    <?php endforeach; ?>
