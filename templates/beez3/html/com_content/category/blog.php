...
<div class="items-leading">
	<?php foreach ($this->lead_items as &$item) : ?>
		<article class="leading-<?php echo $leadingcount; ?><?php echo $item->state == 0 ? 'system-unpublished' : null; ?><?php echo ($item->featured) ? ' featured-article' : ''; ?>">
			<?php
				$this->item = &$item;
...
<?php if (!empty($this->intro_items)) : ?>
	...
	<?php foreach ($this->intro_items as $key => &$item) : ?>
		...
		<?php endif; ?>
		<article class="item column-<?php echo $rowcount;?><?php echo $item->state == 0 ? ' system-unpublished' : null; ?><?php echo ($item->featured) ? ' featured-article' : ''; ?>">
		<?php
			$this->item = &$item;
			echo $this->loadTemplate('item');
		?>
