...
<?php if ($this->item->state == 0 or strtotime($this->item->publish_up) > strtotime(JFactory::getDate())
	or (strtotime($this->item->publish_down) < strtotime(JFactory::getDate()) and $this->item->publish_down !== JFactory::getDbo()->getNullDate())) : ?>
<div class="system-unpublished">
<?php endif; ?>
<?php if ($params->get('show_title')) : ?>
	<h2>
		<?php if ($params->get('link_titles') and $params->get('access-view')) : ?>
...
<?php endif; ?>
<?php if ($params->get('show_parent_category') and $this->item->parent_id != 1) : ?>
...
<?php if ($params->get('show_author') and !empty($this->item->author )) : ?>
	<dd class="createdby">
		...
		<?php if (!empty($this->item->contact_link) and $params->get('link_author') == true) : ?>
...
<?php if ($params->get('show_readmore') and $this->item->readmore) :
