...
?>
<form id="searchForm" class="well" action="<?php echo JRoute::_('index.php?option=com_search'); ?>" method="post">
	<div class="panel panel-default">
		<div class="panel-heading">
			<span class="search-form">
				...
				<button name="Search" onclick="this.form.submit()" class="btn btn-default hasTooltip button-search" title="<?php echo JHtml::tooltipText('COM_SEARCH_SEARCH'); ?>"><span class="icon-search"></span><?php echo JText::_('JSEARCH_FILTER_SUBMIT'); ?></button>
		...
		<div class="panel-body">
			<?php if ($this->params->get('search_phrases', 1)) { ?>
				<fieldset class="phrases col-md-6">
