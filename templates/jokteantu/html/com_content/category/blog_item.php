...
<?php if ($params->get('show_publish_date')) : ?>
	...
	<span class="a&ntilde;o"><?php echo JText::sprintf( JHtml::_('date',$this->item->publish_up, JText::_('Y'))); ?></span>
	</div>
	</div>
	</dd>
	...
	<dd class="createdby">
		...
		<?php $author = ($this->item->created_by_alias ? $this->item->created_by_alias : $author);?>
			...
			<?php if (!empty($this->item->contactid ) &&  $params->get('link_author') == true):?>
				<?php 	echo JText::sprintf('TPL_JOKTEANTU_ESCRITO_POR' ,
...
<?php if (($params->get('show_author')) or ($params->get('show_category')) or ($params->get('show_create_date'))  or ($params->get('show_publish_date')) or ($params->get('show_parent_category')) or ($params->get('show_hits'))) :?>
 	</dl>
<?php endif; ?>
