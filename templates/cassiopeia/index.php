...
?>">
	...
	<jdoc:include type="modules" name="top" style="none" class="grid-child container-top" />
	...
	<jdoc:include type="modules" name="bottom" style="none" class="grid-child container-bottom" />
