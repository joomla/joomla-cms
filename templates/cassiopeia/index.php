...
?>">
    ...
    <div style="background: linear-gradient(90deg, #001B4C 0%, #002e5a 100%); color: white; padding: 60px 20px; text-align: center;">
        <div class="container">
            <h1 style="font-weight: 800; font-size: 3.5rem; margin-bottom: 10px;">Hadgu,Alex,Hagos,Tesfom IT Portal</h1>
            <p style="font-size: 1.2rem; opacity: 0.9;">Welcome to our Joomla 5.4-dev Student Project at MIT.</p>
            <div style="margin-top: 25px;">
                <a href="https://www.mitethiopia.edu.et" target="_blank" style="background: #ffcc00; color: #001B4C; padding: 12px 25px; text-decoration: none; border-radius: 50px; font-weight: bold;">
                    Explore MIT Website
                </a>
            </div>
        </div>
...
?>">
    ...
    <div style="background: linear-gradient(90deg, #001B4C 0%, #002e5a 100%); color: white; padding: 60px 20px; text-align: center;">
        <div class="container">
            <h1 style="font-weight: 800; font-size: 3.5rem; margin-bottom: 10px;">Hadgu IT Portal</h1>
            <p style="font-size: 1.2rem; opacity: 0.9;">Welcome to my Joomla 5.4-dev Student Project at MIT.</p>
            <div style="margin-top: 25px;">
                <a href="https://www.mitethiopia.edu.et" target="_blank" style="background: #ffcc00; color: #001B4C; padding: 12px 25px; text-decoration: none; border-radius: 50px; font-weight: bold;">
                    Explore MIT Website
                </a>
