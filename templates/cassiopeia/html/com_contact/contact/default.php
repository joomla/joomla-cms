...
// Get the **template style parameters** (important!)
...
<div class="com-contact contact">
    ...
    <?php 
    // Show the page heading if enabled in menu item
    $menuPageHeading = $tparams->get('page_heading');
    $showPageHeading = $tparams->get('show_page_heading');
    
    if (!empty($menuPageHeading) && $showPageHeading): ?>
        <h1 class="page-title">
            <?php echo $this->escape($menuPageHeading); ?>
        </h1>
    <?php endif; ?>
    ...
    <?php if ($this->params->get('show_info', 1)) : ?>
        <div class="com-contact__container">
            <?php if ($templateParams->get('show_contact_form_title', 1)) : ?>
    ...
    <?php if ($tparams->get('show_email_form') && ($this->item->email_to || $this->item->user_id)) : ?>
        <?php if ($templateParams->get('show_email_form_title', 1)) : ?>
    ...
    <?php if ($tparams->get('show_links')) : ?>
        <<?php echo $htag2; ?>><?php echo Text::_('COM_CONTACT_LINKS'); ?></<?php echo $htag2; ?>>
            ...
            <dl class="dl-horizontal">
                <dt>
                    ...
                    <?php elseif ($icon && $this->params->get('marker_misc')) : ?>
                        <span class="jicons-image"><?php echo $this->params->get('marker_misc'); ?></span>
                    <?php endif; ?>
                    <span class="<?php echo $this->params->get('marker_class'); ?>"><?php echo Text::_('COM_CONTACT_OTHER_INFORMATION'); ?></span>
                </dt>
                <dd>
                    <span class="contact-misc"><?php echo $this->item->misc; ?></span>
                </dd>
            </dl>
        </div>
    <?php endif; ?>
