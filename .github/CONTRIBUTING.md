...
#### Branches
Bug fixing PRs should be made to the `5.4-dev` branch. Merged bugfixes will be upmerged into the current branches. New features that do not break backwards compatibility should be made to the `6.3-dev`.

| Branch  | Purpose                                                                                                      |
|---------|--------------------------------------------------------------------------------------------------------------|
| 5.4-dev | Branch for the current 5.x Joomla version.                                                                   |
| 6.2-dev | Branch for the current 6.x Joomla version. Bugfixes only for 6.2 go into this branch.                        |
| 6.3-dev | Branch for the next minor 6.x Joomla version. New features have to go into this branch.                      |
