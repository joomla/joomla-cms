...
| 4.0-dev | Branch for the next major Joomla version. New backward in-compatible features go into this branch. Commits to staging will be applied to this branch as well. |
