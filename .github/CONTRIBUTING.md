...
| 3.8.x | Branch for the next minor Joomla version. The 3.8.0 release will just be adding in compatibility features for 4.0. Commits to staging will be applied to this branch as well. |
