...
export default defineConfig({
  ...
  e2e: {
    ...
    specPattern: [
      ...
      'tests/System/integration/administrator/components/**/Workflow.cy.js',
      'tests/System/integration/administrator/components/com_workflow/*.cy.js',
      'tests/System/integration/plugins/workflow/**/*.cy.js',
    ],
