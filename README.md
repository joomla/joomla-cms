...
* How to [migrate from 2.5.x to 3.x](http://docs.joomla.org/Migrating_from_Joomla_2.5_to_Joomla_3.x)?
* What are the [main differences from 1.5 to 2.5](http://docs.joomla.org/Differences_from_Joomla_1.5_to_Joomla_2.5)?
* How to [migrate from 1.5.x to 3.x](http://docs.joomla.org/Migrating_from_Joomla_1.5_to_Joomla_3.x)?
...
* [Credits](http://docs.joomla.org/Joomla_3.x_Credits)
