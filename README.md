...
* It is a simple and powerful web server application which requires a server with PHP and MySQL, MariaDB or PostgreSQL to run. You can find [full technical requirements here](https://downloads.joomla.org/technical-requirements).
