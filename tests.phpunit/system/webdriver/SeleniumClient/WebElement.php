...
class WebElement
{
	...
	{
		$this->_driver->webElementSendKeys($this->_elementId, $text);
	}
	...
	{
		return $this->_driver->webElementGetTagName($this->_elementId);
	}
	...
	{
		return $this->_driver->webElementIsSelected($this->_elementId);
	}
	...
	{
		return $this->_driver->webElementIsDisplayed($this->_elementId);
	}
	...
	{
		return $this->_driver->webElementClear($this->_elementId);
	}
	...
	{
		$this->_driver->webElementClick($this->_elementId);
	}
	...
	{
		$this->_driver->webElementSubmit($this->_elementId);
	}
	...
	{
		return $this->_driver->webElementDescribe($this->_elementId);
	}
	...
	{
		return $this->_driver->webElementGetCoordinates($this->_elementId);
	}
	...
	{
		return $this->_driver->webElementGetLocationOnScreenOnceScrolledIntoView($this->_elementId);
	}
	...
	{
		return $this->_driver->webElementFindElement($this->_elementId, $locator, $polling);
	}
	...
	{
		return $this->_driver->webElementFindElements($this->_elementId, $locator, $polling);
	}
	...
	public function waitForElementUntilTextIsChanged($targetText, $timeOutSeconds = 5)
	{
		...
		while ($wait)
		{
			...
			{
				throw new WebDriverWaitTimeoutException ("Timeout for waitForElementUntilTextIsChange.");
			}
