...
class ContactEditPage extends AdminEditPage
{
	...
	public $inputFields = array(
		...
		array(
			'label' => 'Show Category',
			'id'    => 'jform_params_show_contact_category',
			'type'  => 'select',
			'tab'   => 'attrib-display'
		),
		array(
			'label' => 'Show Contact List',
			'id'    => 'jform_params_show_contact_list',
			'type'  => 'select',
			'tab'   => 'attrib-display'
		),
		array(
			'label' => 'Display Format',
			'id'    => 'jform_params_presentation_style',
			'type'  => 'select',
			'tab'   => 'attrib-display'
		),
		...
		array(
			...
			'id'    => 'jform_params_show_street_address',
			'type'  => 'select',
			'tab'   => 'attrib-display'
		),
		array(
			'label' => 'City or Suburb',
			'id'    => 'jform_params_show_suburb',
			'type'  => 'select',
			'tab'   => 'attrib-display'
		),
		array(
			'label' => 'State or County',
			'id'    => 'jform_params_show_state',
			'type'  => 'select',
			'tab'   => 'attrib-display'
		),
		array(
			'label' => 'Postal Code',
			'id'    => 'jform_params_show_postcode',
			'type'  => 'select',
			'tab'   => 'attrib-display'
		),
		...
		array(
			'label' => 'Telephone',
			'id'    => 'jform_params_show_telephone',
			'type'  => 'select',
			'tab'   => 'attrib-display'
		),
		array(
		...
		array(
			'label' => 'Show User Articles',
			'id'    => 'jform_params_show_articles',
			'type'  => 'select',
			'tab'   => 'attrib-display'
		),
		array(
