...
class MenuItemEditPage extends AdminEditPage
{
	...
	public $inputFields = array(
		...
		array(
			...
			'id'    => 'jform_params_menu_anchor_title',
			'type'  => 'input',
			'tab'   => 'attrib-menu-options'
		),
		array(
			'label' => 'Link CSS Style',
			'id'    => 'jform_params_menu_anchor_css',
			'type'  => 'input',
			'tab'   => 'attrib-menu-options'
		),
		array(
			'label' => 'Link Image',
			'id'    => 'jform_params_menu_image',
			'type'  => 'input',
			'tab'   => 'attrib-menu-options'
		),
		array(
			'label' => 'Add Menu Title',
			'id'    => 'jform_params_menu_text',
			'type'  => 'fieldset',
			'tab'   => 'attrib-menu-options'
		),
		array(
			'label' => 'Browser Page Title',
			'id'    => 'jform_params_page_title',
			'type'  => 'input',
			'tab'   => 'attrib-page-options'
		),
		array(
			'label' => 'Show Page Heading',
			'id'    => 'jform_params_show_page_heading',
			'type'  => 'fieldset',
			'tab'   => 'attrib-page-options'
		),
		array(
			'label' => 'Page Heading',
			'id'    => 'jform_params_page_heading',
			'type'  => 'input',
			'tab'   => 'attrib-page-options'
		),
		array(
			'label' => 'Page Class',
			'id'    => 'jform_params_pageclass_sfx',
			'type'  => 'input',
			'tab'   => 'attrib-page-options'
		),
		array(
			'label' => 'Meta Description',
			'id'    => 'jform_params_menu_meta_description',
			'type'  => 'textarea',
			'tab'   => 'attrib-metadata'
		),
		array(
			'label' => 'Meta Keywords',
			'id'    => 'jform_params_menu_meta_keywords',
			'type'  => 'textarea',
			'tab'   => 'attrib-metadata'
		),
		...
		array(
			'label' => 'Show Title',
			'id '   => 'jform_params_show_title',
			'type'  => 'fieldset',
			'tab'   => 'attrib-basic'
		),
		array(
			'label' => 'Linked Titles',
			'id'    => 'jform_params_link_titles',
			'type'  => 'fieldset',
			'tab'   => 'attrib-basic'
		),
		array(
			'label' => 'Show Intro Text',
			'id'    => 'jform_params_show_intro',
			'type'  => 'fieldset',
			'tab'   => 'attrib-basic'
		),
		array(
			'label' => 'Position of Article Info',
			'id'    => 'jform_params_info_block_position',
			'type'  => 'fieldset',
			'tab'   => 'attrib-basic'
		),
		array(
			'label' => 'Show Category',
			'id'    => 'jform_params_show_category',
			'type'  => 'fieldset',
			'tab'   => 'attrib-basic'
		),
		array(
			'label' => 'Link Category',
			'id'    => 'jform_params_link_category',
			'type'  => 'fieldset',
			'tab'   => 'attrib-basic'
		),
		array(
			'label' => 'Show Parent',
			'id'    => 'jform_params_show_parent',
			'type'  => 'fieldset',
			'tab'   => 'attrib-basic'
		),
		array(
			'label' => 'Link Parent',
			'id'    => 'jform_params_link_parent_category',
			'type'  => 'fieldset',
			'tab'   => 'attrib-basic'
		),
		array(
			'label' => 'Show Author',
			'id'    => 'jform_params_show_author',
			'type'  => 'fieldset',
			'tab'   => 'attrib-basic'
		),
		array(
			'label' => 'Link Author',
			'id'    => 'jform_params_link_author',
			'type'  => 'fieldset',
			'tab'   => 'attrib-basic'
		),
		array(
			'label' => 'Show Create Date',
			'id'    => 'jform_params_show_create',
			'type'  => 'fieldset',
			'tab'   => 'attrib-basic'
		),
		array(
			'label' => 'Show Modify Date',
			'id'    => 'jform_params_show_modify_date',
			'type'  => 'fieldset',
			'tab'   => 'attrib-basic'
		),
		array(
			'label' => 'Show Publish Date',
			'id'    => 'jform_params_show_publish_date',
			'type'  => 'fieldset',
			'tab'   => 'attrib-basic'
		),
		array(
			'label' => 'Show Navigation',
			'id'    => 'jform_params_show_item_navigation',
			'type'  => 'fieldset',
			'tab'   => 'attrib-basic'
		),
		array(
			'label' => 'Show Voting',
			'id'    => 'jform_params_show_vote',
			'type'  => 'fieldset',
			'tab'   => 'attrib-basic'
		),
		...
		array(
			'label' => 'Show Icons',
			'id'    => 'jform_params_show_icons',
			'type'  => 'fieldset',
			'tab'   => 'attrib-basic'
		),
		array(
			'label' => 'Show Print Icon',
			'id'    => 'jform_params_show_print_icon',
			'type'  => 'fieldset',
			'tab'   => 'attrib-basic'
		),
		array(
			'label' => 'Show Email Icon',
			'id'    => 'jform_params_show_email_icon',
			'type'  => 'fieldset',
			'tab'   => 'attrib-basic'
		),
		...
		array(
			...
			'id'    => 'jform_params_show_noauth',
			'type'  => 'fieldset',
			'tab'   => 'attrib-basic'
		),
		array(
			'label' => 'Positioning of the Links',
			'id'    => 'jform_params_urls_position',
			'type'  => 'fieldset',
			'tab'   => 'attrib-basic'
		),
	);
