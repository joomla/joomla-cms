...
class GlobalConfigurationPage extends AdminEditPage
{
	...
	public $inputFields = array(
		...
		array(
			...
			'id'    => 'jform_display_offline_message',
			'type'  => 'select',
			'tab'   => 'page-site'
		),
		...
		array(
			'label' => 'Search Engine Friendly URLs',
			'id'    => 'jform_sef',
			'type'  => 'fieldset',
			'tab'   => 'page-site'
		),
		...
		array(
			'label' => 'Include Site Name in Page Titles',
			'id'    => 'jform_sitename_pagetitles',
			'type'  => 'select',
			'tab'   => 'page-site'
		),
