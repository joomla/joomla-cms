...
class ModuleEditPage extends AdminEditPage
{
	...
	public $inputFields = array(
		...
		array(
			...
			'id'    => 'jform_params_show_description',
			'type'  => 'fieldset',
			'tab'   => 'general'
		),
		array(
			'label' => 'Show Number of Articles',
			'id'    => 'jform_params_numitems',
			'type'  => 'fieldset',
			'tab'   => 'general'
		),
		array(
			'label' => 'Show Subcategories',
			'id'    => 'jform_params_show_children',
			'type'  => 'fieldset',
			'tab'   => 'general'
		),
		array('label' => '# First Subcategories', 'id' => 'jform_params_count', 'type' => 'select', 'tab' => 'general'),
		array(
			'label' => 'Maximum Level Depth',
			'id'    => 'jform_params_maxlevel',
			'type'  => 'select',
			'tab'   => 'general'
		),
		...
		array(
			'label' => 'Cache Time',
			'id'    => 'jform_params_cache_time',
			'type'  => 'input',
			'tab'   => 'attrib-advanced'
		),
		array(
			'label' => 'Module Tag',
			'id'    => 'jform_params_module_tag',
			'type'  => 'select',
			'tab'   => 'attrib-advanced'
		),
		array(
			'label' => 'Bootstrap Size',
			'id'    => 'jform_params_bootstrap_size',
			'type'  => 'select',
			'tab'   => 'attrib-advanced'
		),
		array(
			'label' => 'Header Tag',
			'id'    => 'jform_params_header_tag',
			'type'  => 'select',
			'tab'   => 'attrib-advanced'
		),
		array(
			'label' => 'Header Class',
			'id'    => 'jform_params_header_class',
			'type'  => 'input',
			'tab'   => 'attrib-advanced'
		),
		...
		array(
			...
			'id'    => 'jform_params_showAllChildren',
			'type'  => 'fieldset',
			'tab'   => 'general'
		),
		...
		array(
			...
			'id'    => 'jform_params_class_sfx',
			'type'  => 'input',
			'tab'   => 'attrib-advanced'
		),
		array(
			'label' => 'Target Position',
			'id'    => 'jform_params_window_open',
			'type'  => 'input',
			'tab'   => 'attrib-advanced'
		),
	);
