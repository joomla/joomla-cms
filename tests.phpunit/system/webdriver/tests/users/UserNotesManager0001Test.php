...
class UserNotesManager0001Test extends JoomlaWebdriverTestCase
{
	...
	public function addUserNotes_WithGivenFields_UserNotesAdded()
	{
		...
		$this->userNotesManagerPage->addUserNotes($userNotesName, 'Super User', array('Category'    => $category,
		                                                                              'Status'      => $status,
	...
	public function editUserNotes_ChangeFields_FieldsChanged()
	{
		...
		$this->userNotesManagerPage->editUserNotes($userNotesName, array('Subject'     => $newNotesName,
		                                                                 'ID'          => $newUserName,
		                                                                 'Status'      => $newStatus,
		                                                                 'Review Date' => $newReviewTime,
		                                                                 'Note'        => $newNote
		));
	...
	public function setFilter_TestOrdering_ShouldOrderNotes()
	{
		...
		$note               = 'This is a user note with custom fields.';
		$this->userNotesManagerPage->addUserNotes($superUserNotesName, 'Super User', array('Category'    => $category,
		                                                                                   'Status'      => $status,
		                                                                                   'Review Date' => $reviewTime,
		                                                                                   'Note'        => $note
		));
		...
		$this->userNotesManagerPage->addUserNotes($user1NotesName, $userName1, array('Category'    => $category,
		                                                                             'Status'      => $user1Status,
		                                                                             'Review Date' => $user1ReviewTime,
		                                                                             'Note'        => $user1Note
		));
		...
		$this->userNotesManagerPage->addUserNotes($user2NotesName, $userName2, array('Category'    => $category,
		                                                                             'Status'      => $user2Status,
		                                                                             'Review Date' => $user2ReviewTime,
		                                                                             'Note'        => $user2Note
		));
