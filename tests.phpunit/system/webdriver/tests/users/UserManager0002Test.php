...
class UserManager0002Test extends JoomlaWebdriverTestCase
{
	...
	public function setFilter_TestFilters_ShouldFilterUsers()
	{
		...
		$this->userManagerPage->addUser('Test User3', 'login3', 'password3', 'user3@test.com', array(
			'Registered',
			'Manager'
		));
	...
	public function setFilter_TestOrdering_ShouldOrderUsers()
	{
		...
		$this->userManagerPage->addUser('Test User3', 'login3', 'password3', 'user2@test.com', array(
			'Registered',
			'Manager'
		));
