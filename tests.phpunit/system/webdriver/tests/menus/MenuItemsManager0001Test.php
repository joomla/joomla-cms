...
class MenuItemsManager0001Test extends JoomlaWebdriverTestCase
{
	...
	public function addMenuItem_SingleContact_MenuAdded()
	{
		...
		$this->menuItemsManagerPage->searchFor();
		$actualValues   = $this->menuItemsManagerPage->getFieldValues('MenuItemEditPage', $title, array(
			'Menu Title',
			'Menu Item Type',
			'contact'
		));
	...
	public function editMenuItem_ChangeFields_FieldsChanged()
	{
		...
		$this->menuItemsManagerPage->editMenuItem($title, array('Menu Title'     => $newTitle,
		                                                        'Menu Item Type' => $newMenuType,
		                                                        'category'       => $newCategory,
		                                                        'Menu Location'  => $newMenuLocation
		));

		$this->menuItemsManagerPage->setFilter('Menu', $newMenuLocation);
		$actualValues   = $this->menuItemsManagerPage->getFieldValues('MenuItemEditPage', $newTitle, array(
			'Menu Title',
			'Menu Item Type',
			'category',
			'Menu Location'
