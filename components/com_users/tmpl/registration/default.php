...
<div class="com-users-registration registration">
    ...
    <form id="member-registration" action="<?php echo Route::_('index.php'); ?>" method="post" class="com-users-registration__form form-validate" enctype="multipart/form-data">
