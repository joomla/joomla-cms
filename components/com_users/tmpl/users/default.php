                ...
                <tr>
                    <th scope="col" id="userlist_header_name">
						<?php echo HTMLHelper::_(
							'grid.sort', 'COM_USERS_USERS_NAME', 'users.name', $listDirn, $listOrder
						); ?>
					...
					<?php if ($params->get('show_articles')) : ?>
                        <th scope="col" id="userlist_header_articles">
							<?php echo HTMLHelper::_(
								'grid.sort', 'COM_USERS_USERS_NUMBER_ARTICLES', 'articlesByUser', $listDirn, $listOrder
							); ?>
                        </th>
					<?php endif; ?>
					<?php if ($params->get('show_last_visited')) : ?>
                        <th scope="col" id="userlist_header_lastvisit">
							<?php echo HTMLHelper::_(
								'grid.sort', 'COM_USERS_USERS_LASTVISIT', 'users.lastvisitDate', $listDirn, $listOrder
							); ?>
                        </th>
					<?php endif; ?>
					<?php if ($params->get('show_online_status')) : ?>
                        <th scope="col" id="userlist_header_onlinestatus">
							<?php echo HTMLHelper::_(
								'grid.sort', 'COM_USERS_USERS_ONLINE_STATUS', 'session.time', $listDirn, $listOrder
							); ?>
                        </th>
					<?php endif; ?>
                </tr>
					...
					<?php if ($params->get('show_last_visited')) : ?>
                        <td headers="categorylist_header_author" class="list-author">
							<?php echo HTMLHelper::_(
								...
								$this->escape($params->get('date_format', Text::_('DATE_FORMAT_LC3')))
							); ?>
                        </td>
					<?php endif; ?>
					<?php if ($params->get('show_online_status')) : ?>
