...
<div class="com-users-login login">
    ...
    <form action="<?php echo Route::_('index.php?task=user.login'); ?>" method="post" class="com-users-login__form form-validate form-horizontal well" id="com-users-login__form">
