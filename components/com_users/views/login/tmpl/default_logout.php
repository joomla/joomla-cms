...
<div class="logout<?php echo $this->pageclass_sfx?>">
	...
	<form action="<?php echo JRoute::_('index.php?option=com_users&task=user.logout'); ?>" method="post" class="form-horizontal well">
		...
		<?php if ($this->params->get('logoutredirectchoice') == "0" && !empty ($this->params->get('logout_redirect_url'))) : ?>
			<input type="hidden" name="return" value="<?php echo base64_encode($this->params->get('logout_redirect_url', $this->form->getValue('return'))); ?>" />
		<?php endif; ?>

		<?php if ($this->params->get('logoutredirectchoice') == "1" && !empty ($this->params->get('logout_redirect_menuitem'))) : ?>
