...
<div class="login<?php echo $this->pageclass_sfx; ?>">
	...
	<form action="<?php echo JRoute::_('index.php?option=com_users&task=user.login', true, $usersConfig->get('usesecure')); ?>" method="post" class="form-validate form-horizontal well">
