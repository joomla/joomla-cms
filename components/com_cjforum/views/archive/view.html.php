...
class CjForumViewArchive extends JViewLegacy
{
	...
	public function display ($tpl = null)
	{
		...
		$form->monthField = JHtml::_('select.genericlist', $months, 'month', 
				array(
	...
	protected function _prepareDocument ()
	{
		...
		{
			$this->params->def('page_heading', JText::_('JGLOBAL_TOPICS'));
		}
