...
JFactory::getLanguage()->load('com_communitysurveys');
?>
<div id="cj-wrapper" class="profile-surveys<?php echo $this->pageclass_sfx;?>">
	<?php 
	if(count($this->items) > 0)
	{
		echo JLayoutHelper::render(
			...
			null,
			array('debug' => false, 'client' => 0, 'component' => 'com_communitysurveys'));
	}
	else 
	{
		?>
