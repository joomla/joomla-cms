...
JLoader::register('CommunityPollsHelperRoute', JPATH_BASE . '/components/com_communitypolls/helpers/route.php');
JFactory::getLanguage()->load('com_communitypolls');
?>
<div id="cj-wrapper" class="profile-questions<?php echo $this->pageclass_sfx;?>">
	...
	if(count($this->items) > 0)
	{
		echo JLayoutHelper::render(
			...
			null,
			array('debug' => false, 'client' => 0, 'component' => 'com_communitypolls'));
	}
	else 
	{
		?>
