				...
				<li class="list-group-item">
					<div class="media">
						...
						<div class="media-body">
							...
							<p class="badge badge-success hidden-sm hidden-md hidden-lg"><?php echo CjForumApi::getActivityDate($item->created);?></p>
						...
						<div class="media-right hidden-xs">
							<p class="badge badge-success"><?php echo CjForumApi::getActivityDate($item->created);?></p>
						</div>
					</div>
				</li>
				<?php
