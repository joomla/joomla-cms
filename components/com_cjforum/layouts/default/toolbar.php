...
<!-- 				<span class="sr-only">Toggle navigation</span> -->
			...
			<a class="brand navbar-brand" href="<?php echo JRoute::_('index.php?option=com_cjforum');?>">
		...
		<div class="nav-collapse navbar-responsive-collapse collapse" id="cf-navbar-collapse">
			...
			<ul class="nav pull-right">
				...
				<li class="dropdown">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown"><?php echo JText::_('COM_CJFORUM_LABEL_ACCOUNT');?> <b class="caret"></b></a>
					<ul class="dropdown-menu">
						<li class="nav-header"><?php echo JText::_('COM_CJFORUM_LABEL_MY_STUFF');?></li>
						<?php if($user->authorise('core.create', 'com_cjforum')):?>
						<li>
							...
							<div class="row-fluid">
								<div class="span6">
									<ul class="multi-column-dropdown no-space-left">
										<li class="nav-header"><?php echo JText::_('COM_CJFORUM_LABEL_ACTIVITIES');?></li>
										<li>
										...
										<li class="divider"></li>
										<li class="nav-header"><?php echo JText::_('COM_CJFORUM_LABEL_USERS');?></li>
										<li>
								...
								<div class="span6">
									<ul class="multi-column-dropdown no-space-left">
										<li class="nav-header"><?php echo JText::_('COM_CJFORUM_LABEL_TOPICS');?></li>
										...
										<li class="divider"></li>
										<li class="nav-header"><?php echo JText::_('COM_CJFORUM_LABEL_SEARCH');?></li>
										<li>
