			...
			<tbody>
				<?php foreach ($this->items as $i => $item) : ?>
					<?php if ($this->items[$i]->core_state == 0) : ?>
					 <tr class="system-unpublished cat-list-row<?php echo $i % 2; ?><?php echo ($item->featured) ? ' featured-contact' : ''; ?>">
					<?php else: ?>
					<tr class="cat-list-row<?php echo $i % 2; ?><?php echo ($item->featured) ? ' featured-contact' : ''; ?>" >
					<?php endif; ?>
