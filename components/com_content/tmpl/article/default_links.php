...
// Create shortcut
$urls = json_decode((string) $this->item->urls, null, 512, JSON_THROW_ON_ERROR);
...
<div class="com-content-article__links content-links">
    <ul class="com-content-article__links content-list">
        <?php
            $urlarray = [[$urls->urla, $urls->urlatext, $urls->targeta, 'a'], [$urls->urlb, $urls->urlbtext, $urls->targetb, 'b'], [$urls->urlc, $urls->urlctext, $urls->targetc, 'c']];
                ...
                switch ($target) {
                    ...
                    case 3:
                        ...
                        echo HTMLHelper::_(
                            ...
                            'linkModal',
                            ['url'    => $link, 'title'  => $label, 'height' => '100%', 'width'  => '100%', 'modalWidth'  => '500', 'bodyHeight'  => '500', 'footer' => '<button type="button" class="btn btn-secondary" data-bs-dismiss="modal" aria-hidden="true">'
