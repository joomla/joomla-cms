...
?>
<div class="com-content-article <?php echo $this->pageclass_sfx; ?> | item-page" itemscope itemtype="https://schema.org/Article">
	<meta itemprop="inLanguage" content="<?php echo ($this->item->language === '*') ? Factory::getApplication()->get('language') : $this->item->language; ?>">
	<?php if ($this->params->get('show_page_heading')) : ?>
	<div class="article__title--menu | page-header">
	...
	<div class="article__title | page-header">
	...
	<div itemprop="articleBody" class="article__content | com-content-article__body">
