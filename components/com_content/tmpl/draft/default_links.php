...
?>
	<div class="com-content-draft__links content-links">
		<ul class="com-content-draft__links content-list">
			<?php
			$urlarray = array(
			...
			?>
				<li class="com-content-draft__link content-links-<?php echo $id; ?>">
					<?php
