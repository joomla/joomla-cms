...
<div class="item-content">
    <?php if ($isUnpublished): ?>
        ...
        <?php if ($params->get('show_title')): ?>
            <h2 class="item-title">
                <?php if ($params->get('link_titles') && $params->get('access-view')): ?>
                    <a
                        href="<?php echo Route::_(RouteHelper::getArticleRoute($this->item->slug, $this->item->catid, $this->item->language)); ?>">
        ...
        // Remove unclosed block tags safely
        if (substr_count($intro, '<div') > substr_count($intro, '</div>')) {
            $intro .= '</div>';
        }
