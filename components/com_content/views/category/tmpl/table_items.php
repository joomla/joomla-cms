...
<?php if ($params->get('filter') || $params->get('display')) : ?>
<tr>
	<td colspan="5">
		<table>
		<tr>
...
<tr class="sectiontableentry<?php echo ($item->odd +1 ) . $params->get( 'pageclass_sfx' ); ?>" >
	<td align="center">
		<?php echo $pagination->rowNumber( $item->count ); ?>
	</td>
	<?php if ($params->get('title'))              : ?>    
	<?php if ($item->access <= $user->get('gid')) : ?>
	<td>
...
<input type="hidden" name="sectionid" value="<?php echo $category->sectionid; ?>" />
