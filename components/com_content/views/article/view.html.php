...
class ContentViewArticle extends JViewLegacy
{
	...
	protected function _prepareDocument()
	{
		...
		if ($menu && (isset($menu->query['option']) && $menu->query['option'] !== 'com_content' || $menu->query['view'] !== 'article' || $id != $this->item->id))
		{
			...
			while ($category && (isset($menu->query['option']) && $menu->query['option'] !== 'com_content' || $menu->query['view'] === 'article' || $id != $category->id) && $category->id > 1)
			{
