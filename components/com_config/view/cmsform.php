...
abstract class JModelCmsform extends JModelCms
{
	...
	public function checkin($pk = null)
	{
		...
		if ($pk)
		{
			...
			{
				JFactory::getApplication()->enqueueMessage(JText::_('JLIB_APPLICATION_ERROR_CHECKIN_USER_MISMATCH'));
				return false;
			}
	...
	public function checkout($pk = null)
	{
		...
		if ($pk)
		{
			...
			{
				JFactory::getApplication()->enqueueMessage(JText::_('JLIB_APPLICATION_ERROR_CHECKOUT_USER_MISMATCH'));
				return false;
			}
