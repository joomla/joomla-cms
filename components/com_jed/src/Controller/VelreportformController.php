 ...
 * @since 4.0.0
 */
class VelreportformController extends FormController
{
    /**
    ...
    public function cancel($key = null)
    {
        ...
        $editId = (int) $app->getUserState('com_jed.edit.velreport.id');

        // Get the model.
        $model = $this->getModel('Velreportform', 'Site');
        ...
        $item = $menu->getActive();
        $url  = (empty($item->link) ? 'index.php?option=com_jed&view=velreports' : $item->link);
    ...
    public function edit($key = null, $urlVar = null)
    {
        ...
        $previousId = (int) $app->getUserState('com_jed.edit.velreport.id');
        $editId     = $app->input->getInt('id', 0);

        // Set the user id for the user to edit in the session.
        $app->setUserState('com_jed.edit.velreport.id', $editId);
        ...
        $this->setRedirect(Route::_('index.php?option=com_jed&view=velreportform&layout=edit', false));
    }
    ...
    public function save($key = null, $urlVar = null)
    {
        ...
        if ($return === false) {
            // Save the data in the session.
            $app->setUserState('com_jed.edit.velreport.data', $data);
