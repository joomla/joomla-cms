 ...
 * @since 4.0.0
 */
class VelabandonedreportController extends BaseController
{
    /**
    ...
    public function publish()
    {
        ...
        if ($user->authorise('core.edit', 'com_jed') || $user->authorise('core.edit.state', 'com_jed')) {
            ...
            if (!$item) {
                ...
                $this->setRedirect(Route::_('index.php?option=com_jed&view=velabandonedreports', false));
            } else {
    ...
    /*  public function remove()
    {
        ...
        if ($user->authorise('core.delete', 'com_jed'))
        {
            ...
            else
            {
                ...
                $app->redirect(Route::_('index.php?option=com_jed&view=velabandonedreports', false));
            }
