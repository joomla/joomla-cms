...
<div class="contact<?php echo $this->pageclass_sfx; ?>" itemscope itemtype="https://schema.org/Person">
	...
	<?php if ($tparams->get('show_contact_list') && count($this->contacts) > 1) : ?>
		<form action="#" method="get" name="selectForm" id="selectForm">
			<?php echo '<label for="idSelContact">'.JText::_('COM_CONTACT_SELECT_CONTACT').'</label>'; ?>
			<?php echo JHtml::_('select.genericlist', $this->contacts, 'idSelContact', 'class="inputbox" onchange="document.location.href = this.value"', 'link', 'name', $this->contact->link); ?>
		</form>
	<?php endif; ?>
