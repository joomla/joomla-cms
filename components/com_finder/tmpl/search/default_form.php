...
if ($this->params->get('show_autosuggest', 1)) {
    ...
    $this->document->addScriptOptions('finder-search', array('url' => Route::_('index.php?option=com_finder&task=suggestions.suggest&format=json&tmpl=component', false), 'listLabel' => Text::_('COM_FINDER_SEARCH_FORM_LIST_LABEL')));
}
