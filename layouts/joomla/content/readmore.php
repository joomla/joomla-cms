...
<p class="readmore">
	<?php if (!$params->get('access-view')) : ?>
		<a class="btn btn-secondary" href="<?php echo $displayData['link']; ?>" itemprop="url" aria-label="<?php echo $this->escape(Text::_('COM_CONTENT_REGISTER_TO_READ_MORE') . ' ' . $item->title); ?>">
	...
	<?php elseif ($params->get('show_readmore_title', 0) == 0) : ?>
		<a class="btn btn-secondary" href="<?php echo $displayData['link']; ?>" itemprop="url" aria-label="<?php echo $this->escape(Text::sprintf('COM_CONTENT_READ_MORE_TITLE', $item->title)); ?>">
			<?php echo '<span class="fas fa-chevron-' . $direction . '" aria-hidden="true"></span>'; ?>
