...
<dd class="createdby">
	...
	<?php if (!empty($displayData['item']->contact_link ) && $displayData['params']->get('link_author') == true) : ?>
		<?php echo JText::sprintf('COM_CONTENT_WRITTEN_BY', JHtml::_('link', $displayData['item']->contact_link, JFactory::getMicrodata()->content($author)->property('author')->fallback('Person', 'name')->display())); ?>
	<?php else :?>
