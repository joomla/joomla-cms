		...
		<?php foreach ($displayData as $i => $tag) : ?>
			<?php if (in_array($tag->access, JAccess::getAuthorisedViewLevels(JFactory::getUser()->get('id')))) : ?>
				...
				<span class="tag-<?php echo $tag->tag_id; ?> tag-list<?php echo $i ?>">
					<a <?php echo JFactory::getMicrodata()->property('keywords')->display(); ?> href="<?php echo JRoute::_(TagsHelperRoute::getTagRoute($tag->tag_id . ':' . $tag->alias)) ?>" class="<?php echo $link_class; ?>">
